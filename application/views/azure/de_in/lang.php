...
'EMAIL_SENDDOWNLOADS_DOWNLOADS_DESC' => 'Lade Dir Deine bestellten Dateien hier herunter.',
...
'PAGE_ACCOUNT_USER_USERTITLE' => 'Versandkosten- und Versand-Optionen',
'PAGE_ACCOUNT_WISHLIST_SENDSUCCESSFULLY1' => 'Dein Wunschzettel wurde erfolgreich an',
'PAGE_ACCOUNT_WISHLIST_SENDSUCCESSFULLY2' => 'verschickt!',
'PAGE_CHECKOUT_BASKETCONTENTS_ARTNOMBER' => 'Artikel Nr.',
'PAGE_CHECKOUT_BASKETCONTENTS_COUPONNOTACCEPTED1' => 'Dein Gutschein',
...
'PAGE_CHECKOUT_BASKETCONTENTS_YOURMESSAGE' => 'Dein Text:',
'PAGE_CHECKOUT_ORDER_BILLINGADDRESS' => 'Rechnungsadresse',
'PAGE_CHECKOUT_ORDER_COUPONNOTACCEPTED1' => 'Dein Gutschein',
...
'PAGE_CHECKOUT_PAYMENT_EMPTY_TEXT' => '<p>Derzeit ist keine Versandart für dieses Land definiert.</p> <p>Wir werden versuchen, Liefermöglichkeiten zu finden und Dich über die Versandkosten informieren.</p> <p>Falls Du damit einverstanden bist, wähle "Weiter zum nächsten Schritt".</p>',
...
'PAGE_CHECKOUT_PAYMENT_TSPROTECTIONTEXT' => 'Der Trusted Shops Käuferschutz sichert Deinen Online-Kauf ab. Mit der Übermittlung und',
...
'PAGE_CHECKOUT_THANKYOU_REGISTEREDYOUORDERNO1' => 'Deine Bestellung ist unter der Nummer',
'PAGE_CHECKOUT_THANKYOU_REGISTEREDYOUORDERNO2' => 'bei uns registriert.',
'PAGE_CHECKOUT_THANKYOU_THANKYOU1' => 'Vielen Dank für Deine Bestellung',
'PAGE_CHECKOUT_THANKYOU_THANKYOU2' => 'im',
'PAGE_CHECKOUT_USER' => 'Versenden',
'PAGE_CHECKOUT_USER_OPTION_REGISTRATION_DESCRIPTION' => 'Mit einem persönlichen Kundenkonto hast Du folgende Vorteile:<br> - Verwaltung der Lieferadressen<br> - Prüfung des Bestellstatus<br> - Bestellhistorie<br> - persönlicher Merkzettel<br> - persönliche Wunschliste<br> - Newsletter-Verwaltung<br> - Sonder- und Rabattaktionen',
'PAGE_CHECKOUT_WRAPPING_CANCEL' => 'Abbrechen',
'PAGE_CHECKOUT_WRAPPING_NONE' => 'KEINE',
'PAGE_DETAILS_THANKYOUMESSAGE1' => 'Vielen Dank für Deine Nachricht an',
...
'PAGE_INFO_CLEARCOOKIE_CONTENT' => 'Du hast Dich entschieden, keine Cookies von unserem Online-Shop zu akzeptieren. Die Cookies wurden gelöscht. Du kannst in den Einstellungen Deines Browsers die Verwendung von Cookies deaktivieren und den Online-Shop mit einigen funktionellen Einschränkungen nutzen. Du kannst auch zurück zum Shop gehen, ohne die Einstellungen zu ändern, und den vollen Funktionsumfang des Online-Shops genießen.<br/><br/>Informationen zu Cookies auf Wikipedia: <a href="http://de.wikipedia.org/wiki/HTTP-Cookie"><strong>http://de.wikipedia.org/wiki/HTTP-Cookie</strong></a>',
'PAGE_INFO_CLEARCOOKIE_TITLE' => 'Information über Cookies',
'PAGE_INFO_CONTACT_THANKYOU1' => 'Vielen Dank für Deine Nachricht an',
...
'PAGE_WISHLIST_PRODUCTS_PRODUCTS2' => 'gewünscht. Wenn Du ihr/ihm eine Freude machen willst, dann kaufe einen oder mehrere von diesen Artikeln.',
