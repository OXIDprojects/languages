...
'USER_LIST_CUSTOMERNUM' => 'Cust No.',<?php
/**
MENNUITE file iAdminister Usersf OXID eShop CommunSUBity Editio   OXID eShop CommuPLACEfile isityf OXID eShop CZIPfile ify
 OXID eSMAIN
 *    ThSNRfile is paomerrt of OXID eSe terEMAILLOGINfile iE-mail/Login under the terHASPASSWORDfile iHas password? under the terLDA
 *        user under the terNAMdistribName, Surname) any later verEW, either versiNew Pof the  under the terRIGHTSfile iRightXID eShop e terSTR GNU GenStreet, RRANTYrt of OXID eSOVERVIEW_BONIfile i\'Traffic Lful,\' Credit Ratingen the implied warrREACKORDEGNU GenAborted Ord OXID eShop plied warGROUPl be us   O GroupGeneral Public LiceLASTBUY(at youast Purchas eShop Com You should hity Editioved apcopy ofd Produc,
 *    buplied warOXIr versiition OXID eSPAYMENTty Edi://wws distributeyment MethodXID eShop tp://wwwu.org/license
 *
 * @link      http://www.oxid-esaTYPdistrib @link Typ eShop Comtp://wwwVALUdistribValu eShop ComREMARKty El be us[News]
 * @translatorsSE.  See th[ GNU ngName  = "普通slator 普通RemarkngName  = "普通php---------g.ngNamusrReg*
 *edfile iTheption will be r--------- af
 * entering hi 3 of the of OXVENDOeShop Commnity EditioMa
 * SetTNESXID eIONS_LIST_MENUITEdition is frDistributoOXID eIONS_LIST_METITLdistrib[itio Vendor n.
 *
rationngNamIONS_LIe terALLity l be usAll availableith OXID eSho,
'ACTIONS_MICONUPLOAr versiUpload Icooftwaoducts',
'ACTALLAWITHIONS_Lles.comh OXID  from t => => 'Promoti, seviewAllANY WARhow all'PleaOUCHERSERIE_EXPORTDONdistribuoupons export complete,
'ACTILIST_ENTRY' => 'EntrWNMAIN_NOTSEDownCTEDustomer Information',
'Er versiINGB_LIST_MENUed: ustomer Information',
'ING
 *    _MENUset'cNGB_LIS..Customer InformatiGENERADMINGB_TITLE' => generaD Guestbook]',
'ADMINLLINKS_LISry',
'ADMINGB_LIS => 'LiionITEM' => 'Customer InformatiLINKS_LIST_MENUIGministr 'Customer Information',
'ADMINLse fo_INnfiguRTICLESATTR' => fo*    Oails.
 *
mer InformatiST_MENUITEM' => 'CuShop Information',o remote location. PlEdition is frINGB_L Serieaded to remote location.INn OXID eShoMin.  GNU  Sumded to remote locationNTRYALis file i
 *ded to remote locONS_MAINOWOTT_ENTRY'l be usValid with differ
 *,
'ARTICLE_ATTRIBUTE_ASction ListSAMEARTICLE_ATTRIBUTE_ITEMSsame' => 'Product\'s Attributes',
VAILABALLARTIC, files wroduct\'s Attributes',CALCULATEONedistribualculate only once (vBUTE_BUTE_ll nph OXID or category vouchers)roduct\'s Attributes',DISCOU/licenseDiscountroduct\'s Attributes',=> 'En_MENUITEM' =roduct\'s Attributes',LINKS_LI => '<b>Note:ATTRIBUTE' => 'AvailablLINKS_LIRANDO file i new win Random Noroduct\'s Attributes',MINSE.  PRIedistribAssign Attributes',
'ARTICLE_ATmunity Eonizatifile isreCLE_new INGB_LICLE_ATTRIBUTE_TOOMANYA => 'Sis file iATTRIBUTumb OXID eATTRIBUTE_TOOMANYAICLE_ATs',
'SE.  See thTEMSSELLIST' => 'Produ,SATTRIBUTE' GNU available Products',
'USMINGB_TIUseTEM' => 'Guestbooke teronizatiis file ismount'> 'Alloduct:',
'ARTICLE_BUNDLE_UNASSTATISTICl be ust only one weful,file iWilable,
'WRAPPING_COSll be usGift WrappNESS FOTICLE_CROation. Please take care about synchr => 'Assign AccessEdition is frSSIGNACCESSORIES' => 'Assign AcPICTURbute inPicturATTRI,
'ARTICLE_CROSRESENTPACKUE' => '<bSIGNACCESSORIES' => 'Assign AcIN_ALLARTICLES' =ACCESSORngNamTICLE_CROe terSSSELLING_CROSSSELLING' => 'CrossALLCATS'S_MAIN_NOTSELECTED'vailable Categories',
'ARTg Products',
'ARTICLE_CROSSSELLING_EXTRAS' =>e teressories for Product',
'ARTIC);
