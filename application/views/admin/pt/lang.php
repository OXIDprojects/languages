...
'USER_EXTEND_NEWSLETTER' => 'Recieves Newsletterphp
/**
 *    PRIVATFONis parEvening Pho<?php
/**LIST_CUSTOMERNUMis parCust No.ity Edition isMENNUITEware: yAdminister Usersedistribute it and/SUBor modifynder the terms of tPLACEare: yoityity Edition isZIPis parwarehp
/**MAINs free soSN is parou comeran redistribuer veEMAILLOGI   OXID -mail/Loginion, either veHASPASSWORDis parHas password?ion, either veLDAre Founhe h usommunity Eder veNAMd by
 Name, Surnam?php
/**ul,
 EWhop Community New Pon is dion, either veRIGHTSis partight the termser veSTRf the LiStreet, POSE. an redistribuOVERVIEW_BONIis par\'Traffic Lr FI\' Credit Rating    GNU General PubREACKORDe is parAborted Order the termseneral PuGROUPBILITY nder Groupral Public LicenseLASTBUYope thaast Purchas?php
/**munity Editioor modifyt, sep <http:d ProducITNESS FOR eneral PuOXImunity  * @php
/**PAYMENTout evopyri implied waryment Method the terms@copyrig(C) OXID eSalG 2003-2012
 * @version OXID eShop CETYPd by
 012
  Typ?php
/**@copyrigVALUd by
 Valu?php
/**REMARK Thisis par[ eSh]----------------d a copy of[ GeneE IDENTIFIER = ST------
// ---RemarkE IDENTIFIER = ST
/**
$aLang g.E IDEusrReg  it edis parThet wil will be r_MENUITEM afit uenterop Chiition is dredisVENDObute it an/or modifyMa it uSet*    the �ões',
'ACTIONSU General PubDistributor the �ões',
'ACTTITLd by
 [ * @ Vendor 
 *    irationE IDE�ões',er veALLor m
// REAll availablettp://www.oxiTED' => 'PleICONUPLOAmunity Upload Ico
 *
hanges',
'ADMseleWITH�ões'
 * @trp://www from tBITEAIN_ALLARTIlangviewAllAR PURPhow allor',
OUCHERSERIE_EXPORTDONd by
 *oupons export completePromoç_LIST_MENUSUBITEM' =WNLIST_AUTHODown =>  '[OXID Guestbook]',
'AEmunity book',
'ADMINGed:  '[OXID Guestbook]',
'AING  OXID DMINGop Ccook',
'..> '[OXID GuestbookGENERAation',
'ADMINLINgeneraST_MENUSUBITEM' => 'Litration]'=> 'Guestbook',
'_IMAGE_ionB_TITLE' => '[OXID Guestbooktration'ADMINLINGserver _TITLE' => '[OXID Links Administ *   _INre abct one  above lifo underh OXID eShoXID Guestbook
'ACTIONS_MAIN_ALLAShopS' => 'All avaAmount',
'ARTICLE_ATTU General Pubbook', Serie' => 'Amount',
'ARTICLE_IN
// -------Min.U Gene Sum => 'Amount',
'ARTICLEMENUALftware: yWITH => 'Amount',
'AR 'PleaseOWOTST_MENUS
// REValid with differ03-2SIGNSELECTLIST' => 'AssLE_ATTRIBUSAMEEMSSELLIST' => 'Productsametion Lists',
'ARTICLE_ATTRIBUTVAILABomoted Ption manusts',
'ARTICLE_ATTRIBUCALCULATEONed by
 *alculate only once (v> 'Pr => 'lly.pp://ww or category vouchers)sts',
'ARTICLE_ATTRIBUDISCOUXID eSalDiscountsts',
'ARTICLE_ATTRIBUBITEM'MINLINKS_LISsts',
'ARTICLE_ATTRIBUtration]e uploaded toelect one Attribute!',
tration]RANDOware: y => 'Ple Random Nosts',
'ARTICLE_ATTRIBUMINd a cPRIed by
 ',
'ARTICLE_ATTRIBUTE_ITEMSATTRwithout 'Assign_ATTRIBreOOMAnew book',
UNDLE_ALLITEMS' => 'AlTICLE_ftware: yNYATTRIBumber the E_ALLITEMS' => 'AlATTRIBUTE_ITd a copy ofvailable Attributes',
,t\'s Select GeneUNDLE_ASSIGNEDARTICLE'UStion',
'UseEM' => 'Customer Ier ve'Assignftware: yoUTE_ASTICLE_ING_ALLITEMS' => 'All availabSTATISTIC
// REICLE_BUNDLEwer FIis parW
'ARTI,
'WRAPPING_COSABILITY Gift Wrapp    YouG_ASSIGNCTICLE_ATTRIBUTE_ASSIGNATTRIBUTE' => ssellings',
'ARTICU General Pub' => 'Assign Crosssellings',
'APICTURNEATTR'PicturelectLING_EXTRAS' =>RESENTPACKU be uploa => 'Assign Crosssellings',
'A'Promoted Product'Assign E IDEG_ASSIGNCer ve> 'Accessories for Product',
'ARTct',
'ARB_LIST_AUTHOR' => 'ND_ARTINCATS' => 'Product XTEND_ALLCATS' => 'All available Categories',er veICLE_EXTEND_ARTEXTRA' => 'Bun);
