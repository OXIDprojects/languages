...
'DYN_TRUSTED_OTHER' => 'Different payment method',
...
'EFIRE_GETCONNECTOR' => 'Once you are registered with OXID eFire you\'ll be able to download your personalized copy of the shop connector and install it directly to the proper shop location.',
'EFIRE_PASSWORD' => 'External transaction password',
'EFIRE_SAVECREDENTIALS' => 'Save your credentials for future use',
'EFIRE_USERDETAILS' => 'User',
'EFIRE_USERNAME' => 'External transaction login (user name)',
...
<ul>
<li>Depending on the shop settings, the price with or w/o VAT will be shown or inserted.</li>
<li>The price incl. VAT will always be shown in brackets.</li></ul>',
...
'OLC_ERROR_REQUEST_FAILED' => 'Service unavailable, please try again later. If this error persists, please check if your server is able to establish outgoing connections.',
'OLC_ERROR_RESPONSE_NOT_VALID' => 'Service unavailable, please try again later. If this error persists, please check if your server is able to establish outgoing connections.',
...
'OMVN_ERROR_REQUEST_FAILED' => 'Service unavailable, please try again later. If this error persists, please check if your server is able to establish outgoing connections.',
'order' => 'Order',
...
'OXDIAG_CHKVERSION' => 'Version checker output',
'OXDIAG_CHKVERS_FULLREP' => 'Run the version check for a full report',
'OXDIAG_COLLECT_CHKVERS' => 'Run the <i>version checker</i>',
'OXDIAG_COLLECT_CHKVERS_DURATION' => 'This can increase the execution time of the module or the execution might fail.',
...
'OXDIAG_COLL_CHKV_NOTINST' => '<i>Version checker</i> is not installed at this system. You might <a href="http://exchange.oxid-esales.com/OXID-oxid-oxid/Additional-OXID-Extensions/OXDIAG-3-1-0-Stable-CE-4-0-x-4-7-x.html">download the file from OXID eXchange</a> and install it in the root directory of the shop.',
...
'OXDIAG_ERRORMESSAGEVERSIONDOESNOTEXIST' => 'OXID eShop %s %s revision %s does not exist.',
'OXDIAG_ERRORMESSAGEWEBSERVICEISNOTREACHABLE' => 'The web service is currently not available. Please try again later.',
'OXDIAG_ERRORMESSAGEWEBSERVICERETURNEDNOXML' => 'The web service didn\'t return valid XML.',
'OXDIAG_ERRORVERSIONCOMPARE' => 'This text is not supposed to appear. Please try again.',
'OXDIAG_FINALNOTE' => 'End of analysis.',
'OXDIAG_FORM_LIST_ALL_FILES' => 'List all files (also those checked as okay)',
...
'OXDIAG_INTROINFORMATION' => 'This script is intended to check the consistency of your OXID eShop. It collects names of PHP files and templates, detects their MD5 checksums and connects for each file to the OXID web service to determine if it fits this shop version.',
'OXDIAG_INTROINFORMATION_CONTACT_US' => 'You can contact us using',
'OXDIAG_INTROINFORMATION_DATA_TRANSMITTED' => 'The following data will be transmitted to OXID:',
'OXDIAG_INTROINFORMATION_FILENAME_TO_BE_CHECKED' => 'Filename checked',
'OXDIAG_INTROINFORMATION_MD5_CHECKSUM' => 'MD5 checksum',
'OXDIAG_INTROINFORMATION_MORE_INFORMATION' => 'For detailed information please see',
'OXDIAG_INTROINFORMATION_NO_PERSONAL_INFO' => 'It doesn\'t collect nor transmit any license or personal information.',
'OXDIAG_INTROINFORMATION_ONLINE_CONTACT_FORM' => 'Online contact form',
'OXDIAG_INTROINFORMATION_OXID_ESALES_BLOG' => 'OXID eSales blog',
'OXDIAG_INTROINFORMATION_REVISION_DETECTED' => 'Revision detected',
'OXDIAG_INTROINFORMATION_VERSION_DETECTED' => 'Version detected',
