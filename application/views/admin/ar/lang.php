...
'USER_LIST_CUSTOMERNUM    ThCust No.rt of OXID eShMENNUITEty EditAdminister Users
 *    OXID eShop SUBCommunity free software: you PLACEy Editiityrt of OXID eShZIP    Th GNUt of OXIMAINhop CommuSNRy Edition.omer
 *
 *    OicensEMAILLOGI*    Thi-mail/Login Public LicensHASPASSWORD    ThHas password? Public LicensLDANU Geneion. user Public LicensNAMit undeName, Surnamart of OXIommuniEWor
 *    (at New Poption) Public LicensRIGHTS    ThRight software:icensSTRished byStreet, rranty
 *
 *    OOVERVIEW_BONI    Th\'Traffic LY; w\' Credit RatingERCHANTABILITY or FREACKORDEshed byAborted Ordee software:ILITY or GROUP WARRANfree Groupails.
 *
 *    YoLASTBUY
 *
 ast Purchasart of OXI the GNU GeneCommunity c Licpnse
 *d Producwithout eveILITY or OXI   (at .org/t of OXIPAYMENTpe tha@linkill be usefuyment Method software:* @link   http://www.-esales.com
 * @package   lang
 * @coTYPit undecom
  Typart of OXI* @link VALUit undeValuart of OXIREMARKpe t WARRAN[News]

$sLangName  =lic License[e det�";

// -------Name  -------Remark�";

// -------f OXENTIFIER g.�";
usrRegon ised    ThThe  OXI will be r
$aLang = af is enterile hiur option)*
 *VENDO OXID eSho Community Man is Sete th soft�لامات الedistribute iDistributoe soft�لامات TITLit unde[.org Vendor Edition ration�";
�لامicensALLComm WARRANAll availableIf not, see <,
'ACTIONS_MICONUPLOA   (at Upload Ico3 of oducts',
'ACTALLAWITH�لا�pyright not, s from tITEM�إجراء>.
viewAllied warhow all'PleaOUCHERSERIE_EXPORTDONit underoupons export complete�ستعLIST_ENTRY' => 'EntrWNMAIN_NOTSEDownCTEDustomer Information',
'E   (at INGB_LIST_MENUed: ustomer Information',
'ING    Thi_MENUile cNGB_LIS..Customer InformatiGENERADMINGB_TITLE' => generaD Guestbook]',
'ADMINLLINKS_LISry',
'ADMINGB_LIS => 'LiionITEM' => 'Customer InformatiLINKS_LIST_MENUIGministr 'Customer Information',
'ADMINL shou_INnfiguRTICLESATTR' => fos freeceived a comer Informatiات الزبائنShopTIONS_LIST_MENo remote location. Pledistribute iINGB_L Serieaded to remote location.INarazi (33)Min.re det Sumded to remote locationNTRYALnity Editn isded to remote locONS_MAINOWOTT_ENTRY' WARRANValid with differles.,
'ARTICLE_ATTRIBUTE_ASction ListSAMEARTICLE_ATTRIBUTE_ITEMSsame' => 'Product\'s Attributes',
VAILAB_ALLARTI, files wroduct\'s Attributes',CALCULATEON it underalculate only once (vBUTE_BUTE_ll np not,  or category vouchers)roduct\'s Attributes',DISCOUp://www.Discountroduct\'s Attributes',=> 'En_MENUITEM' =roduct\'s Attributes',LINKS_LI => '<b>Note:ATTRIBUTE' => 'AvailablLINKS_LIRANDOty Edit new win Random Noroduct\'s Attributes',MINlic LPRI it undeAssign Attributes',
'ARTICLE_ATe hope tonizati' => 'AreCLE_new INGB_LICLE_ATTRIBUTE_TOOMANYA => 'Snity EditATTRIBUTumbee softATTRIBUTE_TOOMANYAICLE_ATs',
'lic LicenseTEMSSELLIST' => 'Produ,SATTRIBUTE'e detavailable Products',
'USMINGB_TIUseTEM' => 'Guestbookicensonizatinity Editimount'> 'Alloduct:',
'ARTICLE_BUNDLE_UNASSTATISTIC WARRANt only one weY; w    ThWilable,
'WRAPPING_COSY WARRANGift Wrapp the
 TICLE_CROation. Please take care about synchr => 'Assign Accessedistribute iSSIGNACCESSORIES' => 'Assign AcPICTURbute inPicturATTRI,
'ARTICLE_CROSRESENTPACKUE' => '<bSIGNACCESSORIES' => 'Assign AcAIN_ALLARTICLES' ACCESSOR�";
TICLE_CROicensSSSELLING_CROSSSELLING' => 'CrossALLCATS'S_MAIN_NOTSELECTED'vailable Categories',
'ARTg Products',
'ARTICLE_CROSSSELLING_EXTRAS' =>icensessories for Product',
'ARTIC);
