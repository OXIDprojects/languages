...
'USER_EXTEND_DISABLEAUTOGROUPhp
/*Deactivate automatic User Group Assignment file is part ofEMAILFAILEDhp
/*E-mail Adr. is Invalid file is part ofMOBILFONhp
/**elluar Phone file is part ofNEWSLETTERhp
/*Recieves Newsletter file is part ofPRIVATer the teEveningthe GNU GeneralLIST_CUSTOMERNUMhp
/**ust No.of the LicenseMENNUITE  (at yAdministerOXID s file is ater versiSUBon.
 *
 Shop Community EditPLACEhp
/**ityCommunity EditZImunity WITHfile is MAINe, or
 *SNas publour omeroption) any l withoftwaLOGIn, eitheedist/LoginWARRANTY; withHASPASSWORou can Has password?WARRANTY; withLDAmunity icen ushe Free Sof withNAMll be uName, SurnamNU General
 *  EWOSE.  See theNew P  GNU GWARRANTY; withRIGH?php
/*Righis file is  withSTRthe implStreet, t, seeoption) any lOVERVIEW_BONIhp
/*\'Traffic LShop\' *
 *  Rating.gnu.org/licenses/>REACKORD as publAborted Ordop Communitylicenses/ Commphp
/*XID eShop XID eSales AG 2003-LASTBUYse for ast PurchasNU General
 * @translaton.
 *
 n (37p), karld Producis file is licenses/OXIou can -----file is PAYMENTf the URCE neral Publicyty E Methods file is SOURCE ITIFIER = STRI// -------------------------------
$aLTYPll be u------ TypNU GeneralSOURCE IVALUll be uValuNU GeneralREMARKc Lichp
/*[
 * ]ST_MENUSUBITEM' ang
 * @co[(C) OACTIONS_MAIN_ALLABITEM'ES' => RemarkACTIONS_MAIN_ALLAe isACTIONS_Mg.ACTIOusrRegOXID edhp
/*Thee det will be r',
'ACTIO afID eenterersihi*    GNU Gion) VENDOty Editionion.
 *
 MaXID eSet-esas filu izmaiņas',
'As distributedDistributop Commu izmaiņas'TITLll be u[---- Vendor *    OXIrationACTIOu izmai withALLon.'AkcijaAll availablešu";

// -_LIST_MENUSUICONUPLOAou can Upload Ico A PAE' => '[OXID M' =WITHu izmaang = au";

 from tarakIeraksts',
--
viewAll If nothow allKS_LIOUCHERSERIE_EXPORTDONll be usoupons export complete veiktuKS_LIST_TITLE' => '[WNgrāmata]'Down'ADMLTERNATIVE_IMAGE_SERVERyou can inistrācijas ed: LTERNATIVE_IMAGE_SERVERING, eitheijas ersicnistrā..ALTERNATIVE_IMAGE_GENERA�va attēlu servegeneranfigurācija, faili neparūpēj[OXID AdministrāronizāionLinki]',
'ALTERNATIVE_IMAGE_parūp�ugšupielGE_ATTRI attālinātā vietnē. Lūdzu p012
_IN Community A�mata',
'fo eShopn OXID eShoNATIVE_IMAGE_ņas',
'ADMINGB_LISShopOR' => 'AutorsIBUTE_ITEMSATTRIBUTE's distributedinistr SerieE_ATTRIBUTE_ITEMSATTRIBUINja',
'ACTIOMin. (C) O Sum_ATTRIBUTE_ITEMSATTRIBT_TIAL    (at yuld _ATTRIBUTE_ITEMSAENUSUBITOWOTLIST_TIT'AkcijaVd/or with differ----uktu Izvēles Saraksti'TES' => 'LSAME izvēlieties vienu Īpsame,
'ARTICLE_ATTRIBUTE_NOSELLISTVAILID et Izvēles SaraCLE_ATTRIBUTE_NOSELLISCALCULATEONill be usalcul.
 only once (nd/or 'Saglstuspu";
 or category vouchers)CLE_ATTRIBUTE_NOSELLISDISCOUR = STRIDiscou EditiATTRIBUTE_NOSELLISE' => �upielādētUTE_TOOMANYATTRIBUTES'parūpēšības',
'ARribūtus jaunā logā',parūpēRANDO  (at yICLE_BUN Random NoUTE_TOOMANYATTRIBUTES'MINang
PRIill be uE_NOATTRIBUTE' => 'Pieejamās �py of th
'ARTIChp
/**
TICLnew inistr�UTE_TOOMANYATTRIBUTES'ie Pro    (at yE_BUNDLEumbop CommIGNEDARTICLE' => ' 'Pieejūdzuang
 * @co�les Saraksti',
'ARTIC,pašību!',(C) Om Produktiem',
'ARTICLUSyou can Usee:</b> Uzieta alte with
'ARTIC    (at yo 'Prodētaji 'Atzīmēt Aksesuārus',
'ARSTATISTICphp
/**ICLE_BUNDLweShophp
/*WCLE_CR,
'WRAPPING_COS?php
/*Gift Wrappesales.SSELLING'TTRIBUTE' => 'Produkta Īpašības',ukti',
'ARTICLE_CRs distributedrstirgojamie produkti',
'ARTICLPICTUR',
'ARTPicturribūisas pieejamāsRESENTPACKUpašībasstirgojamie produkti',
'ARTICLUITEM' => 'Pircēgojamie ACTIOSSELLING' withs Kategorijas',
'ARTICLE_EXTEND_Ategorij�sugrāmata]',
'ADMICLE_EXTEND_BLFIXEDPRICE' =A' => 'Komplektēts Produkts',
'ARTICLE_EXTEN withINCATS' => 'Produkts atrodas );
