...
'USER_EXTEND_EMAILFAILED' => 'E-mail Adr. is Invalid',<?php
/**
 *MOBILFONle is Celluar Phonemunity Edition.NEWSLETTERle is Recieves Newslettermunity Edition.PRIVAT *    OXIEvening Community EditLIST_CUSTOMERNUM   OXIDust No.of the GNU GenMENNUITEc LicenAdminister Usersblished by
 *    tSUBhe Free Sodation, either versPLACE   OXIDityof the GNU GenZIPle is .
 unity EdMAINneral PubSNware: yse aomers published bop Co    TLOGI it undeart o/Login OXID eShop CoHASPASSWORile is Has password? OXID eShop CoLDA
 *
 *anty uste it and/oop CoNAMoption)Name, Surnamunity EditTY or EWY WARRANTY; wiNew P even t OXID eShop CoRIGHTSare: yoighton, eitherop CoSTRdition iStreet, receivs published bOVERVIEW_BONIle is \'Traffic Ls.
\' Credit Rating the GNU General PuREACKORDtware: yAborted Ordtion, eitherGeneral PGROUPe detaidati Groupu.org/licenses/>.
LASTBUY of
 *ast Purchasunity Editd-esales.comhe Free Soage  plang
 d Produc
 *
 *    General POXIile is @tranunity EdPAYMENTSee th, ros   GNU Generyment Methodon, either5), rost(28)
 */

ngName  = "Ελληνικά";

// ---TYPoption)= "Ε� Typunity Edit5), rostVALUoption)Valuunity EditREMARK freele is [dist]$aLang = array( not, see <[ww.gnutf-8',
'ACTIONS_array(MENUITERemarkutf-8',
'ACTIONS_php� Πελ�g.utf-8usrRege Fouedle is The MERC will be rώθησ� afFounenterhe thiout even tublisVENDO by
 *   the Free SoMa FounSeteShoon, eτα',
'ACTIONS_ of the LicenDistributoion, eτα',
'ACTITITLoption)[@tra Vendor ftware Frationutf-8τα',
op CoALLhe Fharset'All available@version OXID�ξτε κάICONUPLOAile is Upload Ico    bπαραπά�ιοWITHτα',-------ersion  from tμα�ιόνταadmiviewAll have rhow all κάOUCHERSERIE_EXPORTDONoption) oupons export completeιόν�RY' => 'Entry',
'ADMWN�ίστα DownιαInformation',
'ADMINGB_file is T_MENUITEM' =>ed: Information',
'ADMINGB_INGle is pM' =>he tc_MENUIT.. Information',
'ADGENERAITLE' => '[OXID Ggeneraook]',
'ADMINLINKS_LISST_MENUSUMINGB_LIST_MENUITks',
'Aion 'Customer Information',
'ADST_MENUITEM' => Gtion]',er Information',
'ADMINLINKS_LIS*
 *_INion d στοείο αfoundati  http://wwrmation',
'AD'ACTIONS_MAIN_ALLARShopWITHATTR' => ' location. Please tak of the LicenT_MENU Serieremote location. Please IN-----------Min.www.gn Sumemote location. Please 'EnALlic LicenOR Aemote location. P κάπ�OWOT => 'Entharset'V Com with differme  LE_ATTRIBUTE_ASSIGNATTRsts',
'ARTSAMEATTRIBUTE_ITEMSATTRIBUTsameoduct\'s Attributes',
'ARTICLEVAILABSELECTEDwill not s Attributes',
'ARTICLCALCULATEON option) alculate only once (p ComATTRIBe uppersion or category vouchers)s Attributes',
'ARTICLDISCOU
 */

Discounts Attributes',
'ARTICLy',
'AM' => 'Custos Attributes',
'ARTICLST_MENUSNote:</b> AltE' => 'Available AttribST_MENUSRANDOc Licendow',
'A Random Nos Attributes',
'ARTICLMIN not,PRI option)ttributes',
'ARTICLE_ATTRIBUTE_E.  See n manuaount',
reIBUTnew T_MENUIIBUTE_TOOMANYATTRIBUTEe',
'Alic LicenE_SELECTumbtion, eE_TOOMANYATTRIBUTERIBUTE_ICLE_ not, see <IST' => 'Product\'s Se,TE' => 'Proww.gne Products',
'ARTICLE_USfile is Use'Guestbook',
'ADMIop Con manualic Licens'ARTICvailab
'ARTICLE_BUNDLE_UNASSIGNARTISTATISTICharset'ne Attributwes.
le is Wroduct,
'WRAPPING_COSre detaiGift WrappShop CoOSSSELLINlease take care about synchronizatioign Accessories',
 of the LicenESSORIES' => 'Assign AccessoriePICTURnew winPicturE' =>LE_CROSSSELLINGRESENTPACKUb>Note:</SSORIES' => 'Assign AccessorieNOTSELECTED' => 'IES' => utf-8OSSSELLINop CoG_CROSSSELLING' => 'Crossselling  => 'All λίστα για  Categories',
'ARTICLE_EXTts',
'ARTICLE_CROSSSELLING_EXTRAS' => 'Accessop Co for Product',
'ARTICLE_EXTEN);
