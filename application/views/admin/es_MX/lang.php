...
'USER_EXTEND_PRIVATFON' => 'Evening Phone *    ThiLIST_CUSTOMERNUMf OXIDCust No.ity Edition.
MENNUITEOXID eSAdminister Usersunity Edition is frSUBee softwarredistribute it andPLACEXID eShityity Edition.
ZIPf OXIDense*    ThiMAIN
 *
 *  SNRXID eShop omerCommunity Edi
 *  EMAILLOGIof OXID -mail/Loginished by
 *  HASPASSWORDf OXIDHas password?ished by
 *  LDAse as phop  us
 *    Thi
 *  NAMhe GNU Name, Surnamnity EdititributEWon) any later New Pon.
 *ished by
 *  RIGHTSf OXIDRightstribute i
 *  STRe SoftwaStreet, NTABILCommunity EdiOVERVIEW_BONIf OXID\'Traffic Llied\' Credit RatingSS FOR A PARTICULARREACKORDE SoftwaAborted Orddistribute iPARTICULAGROUP the imredi Groupould have received LASTBUYCommuniast Purchasnity Editi License
 * ee softwarwith pXID eShd Producd warranty PARTICULAOXI later * @li*    ThiPAYMENTul,
 xid-eut WITHOUT Ayment Methodstribute i.oxid-ess.com
 * @pae   lang
 * @copyright (C) OXID eSalesTYPhe GNU 
 * @ Typnity Editi.oxid-esVALUhe GNU Valunity EditiREMARKul, the im[php]añol de Méxicotails.
 *[ou sh-----------------Méxic---
//Remark-----------------  ThG
// ---g.-----usrRegu canedf OXIDTheEditi will be r
'charse afcan enterop Chirsion.
 *munitVENDOdition is ree softwarMa can Setl Pustrib'ACTIONS_LIST_MEodify
 *    Distributoistrib'ACTIONS_LISTITLhe GNU [* @l Vendor e: you cration-----'ACTION
 *  ALLee s the imAll available.gnu.org/liceed Products'ICONUPLOA later Upload Ico*    select one frCTIOWITH'ACTIO AG 200nu.org/ from ter I'All availattp:viewAllMERCHANhow allges',OUCHERSERIE_EXPORTDONhe GNU Goupons export completeion',
' => 'Customer InformWNove list tDownmake' => 'Guestbook',
'ADMIE later 'ADMINGB_LIST_ed: ' => 'Guestbook',
'ADMIINGf OXID LIST_op CcADMINGB..M' => 'Guestbook',GENERAS_LIST_MENUITEM' generaustomer Information',
_LIST_TITmation',
'ADMINGBLinks AionMENUSUBITEM' => 'Guestbook',_LIST_TLINKS_LISG => '<bUBITEM' => 'Links',
'ADMINLINKS_ copy_INd to NS_MAINSELECTED'fon rediU General P 'Guestbook',S_LIST_MENUSUBITEM'Shopromotions',
'Aronization manually.'odify
 *    'ADMIN Serie synchronization manuallINLangName  =Min.You sh Sumsynchronization manualustoAL  OXID eS hopsynchronization mucts',
'OWOT 'Custom the imValid with differlangn Attributes',
'ARTICLE' => 'ProdSAMEs Attributes',
'ARTICLEsameE_ITEMSSELLIST' => 'Product\'sVAILABONS_MAIN. Please SELLIST' => 'Product\'CALCULATEONthe GNU Galculate only once (v,
'ARute!'ake pnu.org or category vouchers)SELLIST' => 'Product\'DISCOU
 * @paDiscountSELLIST' => 'Product\'r InfoKS_LIST_MENUSELLIST' => 'Product\'_LIST_TIiguration detATTRIBUTE_NOATTRIBUTES'_LIST_TIRANDOOXID eS',
'ARTI Random NoSELLIST' => 'Product\'MINtailsPRIthe GNU LECTLIST' => 'Assign Selection useful,TICLE_ATE' => rean Anew 'ADMINGect only one Attribute> 'Ple  OXID eSttributeumbdistribonly one Attributeection uct\'tails.
 *ARTICLE_ATTRIBUTE_NOAT,E_ATTRIBUTEou shCLE' => 'Assign ProducUS_LIST_MEUseGuestbook]',
'ADMI
 *  TICLE_A  OXID eSh'AssigIGNARTnassign Product',
'ARTICLE_CRSTATISTIC the imS' => 'All weliedf OXIDWCCESSO,
'WRAPPING_COSn the imGift Wrapp Publicn Accessoanually.',
'amount' => 'Amount',
'AR_ASSIGNCROSSSELLINodify
 *    ICLE_CROSSSELLING_ASSIGNCROSSSEPICTUR> 'SavePicturATTRIselling ProductRESENTPACKUnfiguratiCLE_CROSSSELLING_ASSIGNCROSSSECTIONS_MAIN_ALLARCROSSSEL-----n Accesso
 *  ts',
'ARTICLE_CROSSSELLING_EXTRASE_EXTENDabove list to make  => 'Bundled Product',
'ARAccessories for Product',
'ARTICLE_EXTEND_ALL
