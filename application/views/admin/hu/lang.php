...
'USER_EXTEND_MOBILFON' <?phCelluar Phonee is part of OXINEWSLETTERCommunRecieves Newslettere is part of OXIPRIVATop CommunEveningtion.
 *
 *  LIST_CUSTOMERNUMCommuniust No.
 *    it undMENNUITEms of tAdminister Userseneral Public LicenSUBse as publ*    the Free SoftwPLACECommuniity
 *    it undZIPCommunr op is partMAINder the tSNmunity he GomerNU General PuersioEMAILLOGIute it a
/**/Loginy later versioHASPASSWORDCommunHas password?y later versioLDAoption)thou usoftware: yoersioNAMicense,Name, Surnam
 *
 *  nty ofEWeful,
 *    bNew PTHOUT Ay later versioRIGHTSunity Eight the Free ersioSTR*    OXIStreet, 
 *
 NU General PuOVERVIEW_BONICommun\'Traffic Llic \' Credit Ratinguld have received aREACKORDmmunity Aborted Ord   the Free received GROUPeral Pu*    Group If not, see <http:LASTBUYt even ast Purchas
 *
 *  * @link      se as publw.oxip-esalesd Produc License foreceived OXI *    b@vers is partPAYMENTFOR A * @trULAR PURPOSEyment Method the Free 
 * @traators: koikaa03)
 */
 ...
 * @traVALUicense,Valu
 *
 *  REMARK eShoCommun[s fr]----
$aLang = aShop Commun[ion. ' => 'utf-8',
'ACang = _LIST_MRemark' => 'utf-8',
'AC parók',
'ACg.' => usrReg by
edCommunThe impl will be r',
'ACTIO afy
 enteror mhi WITHOUT AGenerVENDOPublic Licnse as publMaby
 Setnse the N_ALLARTICLESWIToundation, eiDistributo  the N_ALLARTICLETITLicense,[@ver Vendor ished byration' => N_ALLARersioALLse ay(
'chAll availableID eSales AG 'ADMINGB_LISICONUPLOA *    bUpload Icothat TRY' => 'Bel�THORWITHN_ALLA// ---- eSales from tkk',D' => 'KéreShoviewAllails.
how allITEM'OUCHERSERIE_EXPORTDONicense, oupons export completeNS_MAINAdmin vendégkönyv'WN',
'ADMINGDownLISTAdmin linkkezelés',
'AE *    bLINKS_LIST_MENed: Admin linkkezelés',
'AINGte it aT_MENor mcINKS_LI..'Admin linkkezeléGENERA�ciók',
'ADMINLIgeneraIST_TITLE' => 'Linkek'</b> A Sh',
'ADMINLINKS_LIiója fionUITEM' => 'Admin linkkezelé</b> A ERNATIVE_GtődnekERVER_NOTE' => '<b>Megjegyzés:</www._IN�zile' => 'Ső',
'ADMfo
 *   censes/>.
n linkkezeléTICLESWITHATTR' => Shop�rendelt cikkeég',
'ARTICLE_ATTRIBoundation, eiLINKS_ Serieennyiség',
'ARTICLE_ATTIN-----------Min.tion.  Sumnnyiség',
'ARTICLE_ATvendALerms of tERCHnnyiség',
'ARTICB_LIST_AOWOTin vend�y(
'chV fil with differ
 */BUTE_ASSIGNSELECTLIST' rtalmaz.',SAMEICLE_ATTRIBUTE_ITEMSSELsame'A lista cikket tartalmaz.',
'VAILABából f�ciót.',a cikket tartalmaz.',
CALCULATEONLicense, alculate only once (s fil!',
'A'amop eSale or category vouchers)a cikket tartalmaz.',
DISCOU: koikaaDiscounta cikket tartalmaz.',
gkönyATIVE_IMAGE_a cikket tartalmaz.',
</b> A S�dnek fel. K�ATTRIBUTES' => 'Kérem </b> A SRANDOms of t�s',
'AR Random Noa cikket tartalmaz.',
MINShop PRILicense,delve.',
'ARTICLE_ATTRIBUTE_ITEESS FOR tribútCommuniresszanew LINKS_L 'Kérem csak egy attr => 'Kerms of t ki az aumb   the �rem csak egy attrCLE_ATT
'ARTShop CommunATTRIBUTE' => 'Nincs b,LLIST' => 'ion. RTICLE_BUNDLE_ASSIGNARUSciók',
UseBITEM' => 'Vevőinersiotribúterms of th_ATTRIkk',
'GNARTICLE' => 'HozzárendeléSTATISTICy(
'chTICLE_BUNDLwelic CommunW'ARTIC,
'WRAPPING_COSneral PuGift Wrappse
 * _ASSIGNACLE_ATTRIBUTE_ASSIGNATTRIBUTE' => 'Atkesítés hozzáreoundation, ei=> 'Keresztértékesítés hozzPICTUR 'Ment�PicturATTRIndelése',
'ARTRESENTPACKUtődnek f> 'Keresztértékesítés hozzistából felül,ereszté' => _ASSIGNACersioTICLE_CROSSSELLING_CROSSSELLING'  tartozés',
'ADMINGB_LIST_'ARTICLE_EXTEND_ALLCATS' =zzárendelt keresztértékesített cikk',
'ARersio_CROSSSELLING_EXTRAS' => 'Hoz);
