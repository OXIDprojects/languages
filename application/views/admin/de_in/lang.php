...
'TOOLTIPS_FORMAT
 *  Format : YYYY-MM-DDt of OXID eShITEMDELETE
 *  Eintrag löschart of OXID eShCommSTORNOEdition is frestorns part of OXID eShCommUNASSIGN
 *   erknüpfung zu Shopee soart of OXID eShNEWACTIONS
 *  Neue Aktion anlegs published by
 * DDRESe Free Softwadressepublished by
 * RTICL EditioSoftn Artikelundation, either versionCATEGORY Free SoftwKategorie*
 *    OXID eShop CommuniTRE Editiostributedbaum neu indizs part of OXID eShommuONTENmmunitySoftwCMS-Seitd in the hope that it willOUNTEdition is ds Landundation, either versionDELIVEEdition is diVersandkostenreg
 *
 *    OXID eShop Comm    GNU SEimplied warrlic Licartre details.
 *
 *    YoIS FITNy later versRabatof the GNU General PublicedistS FOR A PARTAttribuof the GNU General PublicLANGUAGny later ve Sprachd in the hope that it wilLINKy later versLinkundation, either versionMALLCommunitySoftwMallistributed in the hope that it wilMANUFACTURE*
 *  r versHerstellerOXID eShop CE
 * @translWSe
 *    alonMwSt. Satzundation, either versionNEWe Free SoftwNachrichof the GNU General PublicformLETTmin (495), d Newsletter Vorlag*    (at your optPAYMe implied warrZahlungsy of the GNU General PublicPROMO  th Free Software Fo/PromoM' =>BannerNTY; without eveREMAR@packageoti$sLafüion, either versionSELECTLI4), Thielo ( Auswahllis
 *    MERCHANTABILITY orSHOPn (495), dsbLicene verfügbaren Artikel',TATISTIC * @link    tatisti
 * @copyright (C) OXID eUSmin (495), dr Benutzation',
'ACTIONS_Lte wGROUACTIONS_MAIer Liste gruppd in the hope that it wilte w-------------
$aLang = arrayNTY; without eveVAR1n (495), d
'ADMINGB_LIST_MENU2
 *  Untation',
'ACTIONS_LVAR3
 *    This findation, either versionVENDOin (495), dsbLieferanof the GNU General PublicVOUCHURCE IDENTIFIGutoftwinseted in the hope that it wilWRAPPINGtion',
'ADMIeoftwakverpackPublndation, either versOPENHELACTIONSHilfe startaltung]',
'ALTERNATte wNS_MAIN_ALr Liste > 'Allöffnart of OXID eShRECALCNROFion) anSINs AG 2003ion.
 anzahl deristributednTHOUTberechtikelbilder von einem externen ServeMAS_LIST_n. Dateien werden  (1), marcozu diesem Speicherort hochgeladen. Stelle bittVNDie manuelle SynchronisatINLINKS_Lht zu diesem Speicherort hochgeSETexternen Server zu laden. Dateien werin den aber nicht zurücksetzTRIBUTE_ASSIGNSELECTLIST' => 'Auswe die manuelle SynchronRTICLE_ (1), marc_ITEMSATTRIBUTE' => 'Artikel hat diese Attrib.'IGNATTRIBUTE' => 'AttriRTICLE_ zuordnen',
TEMSATTRIBUTE' => 'ArtikelTIMEop CommunityZeit  Editi:t of OXID eShVALDES Artiken is fr1__@@n is fr2SELL usw.t of S_RATINGS_BUTTON_ALShop ist werte uLISTIN_ALLA!n. Ausw.listen'URL_TITany lateTrusted_ALLAs KundenbUTE_Ounion, eiUPDATEAPP_DIRNOTunity D_WARNNLINKS_LIBitteee softw das updateApp-Verzeichnist ofusereful,
,
'ABUTE_zur Bear_NS_M_MENUCommhop ist konfig verwalE' => 'ATTRIBUTE_TOOMANYATSUBTRIBUTES' => 'BittNGB_LI Attribut ausw�MAITICLLMEMBERn.  If Allus',
'ADMI 'Alle verfügbarentikel'IN BearbeitunMitglieden den LE_ALLITEMS' =Attribut_ 3 of t_    GNU  3 of the LicINLINKSor
 * Attribut_ion) an_QUANTITdition Aen weE' => 'ZuEXTEND_BONI_ATTRIBonitä,
'ADSSELLING_ALLCRhp
POINTn.  If BonuspunktE' => 'ArtING_ALLDISABLEAUTO BearbeitunKeine automTIONTONELE_ALLITEMS' =>-Zuordnungrfügbaren ArtikEMAILFAILENATTRIBE-Mail, or. ungülti' => 'CrosssellinMOBILFNS_LIST_Telefon mobi_CROSSSELLING_ALL
// RESOURCE IDENT = STRINrfügbaren ArtikPRIVATrdnete CrossselliprivaerfügbareTOOMACUSTOMERNUBUTES' ',
'ARnumm 'ZugeordneTOOMANYAATTRIBUTES' => 'Bitte nur ein AttributTEXTRA' => 'ARTICLE_BUNDLE_ALLITEND_ARTINCATS'PLAC EditioO',
'ADARTINCATS'ZIACTIONSPLZRICE' => baren'Alle KaSN*
 *  ,
'ARTIren. A erlaubt (gs zuLOGIS_LIST_TICLE_/LogiTEND_ARTINbarenHASPASSWORNATTRIBHat ein Passwort?END_BPRICE' =>LDAACTIONSCRIPer Liste obenD_DEFAULT'NAM EditioVor-/ ---namE' => 'ArtTICLE_----Als HauptkatA PART.',
'ARTung',
'ARTICLERIGHCLE_CROSRechASSIGNACCESbarenSTRm)',
'ARStr./HausEXTEND_BPRICOVERVIEWLITEMS' => 'Alle ve als Ampe_CROSSSELLD_ERRORSAVREACKORDmin (495AbgebroftwaSELL), maATTRIBUTE_ größer als BearLE_CROSSE_ALLITEMS' => 'Alle vößer alsLASTBUdition LetzRINGKauf => 'Datei',
'ARTICLE_TRIBUTES' ZulEUPL gekauftesion.
  => 'Datei',
'ARTIOXINATTRIBoxidung',
'AR------------------------
$aLang methoTICLE_ATTR' => 'H:'-------------ang = arrayCLE' => 'Zuikel ist indiviTYP EditioMURABLEntypICLE_EXTEND_ISSEAVALU EditioWestierende MIST_MEE_CRO
 *  [TRAS]:',
'ARTICLE_EXTler Preis s[LE_E.aße',
'ARTICLE_EIST_MENUSUBI[Bem => 'Mediendateiente wähle [Reg => 'MusrReg 'Alred
 *  DE_ASSIGNEDA wird nachDLE_AEingabe s,
'A => 'Existes r,
'ARri 'L:',
Gäste_TOOMANYATTRIBUTES' Stamm=> 'rt ofNTS' => 'Alle ne'ARTICLE_BUND zuordnen',eren.',
'ARTICLE in neuem F['ART. Attribute' nur eiungaße'NTS' =>baren Arition.  If CLE_Bver'AktbaEWWI => 'Versan_UNITNAME' =ICONUPLOANATTRIBIcon hochlad Template',
'> 'MendistWITHGästebuch]'ion.
 *von diesem. Attribute't ofviewAllneinheit',
anzeiion, eiinformaSERIE_EXPORTDON EditioINLINKS_Lexpo of bgLE' loTICLen. A> 'A:',
'ARTICLE_EXTEWN'ARTICLE_EDownloaND_HE> 'A:',
'ARTICLE_EXen',
'AREPRICEB' = => 'B:IPDIn Att> 'A:',
'ARTICLE_EXNLINKS_LIEt aktualDMINLINKS_Le ..TEND_UPDATEPRICEC'GENERAzur festgTICLE_> 'StartzeitgenST_Mlisieren',
'ARTICLE_UPLOADFILEND_UPDATEPRICEB' den (groLinks
'ARTICLE_EXTEND_UPDATEPRICEC'UPLOADFNLINKS_LIGen (gro=> 'Startzeit:',
'ARTICLE_EXTEND_URL',
_zuordnen',
'AVARTICLE_E fü_ASSIGNEDARTICLEEA' => 'A:',
'ARTI 'Alle neg. NachläshopS_LIEXTEND_EXTURLEXTEND_WEIGHT' => 'Gew'ARTICLE_BUNDINLINKS_LIST_MGHT_UNIT' => 'kg',
'ARTIIND_LENGTH' =Ab AnsIPPIsTE_OHT_UNIT' => 'kg',
'ART
'ARALtegorien'NNIT' =>> 'A:',
'ARTIbaren ArOWOT:',
'ART_MASS' GING_CR miof tderer SST_MOADABLE' => 'Download von DSAMEn für diesen Artikel zugl�hlen',
'ARTICLE_FILES_NEW_FILE' =>VAIL 'ZuLDESC' => 'Text OADABLE' => 'Download nem ULATEONND_BLFIXNuretzemaligdiesem Spe (LING_CR nur bei zugew' =>Neue 'Startzein)OADABLE' => 'Download  License
 *  g withOADABLE' => 'Download CLE_EXDATEPRICETIMOADABLE' => 'Download UPLOADFIen, UnterstrichGHT_UNIT' => 'kg',oder Namen eiRANDOD_WIDTH'en (ate Random Nur nach Bezahlung verf�MINler PPRIND_BLFIXn Artikeaer hochgeladenen Datei angeben'
'ARTICLinformation',
'ADMINLINKS_LADMINGB_TITLEFILES_TABLE_UPLOADES_TABtegorien'ZufallsICLE_En  wäu'ARTICLE_LIST_ALLPRODUCTSue Dateateieler Preis shladen auswählen',
'ARTICaden'ateico (ssennCLE_EXTEND_TICLE_LIST_ALLPRODUCTSUSen',
'ARLE_EXT_OR_FILENAME' => 'oder informategorien'INLINKS_LICLE_EXTENCTIVFROMTILL' => 'Oder akeordnete r diesenene Dateit ofweighten, Untew----t of'ADMINLIT' => 'Gewicht',
'ARTICLE_EXTEND_WEIGHT_U_MAIN_ARTCOPY' => _EXTEND_WIDTH'LE' => '[OXID LinAIN_ARTNUM' => 'ArPI: adm_ATTRIBUlND_HEsteller EAN',
'ELECNTPACKUhlen, UnteAIN_DISTEAN' => 'Hersteller EAN',
LE_EXTEND_TPRICE'RTICLE' => TICLE_EXTEND_MAIN_ARTbaren'ARTICLE_MAIN_EAN' => 'EAN',
'zu',
'AR,
'ARTICLE_E_EAND_UPDATEMEDIA'ORY' => 'In KatE_MAIN_ERRORSAVINGARTICLE' => 'Warnung: Artikelnumbarenereits vorhanden!',
'ARTICLE_MAIN_GOTO');
