 ...
 *    TUsublished by
 *   ill GROUater version.
 * but Grou    OXID eShop Coill redistribute it and/or modify
 *    it under the termVAR1ommunity  PURPOSE.  See the2php
/beloU General Public Lic3php
/c*
 * Variant your option) anVENDO be useful,
 *   Distributoblished by
 *   VOUCHl be useful,
 *   Coupon Serion.
 *
 *    OXWRAPPINGter version.
 *Wrapping file is partOPENHELater veStart Hel    OXID eShop://will ion 3 of tOpenmplied (at your option)RECALCNROFARTICLESINCA?php
/Recalculon.
umber of Products in Categoriehe hope that i2012
 * @version OXMA GNU GeCE
 * @translators: crashover (33Manufacturer
$sLangName  = "Българск�VND

// -------------------------------
 License
 
$sLangName  = SET * @version OXID eShop CEsetnslators: crashover (330)
 */

$sLangName  = _LIST_MENUITEM' =�";

// -рмация за клие// RESOURCE IDENTIFIER = STR_LIST_MENUITEM' =-----------рмация за клиеarset' => 'utf-8',
'ACTIOTIMEFORMD eShop Time Format:  file is partVALDESEditionEntry1__@@ => '2�о� usw. file TAL_PLUS_PROPORthe AL_his hp
/plusThis (proporPublally 
 * @trad) fileS_RATINGS_BUTTON_AL�ка �Write a review!ите промURL_TITLEпро�rusted
 * s Customer Ratinghe hoUPDATEAPP_DIRNOTDELETED_WARNu.org/licPlease delete directory: updateApp => 'ubut hp
/*�изаADMINANTY; wi_ion _MENUITEMree Softminisis f but'ADMINнига за гоSUBсти',
'plied warr=> '[OXID Кн�MAI�',
LMEMBERID eShoAllTLE' => '[OXID Кн�TEM' 'Ин�INY; without plied warr Meator=> '[OXID_ADDRESS_DELIVERY�и',
'xid-esahi * @l Address

$sLъзкersion_QUANTITYMENUSUQuantity�ка к�EXTEND_BONIphp
/**ditне',
та]',
'ALTERNACREDITPOINTID eShop CRVERpointзка к�ALTERNADISABLEAUTOY; without Deactiv
 * automaticmplied warr Assignfy
iguration detectEMAILFAILE-------E-mail Adr. is Invaliit unation detectMOBILFe GNU GeCelluar Phonon.
ation detectID eShop CommuniRecievesEdition is TE' => 'Assign APRIVATTTRIBUTE_Even[OXITRIBUTE' => 'Aза CUSTOMERNU�и',
'BITE No�етписъцMENости',
'ADMINGB_TITLE' => '[OXID_ATTRIBUTE_� гости]',
'ct\'s AttributePLACGB_LISTC�ята]',
'за ZIater ve�с�ARTICLE_TEM' ите �SN be usef�иза�',
'ARTICLE_TEM' onizaLOGIсвоя.',
'/Login� по изб�HASPASSWOR-------Has password?� по изб�LDAater ve�д� IST_MRIBUTE' => 'ANAMGB_LISTName, SurnamUTE' => 'ATICLE_n reIBUTES' => 'ty EP�я иЃт',
'ARTICLERIGHive imagRighnfigurationTEM' STRTICLE_ATStreet, ate AtNOATTRIBUTE' OVERVIEWATIVE_IMAGE\'Traffic LIBUT\' _SERVER_NOTE' => '<b>N',
'ARTICLREACKORD CommuniAborRY' OrdTE_ITEMSSELL',
'ARTICY; wi_TITLE'',
'ADMINLINKS_LISTbute:',
'ALASTBU�стрLast PurchasUTE' => 'AES' => 'Pleasсти',
'only pne Attrdcrashoveribute!',
'ARTICLE_OXI-------ду�ARTICLE_redistrcan redistribute �ци ify
 *    iаличнUNDLE_ASredistribute ign на продукта',
'ARTICLE_BUTYPGB_LIST*    i TypUTE' => 'AUNDLE_ASVALUGB_LISTValuUTE' => 'A the FAttriMENUSU[diti]ssign Product',
EATTR' => '[electELLING_ALLITEMS'  the Free So[RemarkELLING_ALLITEMS' ill be use[Reg.ELLINusrRegGB_TIedпро�heиб� will be r 'Assign  afis fenter[OXIhiоля иЀет the G за гости',
'MaB_TITSet�',
'ADMIсвояване� гости]arset' => 'utf-8свояваDMINGB_LIST[ду Vendor ADMINGB_raPublELLINсво�TEM' => ст�ормацavailable�ки нал�АксесоICONUPLOA-------Upload IcoCLE_ATEND_ALLCATS'и �WITH the GNU Genrashover from tLLIN License
 *   HOR'AllTITLE' =ow allчн�XID eSSERIE_EXт �DONКатаion. s ex з� coe soteПри�E_EXTEND_ARTINCATS' WNВсичкDown н�зи категории manuallодуктътed,
'ACT категорииu.org/licE�ът[OXIc�дук..�зи категоGENERA� промоци�gener�а�rice Alert)',
'ARTIICLE_EXTE => 'Продук 'За�*   е в тези категоICLE_EXu.org/licG',
'ART'Покупна цена',
'ARTITICLE_MINLINKS_LISTA�укт',foITLE' ADMINLINKS_ категоза гости',
'
 * одажби', точен  URL ад� гости]tion.  If noете точен  URL �INARTICLE' =>Min.select Sum�те точен  URL ND_AAL�о из�_NOS�те точен TEM' => OWOTXTEND_ARTICLE_CVРа with differy
 �ли YouTube!)',
'ARTI�о-голSAME� от нормалнаsameна.',
'ARTICLE_EXTEND_EXTURLVAIL filXTEND_ENTERURL'
'ARTICLE_EXTEND_EXTUR12
ULATEON'Ката
 * @tranonly once ('РаARTICL=> 'pashove or c)
 */y vouchers�итTICLE_EXTEND_EXTURDISCOUtribute Discou care TICLE_EXTEND_EXTURINCATSD_BPRICE' =>:',
'ARTICLE_EXTEND_ISICLE_EXT�ие',
'ARTID_FILEUPLOAD' => 'Ка�ICLE_EXTRANDO�и',
'�де п Random No:',
'ARTICLE_EXTEND_ISMINEATTRPRI'Кат�INGTPRICE' => 'ВниманиеичниOXID eShop Community Edition. ,
'ARTICLE_EXTEND_EXTURARTICL�о из�CH' => 'lator,
'ARTICLE_EXTEND_EXTUR 'Въ�ям�EATTR' => 'RL адрес',
'ARTIC,�та це�elect:',
'ARTICLE_EXTEND_ISUS manuallUseFIXEDPRICE' => 'НTEM' рилпо избion.  ARTICLOUNTS' => 'Skip all negative mmunity EID eShop_EXTEND_MEweIBUTADMINGТегло:.,
...
'ARTICLE_EXTEND_алNTPACKU�ние',=> 'RRP',
'ARTICLE_EXTEND_UNIToducts',
'ARTICLE*
 * @lELLINTICLE_EXTTEM' _UPDATEMEDIA' => 'Актуали�CLE_EXTE 'Всички наRICEA' => 'A:',
'ARTICLE_E�я на медиите',
'ARTICLE_EXTEND_UPDTEM' ICE' => 'Базова цен�);
