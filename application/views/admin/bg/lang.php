...
'THEME_AUTHOR' => 'Author'<?php
/*PARENT_hp
/*TITLE   ThiParent theme is part of OXID VERSIONS   ThiCompatible pition.
 * versions is part o Commun   ThiVu can  is pOOLS_LIST_ACTIONEND   Thisction completed *    it under tFFECTEDROWity EdiAffected rowredist it under ERRORMESSAGunity EError messag
 *  re Foundation, NUMversion 3 ofnumbee is p it under MENUITEour optServicicense, or
 *  
 *SUB    OXID eToolSoftware FoundatSECCESity EdiBackup data mailed successfully. hope that it wiQLQUERYOXID eSQL queryer version.
 *Community E[OXID n the]er version.
 *UPDATEVIEWSFAILEs of thDB Views update fWITHOTY; without evenPURPOSE.  Sill be useful  GNU General POUT ANY WARRANTY; withoutMAIN_CHECKPICity EdiSearch and deal P unused PictureSoftware FoeneraSQLDUMB   ThiImport arraFile<br>(large files should be uploaded via ftp)mmunity Edition.TARTLicensetart Ural Pmmunity EditionNTABILITY or FITNESS FOR A PARTICeneraPURPOSSQL   Thie   lap://003-2012
 * @versionE.  SCONFIRour optAre you su val (9waon.oneral PuvU Gennow?@translators: crashover (3INFOy
 *   teree sticular DB ta frestruhop Cneral Ps, in order changessLantake e  theal (9needsLanregenerCE
DB = 'Бf the GNU GeneraPURPOSE.  SNOWID eShop CE
  GNU Gennower versiTIPS_ADDSUMITMTYPunity EAbsolute, percentaggnu.o or Productnu.oMarkup/Discountмация за к�ента',
'ACTION ornu.oLIST_MENUSUBITSurch/lic/Re'П�y
 *    itя з�RTICLEDELIVimplied wTime Format: CTIONS_MAIN_ALLARTICRver (   ThiOpen => 'П� Pre= '�CTIONS_MAIN_ALLARTICSTOCK   ThiQuantity => 'П�sRINGstockCTIONS_MAIN_ALLARTICTEMPLATunity ETemplCE
ww.gnamgnu.oif not defaulCTIONS_MAIN_ALLLARTICUNITDESCRIPe teID eShon// -the basic price is_LIST' => 'LangINGBstand,T_ENedUBITEMn a specific unit of mea33)
appli STRINcludingUBITELISTsaes/>tax   aloth---- => 'eneronentrset' => 'LIST_AUTHOR' RLIMGty Edit-----�а�t�праs----Public LicLIST_AUTHOR'VAm
 * @p'Инy only if individual LINK�ости]',
'Ander NEWROmunity ECreCE
new Rolang
 * @�а клие�а',GENERAT*    Thi(Re) G = arrayRights &T_MENs fieldSoftware �а клие�SEARCHFIELDOXDYNAMIC   This
 *  към администрацияSHOR 'А�
'ALTERNATIV ShhttpDescrip,
'ACTIONS_MAIN_ALLAнистрацияCommunity E сърTitENUSUBITEM' => EDITVA    ThiEdit VariaACTIONS_MAIN_ALFORMINKS_LISрод : YYYY-MM-DDция за �    DEе,   You sng witEnt of
 *   ване STORN-------Cancel�те по избор',UNASSIG�',
'ADMIassign from>.
pция за �NEWthe teity EditLINKS_LISTe GNU �та',
'ARTICLE_DDRbe usefulEMSSELLIST' ddres� към ад�CLE_LARTICисъцит�New => 'П�бор',
'ARTICLCATEGOmplied wOATTRIBUTE'Cateog� по избоатрTREIBUTE_NRe-Index_ATTRgory TreNUSUBITEM' => атONTENm
 * @,
'ARTICLE_AonteACTIONS_MAIN_AL�утUNT�ути',
'ARTICLE_A
'ACUTE_NOATTRIBUTES' LESWITHATTR' =EMSSELLIST'Shipping Cost RuENUSUBITEM' => ,
'ARTICLE_SEARTICLE_ATTRIBNINNEWWINDOW'Metho гости]',,
'AISчн�ATTRIBUTE_OPENINNИ',
'ACTIONS_MAIN_ALNEWр',
исъците п�ttribulang
 * @UTE_SELELANGUer versioOATTRIBUTE'Langu License, o� атр�INере�EMSSELLIST'Lin�ъка по-�NEWMALLCINKS_LISOATTRIBUTE'Mall_ATTRIBUTE_NOATTRIBUTES' MANUFACTURE    ThiEMSSELLIST'Manufahop Cter versi�мо е�WS=> 'Запази',�ация за �NEWNE by
 * лични �the License, o на проLETT�и наUTE'Newslet----Saeral 'Assign на пPAYM
'ARTICLE_ATTRIBLISTPaymion.�',
'ARTICLE_ATTRIBUTEPROMOор',
'ADUTE'e GNU /PromoS' =>Bannкти',
'ARTICLE_REMARере�Add No�ерете атрSELECр',
ATTRIBUTE_OPENINNEele GNU GLis�алични а�SHOPатрибут',
Sукта',
'ARTICLESTATIST',
'ALTEUTE_OPENINNEtatistic�бор',
'ARTICLUS�и налични Usкти',
'ARTICLE_ICLEGROUSSELLING_ASSIGNCROSSSE Grouкта',
'ARTICLEICLEUNDLE_UNASSIGNARTICLE' => 'Unassign Product',
'ARTICLEVAR1LING_ALLI'ARTICLE_EXTEND_ALL2   Thibelрмация зND_ALL3   ThicLINKS_�',
'ARTICLE_ATTRIBUND_AEND*    Thi�пази',
'Aизбle is pCLE_EXTEND_AOUCH�и налични Coupon Seri�т:',
'ARTICLE_BWRAPPINTITLE' =ATTRIBUTE'WraINDOWция за �OPENHELSSELLINpackagHelкта',
'ARTIмаICLEIGNACCESSOTIONSE_CROssories',
'ARTICLRECALCNROF�я, и�INн атрRecal----RIBUy lat�аѽа от сЀетеiCommunity �пна цена',
'ARTICMA�',
'AD_DEFAULT' => 'Задай като продук�на Категория',
'ARTICLVms of th_DEFAULT' => 'Задай като 
'ARTICLE_E�на КатегSET�на',
'ARTICLE_EXTEND_Dset> 'Задай като Основна Катег за тези weE_EXTEND_DE�жения <br>( PDF, mov,
'ARTICLE_EXTEND_DIMENSIONS за тези weTICLE_EXTEN�жения <br>( PDF, mov точен  URL адреTIMETE_ASSIGNSEL> 'Продукти в п�VALтивенте 1__@@те 2TEND uswTY; witTAL_PLUS_PROPORe teAL_LINKS_LISplus' => (pro<httionally EFAULT' =d//www.S_RATINGS_BUTTON_ALACCESSOWrite a SELECT!RTICLE_EXTEND_FURLght (C) OXIDTruseceiSSSEs Customer RatingredisPURPOSAPP_DIRNOTна �D_WARN',
'ARTICPleaselong witdirectory:neral PApp�наuSSELпроT' => 'TICLEelling Pn.
 *
 *    OXID eAdminis----SSSERTICLE',
'ARTICLE_EXTENDdistributed iE_CROSSSEL�сене',
'AReneraALLMEMBERby
 *  llтърсене',
'ARenera'Ра�INing ProductE_CROSSSEL Me lat�сене�а сп_LESWITHAа списъEWWINDOW'о изCommunE_EXTELARTIC_QUANTITplied w�е едCLE_EXTENEXTEND_BONI'ARTICLE_�т�:',
'A�онтакт',
CRи �POINTEATTR' => �т�pointICLE_EXTENкт',
DISABLEAUTOing ProductDeactiv' =>automaticLE_CROSSSEL A�а �Unasби',
'ARTICLE_EMAILee the
 *  E- WIT Adr.'В�Invaliublic',
'ARTICLE_MOBILFр',
'ADCelluar Phon�т:'',
'ARTICLE_ICLE' => 'ПакRecieves�ен прЇество',
'APRIVATUANTITY' EvenDOW'личествnder CUSTOMEt your opt�и� NoTY; wCLE_EXTENDMENND_ISSEARCH' => 'за търсенеена:',
'END_LENGTH' => 'LEA' => 'A:',
'APLACIBUTE_NO. контаnder ZISSELLIN => ва ц�eneralUPDATEPSN� проT' => 'Hзова ц�eneraRTICLLOGI� медNAME'/LogiКаѷация HASPASSWORs of thHas passwordгаѷация LDASSELLINCETI �соEND_UPDATEPRINAMIBUTE_NName, Sur�е �лен час:_BUN време'UTE' TICLE_E�лен часRIGHи ра�> '[OX�лен часSTRCES' => Street, газ�ализацOVERE.  
'ARTICLE_E\'Traf�ф�L '[O\' XTEND_SKIPDISCOUNTS' =�о на �REACKORD�и наAboreceiO
// 'Това �о на ing PEATTR' > 'L:',
'ARTICLE_EXND_URLDESCLASTBUplied wLast P�одsLOADFILE' ,
'ARTICLE_EX    OXID eHT' =p 'те�d�й каѳло',
'ARTICLE_E FITE_EXTEN:',
END_UPDAUNDLE_ULE_BUNDLE_UNASSIG�а',
'Unassign Pr_EXTEND_WIER_FILENUNDLE_UNASSIG�те име на каченения фента',�',
'A TypLOADFILE' ER_FILENVALUIBUTE_NValuLOADFILE' родARTICLITY orенOR A �ове за�игурн[
'ART�дукт',
'ARTIродукт[Remark�дукт',
'ARTIICLE_CROSS[Reg.OR A usrRegза ed'ARTICLheач� will
 * rCHASEDONL a-----enterDOW'hi'ARTICLE_ETY; wтенn.
 *
 *    OXID eMa�а �Set,
'ARTICLата',
'ARTICLdistributed i точен  URLата',
'ARNTABILITY or FITNVendor  => 'з�ra н�OR A ата'ASS' => CTONEATTR' и',availESOURARTICLE_EXTEете фа�ICONUPLOA,
'ARTIUlink  Ic'Ка�ли  посЀ',
WITHтен прна от ро�tед
'ARTICLE_EXTEN= '�Alltangibleow allсъ�=> 'ПSERIE_EXTENDDONIBUTE_NO� в s ex<httpeneral Pu�пк�TICLE_FILES_TABLE_PUWNте им�Downink �амо',
'ARTICLE_FILEhe
 *  NLY' => 'За�edукт�о',
'ARTICLE_FILE',
'ARTICEЗа�DOW'cLY' => ..само',
'ARTICL�',
'AD�лове',
'ARTg = arraST_ALLPRODUCTS' => 'ITEM' => URCHASEDONLY' => g = arrNU General PuTICLE_LIST_MENUSUBITEM' =',
'ARTIC_TITLE'укти',
'ARTICLE_LIST_MENUSUBI => '_ 'Медий�AS_OR_FILEfo тъ�:',
'ARTICL�о',
'ARTICL.
 *
 *    OXID eShopE' => 'Нов E' => 'Алт. ценdistributed iе в тезLDPRICE' => 'Алт. ц�IN�яне н�Min.,
'ART SumDPRICE' => 'Алт. цFILEAL your optLE_EDPRICE' => 'Ал�ASS' => OWOTLE_FILESози V�',
 with diffetion.�ебителски р�M' => 'Н�SAMEр на продукт�sameCLE_MAIN_DISTEAN' => 'Man. EANVAILEND_ктивни',
N_DISTEAN' => 'Man. EA ц�Uа �ONTICLE_EXTFAULT' =>EM' =once (т',
,
'ARTARTIpMAIN_NOor cете �vouchers//wwwSTEAN' => 'Man. EA_SAVE' => 'З�И',
'ACTIONSTEAN' => 'Man. EATABLE_�и продCLE_MAIN_INVALIDTAGSFOITEM' =>VETO' => 'Д� Продуктът в�ITEM' =>RANDOour opt_TITLE' =>andom NoCLE_MAIN_INVALIDTAGSFOMIN�игPRITICLE_EXTICLE_MAIN_ARTCOPY' => 'copy н=> 'Св => 'Продуктът е в IN_DISTEAN' => 'Man. EA�ит� your optMAIN_MPNy latIN_DISTEAN' => 'Man. EAARTICLE�ме�игурн' => 'EAN',
'ARTICLE_M,а',
'ARTIC
'ARTCLE_MAIN_INVALIDTAGSFOUShe
 *  UsPublicMAIN_PARENTNOTBUYAT' => 'RICE' => '� в �' => 'E' => 'Запази',
'ARTICL�свояity Editioduct canwe '[O�на�Тегло:FILE�ии',
_COSи ра�GiftBLFIXEDPRICE'ие.',
'�. цена',
'ARTICLE_MAIN_ALLOWCUS�кети',
'ARTICdistributed iN_TAGS' => 'Етикети',
'API�чк',
'ARTShop C�иант от',
'AябNTPACKUTIVETO' =_TAGS' => 'Етикети',
'ANTABILITY or FITNLFIXEDPROR A ие.',
'eneraARTICLE_MAIN_VAT' => 'Посоч�и оп�ете името �RTICLE_OVERVIEW_ARTMADEON'�С',
'ARTICLE_MAIN_VENDORID' => 'Прода�pyright (C) OXID eSale_OPTIONS' =>);
