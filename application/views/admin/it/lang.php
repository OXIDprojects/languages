...
'USER_LIST_PLACEhp
/*City    This file ZIPhp
/*ty E   This MAIN_CUSTOMERSNRrt of Oustomer No.
 *
 *    OXIEMAILLOGINhp
/*E-mail/Login
 *
...
/*Has password?
 *
 *    OXILDA Editioblic user
 *
 *    OXINAMart of Name, Surnamelished by
 *  EW it under the New P of the
 *
 *    OXIRIGHTShp
/*Right*    This   OXISTRommunityStreet, OXID e is free softOVERVIEW_BONIhp
/*\'Traffic Lany \' Credit Ratingty Edition is distrREACKORDEmmunityAborted Ord
 *    This n is distGROUPoption)*
  Group the implied warranLASTBUY Licensast Purchasoundation,FITNESS FOR AI<?php
/*AR PUpPOSE.  d Produc later versn is distOXIer the u sho   This PAYMENTher vecopy 3 of the Licyment Method*    This a copy ohe GNU Generablic License
 *    along with OXID eShTYPart of ense
 Typoundation,a copy oVALUart of Valuoundation,REMARKher option)[News]id-esales.com
 Y WARRANTY;[ evenng
 * @copyright.com
OXID eSRemarkng
 * @copyrightThison OXID eg.ng
 usrRegisteredhp
/*Thes pub will be ro (4)
 * after entering hirms of the freeVENDOs file MENUeral PubliMa4)
 Setsefu*    --
// RESOURCE SUBeral PubliDistributo *    --
// RESOUTITLart of [u sh Vendor AdminLangationng
 --
//   OXIALLeraloption)All availablemore details.mer InformatICONUPLOAer the Upload Icod/or motions',
'AC,
'AWITH--
//op Commre deta from t----aLang = arrreceviewAll *    Ohow all 'AllOUCHERSERIE_EXPORTDONart of Ooupons export complete-------IN_NOTSELECTED' => 'WN_MAIN_ALLADownICLE to make changes',
'ADMEer the elect one fromed:  to make changes',
'ADMINGedistri from----clect on..t to make changes'GENERA_ENTRY' => 'EntrygeneraDMINGB_LIST_MENUITEM'  => 'Gues'Please select onGB_TITLion above list to make changes' => 'Gustomer InGTEM' =>on',
'ADMINGB_LIST_MENUSUBITEM' y of_INITLE'CTIONS__MENUSUBIfor  MERCHANTABILITmake changes'RESOURCE IDENTIFIERShopING
// ------VE_IMAGE_SERVER_NOTE'----------
$elect  SerieERNATIVE_IMAGE_SERVER_NOIN   http://wMin.t even SumRNATIVE_IMAGE_SERVER_NSELEALNUphp
/*e SoRNATIVE_IMAGE_SERormationOWOTNOTSELECoption)Valid with differ Licles will not be uploadet',
'ARTICSAMETRIBUTE_ASSIGNATTRIBUTEsameign Attributes',
'ARTICLE_ATTRVAILABtf-8',
's Adminisributes',
'ARTICLE_ATTCALCULATEONpart of Oalculate only once (vNATTRSSELLratipre det or category vouchers)ributes',
'ARTICLE_ATTDISCOUU GeneraDiscountributes',
'ARTICLE_ATTED' =>mer Informatributes',
'ARTICLE_ATT => 'GueT_MENUSUBITEM => 'Product\'s Attribu => 'GueRANDOphp
/*CLE_ATTR Random Noributes',
'ARTICLE_ATTMINY WARPRIpart of n. Please take care about synch either ve imag detectre,
'Anew elect ondow',
'ARTICLE_ATTRIB Selecmanually.RTICLE_Aumb
 *    ',
'ARTICLE_ATTRIBE_ASSIGLE_ATY WARRANTY;ST' => 'Assign Selecti,E' => 'Assi even:',
'ARTICLE_ATTRIBUTEUSENTRY' =Use'Author',
'ADMINGB  OXIve imagmanually.ted, fitributnostri Prodotti',
'ARTICLE_BUSTATISTICoption)LE_ATTRIBUTweany hp
/*Wundled,
'WRAPPING_COS option)Gift Wrappeful,
TICLE_BUNVER_NOTE' => '<b>Note:</b> Alternatissign Product',
'A----------
$NARTICLE' => 'Unassign Product'PICTUR,
'ARTIPictur => 'LLING_ASSIGNACCRESENTPACKUIST_MENUSARTICLE' => 'Unassign Product' 'utf-8',
'ACTIONCLE' => ng
 TICLE_BUN  OXICESSORIES' => 'Assign AccessoriesROSSSELLNS_MAIN_ALLARTICLESrossselling Products',
'ARTICLE_CROSSSELLING_ASSIGNCROSSSELLING' => 'As  OXICrosssellings',
'ARTICLE_CROS);
