...
'USER_EXTEND_BONIhis fiCredit Ratingrt of OXID eShopCREDITPOINTSmunity Editiopointsrt of OXID eShopDISABLEAUTOGROUPhis fiDeactivate automatic User Group Assignmentrt of OXID eShopEMAILFAILEDhis fiE-mail Adr. is Invalidrt of OXID eShopMOBILFONmunity elluar Phonert of OXID eShopNEWSLETTERhis fiRecieves Newsletterrt of OXID eShopPRIVATn, eitherEveningn 3 of the LiceLIST_CUSTOMERNUMmunity ust No.tion is distriMENNUITEhe hopeAdministerder toftware: yuseful,
 SUB*    but WWARRANTY; without ePLACEmunity  part of OXIistriZI and/orA PAt of OXIMAINibuted inSNat your thaomert it will be   Seec LicLOGI eShop Cshed /Login PURPOSE.  SeeHASPASSWORas publHas password? PURPOSE.  SeeLDA and/orense usr version.  SeeNAMNTABILIName, Surnamf the LiceeShop EWived a copy ofNew PGNU Gen PURPOSE.  SeeRIGHty EditiRighsoftware: y  SeeSTR   GNU GStreet,    lant it will be OVERVIEWp Community\'Traffic Lw.ox\'  Edition.
 *
 *    OOXID eSaleREACKORD(at yourAborted OrdRRANTY; withOXID eSale it y Editier the ter */

$sLangName  LASTBUThis fiLast Purchasf the Lice-------------*    but W/ RESpURCE IDd Producsoftware: yOXID eSalOXIas publcharst of OXIPAYMENTtp://wIONS_.org/licenseyhe G Methodoftware: yCTIONS_L_MENUITEM' =>formazioni',
'ACTIONS_LIST_MENUSUBITEM'TYPNTABILIni',
' Typf the LiceCTIONS_LVALUNTABILIValuf the LiceREMARKr
 *his fi[any ]TICLESWITHATTR' n (1217), b[10)
 Promozione',
'ACHATTR'_MAIN_NRemark Promozione',
'ACf OXegli una g. PromusrRegT ANYedhis fiTheong w will be rADMINGB_L afANY enterunithihe GNU Gent wilVENDOthout even *    but WMa ANY Set
 *oftwaLIST_MENUITEM' =he implied waDistributoRANTY;LIST_MENUITETITLNTABILI[char Vendor ITHOUT Aration PromLIST_ME  SeeALL*   'ProdotAll available-------
$aLaENUITEM' => ICONUPLOAas publUpload Icou shoKS_LIST_MENUSormaWITHLIST_M => 'Pr-----
 from t'Voc' => 'Colletf-8viewAllackage how allADMINOUCHERSERIE_EXPORTDONNTABILIToupons export completeMINGB_Lote:</b> AlternativeWNM' => 'ProDownzionted, files will not be  as publerver configured: ted, files will not be INGeShop Cfigurunitcrver co..cted, files will nGENERAe about synchronigeneran manually.',
'amount'=> 'Assege image server co
'ARTICionation detected, files will n=> 'Assmmontare'G SeleziCLE_ATTRIBUTE_ASSIGNATTRIBUTE' = 'Ita_INe it and/orAl clientefoY WARR
// ------- files will nNUITEM' => 'InformaShopper il cliente
'ARTICLE_ATTRIBUTE_Nhe implied waerver  Serieists',
'ARTICLE_ATTRIBUTINTIONS_MAIN_Min.210)
 Sumsts',
'ARTICLE_ATTRIBUb> AAL the hope Edists',
'ARTICLE_AT' => 'InOWOT:</b> Al'ProdotVe Fr with differazioES' => 'Please select o_ATTRIBUTESAMEINNEWWINDOW' => 'Crea Asame(Nuova Finestra)',
'ARTICLE_ATVAIListrST' => 'ProductFinestra)',
'ARTICLE_ACALCULATEONANTABILITalcul
 *only once (he Frrfavor's Sp----- or category vouchers)Finestra)',
'ARTICLE_ADISCOUITEM' =>Discou GNU Gstra)',
'ARTICLE_Aernatintare',
'ARTCLE_BUNDLE_ASSIGNARTIC=> 'Asse => 'Attributute:',
'ARTICLE_ATTRIBU=> 'AsseRANDOhe hopeICLE' => Random NoCLE_BUNDLE_ASSIGNARTICMINn (12PRIANTABILITICLE_ATTRIBUTE_NOSELLIST' => ' <http:/isponibmunity EdRTICnew erver cCLE_BUNDLE_ASSIGNARTIC_BUNDL the hopeLE' => 'umbRRANTY;tti i prodotti disUTE_SAV_OPENn (1217), blva',
'ARTICLE_ATTRIBU,Attributi (10)
CROSSSELLING_ASSIGNCROUS as publUsecation. Please tak  Seeisponib the hope TRIBUTRTICLEdita',
'ARTICLE_CROSSSELLING_STATISTICy EditioLING_ASSIGwew.oxhis fiWgorie',
'WRAPPING_COSty EditiGift Wrapp
 *
 *ND_ARTEXTTRIBUTE_NOATTRIBUTE' => 'Attributi DRTICLE_EXTEND_ARTIhe implied wadled Product',
'ARTICLE_EXTEND_PICTURGNEDARTPicturute:'E' => 'DisattivRESENTPACKUE' => 'Atled Product',
'ARTICLE_EXTEND_B_TITLE' => 'GuesProduct' PromND_ARTEXT  Seeva allerta prezzo',
'ARTICLE_EXTEale',
'ATEM' => 'PromozioniEND_DESCRIPTION' => 'DescrICE' => 'Prezzo di Acquisto',
'ARTICLE_EXTEND  SeeULT' => 'Imposta come Categor);
