...
'USER_EXTEND_MOBILFON' => 'Celluar Phonep
/**
 *    ThNEWSLETTERis parRecieves Newsletterp
/**
 *    ThPRIVATle is parEveningID eShop CommunLIST_CUSTOMERNUMis partust No.ibute it and/oMENNUITE *    iAdminister Usersthe terms of the GNSUBU General nse as published byPLACEis partityibute it and/oZIPis parnse,
/**
 MAINor modifySN
 *   t unomerder the termsur opEMAILLOGIare: you-mail/Login   (at your opHASPASSWORDis parHas password?   (at your opLDAe, or
THOU usnity Editiour opNAMher verName, Surnamhop Communeven tEWope that it wiNew P useful   (at your opRIGHTS
 *    ightas publishur opSTR later vStreet, nse foder the termsOVERVIEW_BONIis par\'Traffic L
 * \' Credit Ratingls.
 *
 *    You REACKORD*
 *   Aborted Orde as publish *    YouGROUPSee thense  Groupop Community EditioLASTBUYT ANY Wast Purchashop Communorg/licenses/U General * @lipk      d Produc    GNU Gen *    YouOXIt it wiales 
/**
 PAYMENTANTABIrsionr FITNESS FOyment Methodas publishversion D eShop CE
 ranslators: admin (367), gvlimpt (97), TYPher verrs: ad Typhop Communversion VALUher verValuhop CommunREMARKitionis par[op C]
// RESOURCE IDE*    along [D eShG
// -----------RCE ID-------RemarkG
// -----------**
charset' g.G
//usrRegc Licedis parTheANTY; will be rgegevens' afLiceentern rehi be useful the VENDOms of the NU General Ma LiceSetNU Gas puRTICLES' => 'All   the Free SDistributo as puRTICLES' => TITLher ver[ales Vendor Public LrationG
//RTICLESur opALLU GeFIER = All available
 * @copyrigstaande actiICONUPLOAt it wiUpload Icostrib' => 'Author'oor WITHRTICLEhoekie  * @cop from tACTIted Product012viewAllc Licenhow all'EntrOUCHERSERIE_EXPORTDONher versoupons export completeN_ALLARk',
'ADMINGB_TITLE' WNMINGB_LISTDownNTRYKS_LIST_MENUITEM' => 'CEt it wiD Gastenboek]'ed: KS_LIST_MENUITEM' => 'CINGre: youoek]'n rec Gasten..NKS_LIST_MENUITEM'GENERAUBITEM' => 'LinksgeneraDMINLINKS_LIST_TITLE' OTE' => ' => '[OXID Gastenlternation,
'ADMINLINKS_LIST_MENUITEM'OTE' =>XID LinksGill not]',
'ALTERNATIVE_IMAGE_SERVER_NO.  If_INamounbewerki
'ADMINGBfocense <http://wwwIST_MENUITEM'' => 'Alle producteShopCTIONS_MAIN_ALIBUTE' => 'Assign Att   the Free SD Gast SerieGNATTRIBUTE' => 'Assign IN-----------Min.ID eSh SumNATTRIBUTE' => 'AssignDMINAL
 *    id waNATTRIBUTE' => 'A acties OWOT
'ADMINGFIER = V<?ph with differlatoists',
'ARTICLE_ATTRIBU\'s SelectSAMEists',
'ARTICLE_ATTRIBUsameIBUTE' => 'Available AttributeVAILABTSELECTE
'ARTICLE=> 'Available AttributCALCULATEONther versalculate only once (vLE_ATCLE_AATTRp * @co or category vouchers)=> 'Available AttributDISCOUop CE
 Discount=> 'Available Attribut_TITLE Links behee=> 'Available AttributOTE' => take care aboUTE_NOSELLIST' => 'AvaiOTE' => RANDO *    i'ARTICLE Random No=> 'Available AttributMIN*    PRIther ver=> 'Product\'s Attributes',
'ARERCHANTAE_ASSIGis partre onlnew D Gastee producten',
'ARTICLE=> 'Pl
 *    iy one Atumbe as puoducten',
'ARTICLE'ARTICLion L*    along TE_NOATTRIBUTES' => 'P,UTE_NOATTRID eShled Product:',
'ARTICLUSBITEM' =Use
'ADMINLINKS_LIST_ur opE_ASSIG
 *    ittion L> 'Bun Products',
'ARTICLE_CROSSSELSTATISTICFIER = Assign Prodwe
 * is parWOSSSEL,
'WRAPPING_COS See theGift WrappU Genern Crosssessign Attributes',
'ARTICLE_ATTRIBUTNG_CROSSSELLING' =   the Free SRTICLE_CROSSSELLING_CROSSSELLINPICTURute:',
PicturUTE_Nr Product',
'ARRESENTPACKUe take caTICLE_CROSSSELLING_CROSSSELLIN_NOTSELECTED' => E_CROSSSG
//n Crossseur opRTICLE_EXTEND_ALLCATS' => 'All av => 'ProADMINGB_LIST_ENTRY' these Categories',
'ARTICe Categories',
'ARTICLE_EXTEND_ARTEXTRA' => 'ur oped Product',
'ARTICLE_EXTEND_);
