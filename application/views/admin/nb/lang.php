...
'USER_EXTEND_MOBILFON' => 'Celluar Phone'<?php
/**
 * NEWSLETTERfile iRecieves NewsletterD eShop CommunitPRIVATis file iEveningof OXID eShop CLIST_CUSTOMERNUMfile isust No.distribute it MENNUITEify
 *Administer Usersnder the terms of tSUBhe GNU Gen License as publishPLACEfile isitydistribute it ZIPfile i Lic<?php
/MAIN and/or mSN.
 *
    omerit under the at yoEMAILLOGIsoftware-mail/Login
 *    (at yoHASPASSWORDfile iHas password?
 *    (at yoLDAicense,ut W usCommunity Eat yoNAM, eitheName, SurnamID eShop Chout eEWthe hope that New Pll be u
 *    (at yoRIGHTS
 *
 ightense as puat yoSTR) any laStreet,  Licenit under the OVERVIEW_BONIfile i\'Traffic L the\' Credit Ratingdetails.
 *
 *   REACKORDn.
 *
Aborted Ordicense as pu
 *
 *  GROUPSE.  Se Lic GroupD eShop Community ELASTBUYITHOUT ast PurchasID eShop C.gnu.org/licehe GNU Gen *
 p @link d Produce
 *    GN
 *
 *  OXIe that ID eS<?php
/PAYMENTMERCHA* @veITY or FITNEyment Methodense as pu
 * @vern OXID eShop  * @translators: 
 */

$sLangName  =TYP, eitheslator TypID eShop C
 * @verVALU, eitheValuID eShop CREMARKty Edfile i[D eS]----------------se
 *    a[h OXIng = array(
'cha------ => 'utRemarkng = array(
'chahp
' => 'Cusg.ng = usrRegPubliedfile iThe WARR will be r' => 'Pro afblicenterou chi will be uunderVENDOe terms ofthe GNU GenMaublicSetthe ense 'ACTIONS_MAIN_AL
 *    the FDistributocense 'ACTIONS_MAITITL, eithe[ID e Vendor eral Pubrationng = 'ACTIONat yoALLhe G------All available lang
 * @coMINGB_LIST_AICONUPLOAe that Upload Icois di => 'Entry',
R' =WITH'ACTIO 'Norskang
 * from tlablOTSELECTED'003-viewAllPublic how all 'CusOUCHERSERIE_EXPORTDON, eitheroupons export completects',
'stbook]',
'ADMINLINKWNNGB_LIST_MDownUITEormation',
'ADMINLINKS_Ee that ENUITEM' => 'Ced: ormation',
'ADMINLINKS_INGoftware=> 'Cou ccNUITEM'..formation',
'ADMINGENERAST_TITLE' => '[OXgeneranks Administration]',
rnative iKS_LIST_MENUITEM'nfiguraionustomer Information',
'ADMINrnativeNATIVE_IMGote locVER_NOTE' => '<b>Note:</b> Alterition_INCLE_A> 'Auth
'ADMINGBfoic Lic see <http:tion',
'ADMINS_MAIN_ALLARTICLESWShopR' => 'Promotees',
'ARTICLE_ATTRIBU
 *    the FENUITE Serietributes',
'ARTICLE_ATTRINTRING
// -Min.th OXI Sumributes',
'ARTICLE_ATT]',
ALodify
 *mpliributes',
'ARTICLIST_AUTHOWOTook]',
'------Valid with differtranITEMSATTRIBUTE' => 'ProICLE_ATTRISAMENOATTRIBUTE' => 'Availasamebutes',
'ARTICLE_ATTRIBUTE_NOAVAILABne from ATTRIBUTE
'ARTICLE_ATTRIBUTE_NOCALCULATEONn, eitheralculate only once (v=> 'ADOW'  => pang
  or category vouchers)
'ARTICLE_ATTRIBUTE_NODISCOUD eShop Discount
'ARTICLE_ATTRIBUTE_NODMINLIIVE_IMAGE_SE
'ARTICLE_ATTRIBUTE_NOrnative ation manuallle Selection Lists',
'Arnative RANDOify
 *RIBUTES' Random No
'ARTICLE_ATTRIBUTE_NOMINse
 PRIn, eithe,
'ARTICLE_ATTRIBUTE_ITEMSSELLI    MERCsign Sefile isreLE_Bnew ENUITEMIGNARTICLE' => 'Assigntributodify
 *UNDLE_ALumbicense RTICLE' => 'AssignBUTES' BUTE_se
 *    ae select one Attribute,able Attribh OXIASSIGNARTICLE' => 'UnaUST_TITLE'Use'Links',
'ADMINLINat yosign Seodify
 * IBUTE_NDLE_U_ASSIGNACCESSORIES' => 'AssigSTATISTIC------ASSIGNEDARTwe thefile iWngs',
,
'WRAPPING_COSOSE.  SeGift Wrapphe GNU ELLING_CRE_ATTRIBUTE_ASSIGNSELECTLIST' => 'As Products',
'ARTIC
 *    the F => 'Crossselling Products',
'APICTURMANYATTPicturle SeTS' => 'All avaRESENTPACKUization m=> 'Crossselling Products',
'At one from above Crossselng = ELLING_CRat yoailable Categories',
'ARTICLE_EXTes',
'ARMINGB_LIST_MENUITEMND_BLFIXEDPRICE' => 'DeactTEXTRA' => 'Bundled Product',
'ARTICLE_EXTENDat yoNCATS' => 'Product is in thes);
