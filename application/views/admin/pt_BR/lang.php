...
'USER_EXTEND_MOBILFON' => 'Celluar Phonefile is part of NEWSLETTERop ComRecieves Newsletterfile is part of PRIVATeShop ComEveningEdition.
 *
 LIST_CUSTOMERNUMop Commust No.ify
 *    it MENNUITEterms oAdminister UsersU General Public LiSUBcense as p
 *    the Free SoPLACEop Commityify
 *    it ZIPop Comyourile is pMAIN under thSNCommunif thomere GNU Generalr verEMAILLOGIribute iphp
/Login any later verHASPASSWORDop ComHas password? any later verLDAur opti wit use software:r verNAMe LicenName, Surnamon.
 *
 rrantyEW useful,
 *  New P WITHOU any later verRIGHTSommunitight    the Frr verSTR
 *    Street, s.
 *e GNU GeneralOVERVIEW_BONIop Com\'Traffic LPubl\' Credit Ratingshould have receiveREACKORD CommuniAborted Ord *    the Frve receivGROUPGeneral
 * Groupn.  If not, see <htLASTBUYhout evast Purchason.
 *
 
 * @link   cense as p/www.pxid-esad Produclic Licenseve receivOXI,
 *   * @vile is pPAYMENTSS FOR
 * TICULAR PURPyment Method    the FrCE
 * @nslators: adm1100)
 */

$sLangName  = "PortuguêsTYPe Licen*/
 ...
 * @VALUe LicenValuon.
 *
 REMARKXID eop Com[n is]----------------D eShop Com[ditioarray(
'charset'------utf-8',Remarkarray(
'charset' is 'Customerg.arrayusrReghed bedop ComThethe i will be r'Promotio afd byenternd/ohibut WITHOUNU GeVENDOal Public icense as pMaed bySeticen    tONS_MAIN_ALLARTIe Foundation,Distributo*    tONS_MAIN_ALLTITLe Licen[ * @ Vendor ublishedrationarrayONS_MAIr verALLcens-
$aLaAll available OXID eSales _LIST_AUTHORICONUPLOA,
 *  Upload Icope thEntry',
'ADMI 'AuWITHONS_MA do BraXID eSa from t ProECTED' => 'ID eviewAlldetailshow alltomerOUCHERSERIE_EXPORTDONe Licensoupons export complete
'ACTIOk]',
'ADMINLINKS_LISWNIST_MENUITDown' =>ion',
'ADMINLINKS_LIST_E,
 *  EM' => 'Customed: ion',
'ADMINLINKS_LIST_INGibute iustomnd/ocM' => '..tion',
'ADMINLINKSGENERATLE' => '[OXID Ligeneradministration]',
'ALTEve image ST_MENUITEM' => 'ration ioner Information',
'ADMINLINKSve imagE_IMAGE_SGocationOTE' => '<b>Note:</b> Alternativp://w_INTTRIBthor',
INGB_LISTfoby
 */licenses/>,
'ADMINLINKSN_ALLARTICLESWITHATShop 'Promoted Pro'ARTICLE_ATTRIBUTE_ASe Foundation,EM' => Serietes',
'ARTICLE_ATTRIBUTEIN
// ------Min.Editio Sumes',
'ARTICLE_ATTRIBUTADMIALe terms o  MEes',
'ARTICLE_ATTUTHOR' =OWOT,
'ADMIN-
$aLaVhis  with differ)
 ATTRIBUTE' => 'Product\ATTRIBUTE_SAMERIBUTE' => 'Available Asame',
'ARTICLE_ATTRIBUTE_NOATTRIBVAILABom aboveBUTE' => ICLE_ATTRIBUTE_NOATTRICALCULATEONhe Licensalculate only once (This  => 'CAssipXID eS or category vouchers)ICLE_ATTRIBUTE_NOATTRIDISCOUors: admDiscountICLE_ATTRIBUTE_NOATTRIINKS_LMAGE_SERVER_ICLE_ATTRIBUTE_NOATTRIve image manually.',
lection Lists',
'ARTICLve imageRANDOterms oES' => ' Random NoICLE_ATTRIBUTE_NOATTRIMIND eShPRIhe LicenTICLE_ATTRIBUTE_ITEMSSELLIST' =ITNESS FSelectiop CommreNDLEnew EM' => TICLE' => 'Assign Prodte!',
e terms o_ALLITEMumb *    tE' => 'Assign Prod' => 'PNOATTD eShop Comect one Attribute!',
',Attributes'ditioNARTICLE' => 'UnassignUSLE' => 'Uses',
'ADMINLINKS_LIr verSelectie terms of_ITEMSUNASSIGNACCESSORIES' => 'Assign AccSTATISTIC-
$aLaNEDARTICLE'wePublop ComW
'ARTI,
'WRAPPING_COS GeneralGift Wrappcense
G_CROSSSERIBUTE_ASSIGNSELECTLIST' => 'Assign ucts',
'ARTICLE_CRe Foundation,Crossselling Products',
'ARTICLPICTURTTRIBUTPicturlecti> 'All availablRESENTPACKUon manualrossselling Products',
'ARTICL from above list selling arrayG_CROSSSEr verle Categories',
'ARTICLE_EXTEND_A'ARTICLE_LIST_MENUITEM' => FIXEDPRICE' => 'No PromotiA' => 'Bundled Product',
'ARTICLE_EXTEND_ARTIr ver' => 'Product is in these Cat);
