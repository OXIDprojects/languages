...
'user' => 'Klient
/**USERGROUP_LIST_MENUITEM    ThAdministracja użytkownikamie is part of OXID eShopSUB CommunityGrupy
 *    OXIDówe is part of OMAIN_ALLMEMBERS    ThWszyscyou can redicybute it and/or modi
 *   INt of     ThCzłonkowie ge: you can redisae is par_ADDRESS_DELIVERYn, eithmunity Eres wysyłkShop Comm_ARTICLE_QUANTITYit undeielkość   (at yoEXTEND_BONI    ThRanking kredytowy?*
 *    OXID eSCREDITPOINT the LiLiczba punkttribute it  OXID eSDISABLEAUTOas publisheWyłącz automatyczne przypisywan   the ou can redistribute it  OXID eSEMAILFAILEDthe License,e-mail jest nieprawidłow GNU Gene OXID eSMOBILFON    ThTelefon komórkublic License for mNEWSLETTER    ThOdbiorcy biuletynuic License for mPRIVATetails.
 *
 *  stacjonarnlic LicensXID eCUSTOMERNUmmunityNr ks fil FoundatioXID eShoop Community Edition.
 *
 *    OXID eShop Comm.
 *
 * @s free softwaUrms of the GNU Gene.
 *PLACE    ThMiastoSales AG 2003-ZIublisheKod poczs diSales AG  modi see <htSNf the Ggnu.org/licenses/>. modiTICULLOGIails.
Ee
 */Login/

$sLangNamHASPASSWORRPOSE. t (Cwaj hasłastributed  modiLDAublishe/ -- 
 * R = STRING
/NAM
 * @vImię, Nazwiskn OXID eSh-----EW-------
// RENoweIDENTIset' => 'utf-8'RIGHit will Praw*/

$sLangNamSTRpawelch cense, Ulica nr.---------OVERVIEWShop Commun\'Przepustown.
 \' ruchution is degostributed N_ALLARTICREACKORDof the GZamówienia anulowaneS_MAIN_ALLARTICLESt of  the Lire: you can redistribute it LLARTICLESLASTBUlater vOstat   Mzakupa bete (5)INGB_LIST_AUT CommunityAutor',o'ADMINiorantyoduktGB_LIST_ENTRY' => 'OXIRPOSE. ',
'Ay',
'ADMPAYMENT',
'ACTEM' LIST_MENUITmetody płatnośc
 * @packaBITEM' =Księga goścMDMINGB_TITLE' => '[OXID Guestbook]',
'ADMTYP
 * @vRodzaj'ADMINGST_MENUSUBITEM' =VALU
 * @vWartn.
 *
 *    REMARKd a c    Th[Ndost�ci]_TITLE' => '[OXITR' => 'Pro[dukty z ateion]',
'ALTERNATI> '[OXAGE_SERObserw
 *ion]',
'ALTERNATI parAGE_SERReg.ion]'usrRegisteredpyright (C) OXIDk zost    Mzare   Grmi',a po wpisaniu swojegoIDENTIFCTIONVENDOkage   lanp CommunityUsta z atrygłów,
'ACT> 'Ilość',
'ARs free softwaDystrybutorzUSUBI> 'Ilość',TITL
 * @v[ Edition.tor dszęwcy ',
'ion]'> 'Ilo� modify Com it under thtkieists'ęp => 'InformacjeRIBUTE_ITEMSICONUPLOARPOSE. Ikona wczyę z FounE_ATTRIBUTE_IIBUTWITH> 'Iloenta',
'Inform t�.',dLE_ATTRIBU FounviewAllenta',
okaż wProducn OXIVOUCHERSERIE_EXPORTDON
 * @vEksport kuponów'ADMończonynt' =>IBUTES' => 'Please sWNELLIST' =>PobierzOATTRIBUTES' => 'PleaseURPOSE. Exttribute!',
':OATTRIBUTES' => 'PleaseINGect one Attriujbute!'y ..IBUTE_NOSELLIST' =GENERA_OPENINNEGeneanualieW' => 'Create Attribute in TICLE_ATTselect on_SELECTONEATTR' => 'ARTICLE_ATTeVE' => 'Save',
'ARTICLE_Andow',
'A_SELEATTRIBUTE_SAVE' => 'Save',
'ARTLECTE_e as publisheD AttributdlaMERCHANTABILITY or FITNE_NOSELLIST' =�ć',
'ARTICLE_ATTRIBUTE_ASSIGsklep Lice=> 'Przypisz produkt',s free softwaSeriabute!',
'TICLE' => 'Bundled ProdINi',
'ADMINLMin. suma zukty z atrTICLE' => 'Bundled Pro' =>ALtp://www.gazCTIONS_NOSELLIST' = modifyOWOTTES' =>  it undeażne z różnych sUNDLch
'ARTICLE_CROSSSELLING_ASSISAMEESSORIES' => 'Assign tej samssseeriShop TICLE_CROSSSELLING_VAILWARR Products',
'ARTICLEICLE_CROSSSELLINGCALCULATEON2
 * @vOblicz tylko raz (do wary=> 'Acc 'InforANYAlub ka' =>riibute!',
')ARTICLE_CROSSSELLING_CDISCOUga goścRabale isg Products',
'ARTIPleaseect one Attri_ARTEXTRA' => 'BundledTICLE_AT'ARTICLE_ATTRIBUT_EXTEND_ARTINCATS' => 'ProductRANDO softwarSELECTONEATlosACTIO n-----g Products',
'ARTIMINTR' =PRI2
 * @verCLE_CROSSSELLING_ALLITEMS' => 'Wszystf-8',
'g ProduE_ATTRItwórz nowybute!'e Alert)',
'ARTICLE_EXEDPRICtp://www.Ls<br> AS' selling Products',
'ARTIOSSSELLGNACCTR' => 'ProAssign Crosssellings',
', AccessadbaE_EXTEND_DEFAULT' => 'Set as MaUSURPOSE. SOURCEselling Products',
'ARTIg Produtp://www.gumerbute!'RTICLE' => 'BundlePRICE' => 'ASTATISTICinks AdKIBUTEST_MweightRURL' =>gLLITEWRAPPING_COSit will Gift Wrapping URL',
'ARTICprodukt',
'ARTICLE_BUNDLE_ASSIGNEDASIGNARTARTICLE_EXTEND_FILs free softwaPakCTONEATprezen
 *    bARTICLE_EXTENDPICTURt is inZdjęctegoriXTEND_HEIGHT' =RESENTPACKUdow',
'Aee Shipping',
'ARTICLE_EXTEND_HEIGHT' T' => 'AssigOpe ShippinTICLE_ATT',
'ARTIC modi=> 'H:',
'ARTICLE_EXTEND_ISCONFIGU' => 'L:SSELLIST' =>Wct\'sj z_EXTEND_MASS' => 'Dimensio => 'Product can be customized',
'ARTICLE_EXTEND_ISS modi' => 'Searchable',
'ARTICLE_EXT);
