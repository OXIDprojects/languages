...
'HELP_ARTICLE_MAIN_TAGS' => 'Čia galite įvesti žymes prekei. Šios žymės bus matomos pagrindiniame puslapyje apačioje, kortelėje Žymės. Žymės atskiriamos kableliais.',
...
'HELP_DYN_TRUSTED_ACTIVE' => 'Pažymėkite šį nustatytą, kad Trusted Shops antpaudas būtų rodomas parduotuvėje.',
'HELP_DYN_TRUSTED_PASSWORD' => 'Slaptažodis (wsPassword)Trusted Shops webservice yra būtinas jei jūs siūlote Trusted Shops Buyer Protection Excellence savo pirkėjams. Buyer Protection Classic nereikalauja slaptažodžio.',
'HELP_DYN_TRUSTED_RATINGS_ID' => 'Jūs gausite Trusted Shops ID Pirkėjų reitingams užsakymo patvirtinimo el. laiške. Jei jūs jau esate Trusted Shops narys, prašome patvirtinti, kad žinote Trusted Shops ID. Žalia linija parodo, kad Pirkėjo reitingai patvirtinti ir leidžiami po nustatymų išsaugojimo.',
'HELP_DYN_TRUSTED_RATINGS_ORDEREMAIL' => 'Aktyvuoti mygtuką "Parašyk atsiliepimą!" "Užsakymo patvirtinimas" el. laiške.',
'HELP_DYN_TRUSTED_RATINGS_ORDERSENDEMAIL' => 'Aktyvuoti mygtuką "Parašyk atsiliepimą!" "Užsakymas išsiųstas" el. laiške.',
'HELP_DYN_TRUSTED_RATINGS_THANKYOU' => 'Aktyvuoti mygtuką "Parašyk atsiliepimą!" "Užsakymas baigtas" puslapyje.',
'HELP_DYN_TRUSTED_RATINGS_WIDGET' => 'Enable the Customer Ratings Widget by switching this option on.',
'HELP_DYN_TRUSTED_TESTMODUS' => 'Testuoti aplinką ("Sandbox"). Po sertifikavimo Trusted Shops atsiųs prisijungimo duomenis el. paštu.',
'HELP_DYN_TRUSTED_TSID' => 'Trusted Shops ID aktyvios parduotuvės (kalboms).',
'HELP_DYN_TRUSTED_TSPAYMENT' => 'Priskirti parduotuvės mokėjimo būdus atitinkančius mokėjus Trusted Store.',
'HELP_DYN_TRUSTED_USER' => 'Vartotojo vardas (wsUser) Trusted Shops webservice yra būtinas jei jūs siūlote Trusted Shops Buyer Protection Excellence savo pirkėjams. Buyer Protection Classic nereikalauja vartotojo vardo.',
...
'HELP_SHOP_CONFIG_FACEBOOKCONNECT' => 'Rodyti Facebook prisijungimo lauką, kuris leidžia vartotojams prisijungti į el. parduotuvę naudojantis Facebook prisijungimo duomenimis.',
'HELP_SHOP_CONFIG_FBCOMMENTS' => 'Komentarų laukelyje parduotuvės lankytojai gali lengvai komentuoti el. parduotuvės turinį.',
'HELP_SHOP_CONFIG_FBFACEPILE' => 'Facepile rodo parduotuvės lankytojų profilių nuotraukas, kurie prisijungę per Facebook prieigą į jūsų svetainę.',
'HELP_SHOP_CONFIG_FBINVITE' => 'Rodo lankytojo draugų sąrašą ir leidžia juos pakviesti į parduotuvę.',
'HELP_SHOP_CONFIG_FBLIKE' => 'Leidžia prisijungusiems vartotojams dalintis turiniu, grįžti į draugų sąrašą Facebooke vienu paspaudimu.',
'HELP_SHOP_CONFIG_FBSHARE' => 'Rodo Facebook nuorodų dalinimosi mygtuką, kuris leidžia dalintis svetainės turiniu.',
...
'HELP_SHOP_CONFIG_LOAD_DYNAMIC_PAGES' => 'Jei varnelė uždėta, tai papildoma informacija apie kitas prekes rodoma meniu, pavyzdžiui, apie Oxid eFire. Kokia informacija yra užkrauta, priklauso nuo vietos parduotuvėje.',
...
'HELP_SHOP_CONFIG_SHOP_CONFIG_FACEBOOKAPPID' => 'Norėdami susieti savo svetainę su facebook jums reikia įvesti atpažinimo ID. Kaip prisijungti į savo svetainę per Facebook, jūs rasite čia<a href="http://wiki.oxidforge.org/Tutorials/Connecting_website_to_facebook" target="_blank" target="_blank"></a>.',
...
'HELP_SHOP_PERF_LOADATTRIBUTES' => 'Prekės atributai matomi detaliame prekės aprašyme. Jei varnelė uždėta, prekės atributai yra visada matomi.<br />Šis parametras gali būti naudingas šablonams, pvz. rodyti atributus prekių sąrašuose taip pat.',
...
'HELP_SHOP_PERF_LOADREVIEWS' => 'Vartotojai gali įvertinti ir komentuoti prekes. Jei varnelė uždėta, egzistuojantys atsiliepimai/komentarai yra rodomi prie prekės.',
...
'HELP_USER_EXTEND_DISABLEAUTOGROUP' => 'Vartotojai yra automatiškai priskiriami grupėms. Jei šis parametras aktyvus, tai vartotojas nebus automatiškai priskiriamas vartotojų grupei.',
