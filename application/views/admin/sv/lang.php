...
'USER_EXTEND_MOBILFON' => 'Celluar Phone This file is paNEWSLETTERID eShRecieves Newsletter This file is paPRIVAT OXID eShEveningunity Edition.LIST_CUSTOMERNUMID eShoust No.or modify
 * MENNUITEr the tAdminister Usersthe GNU General PubSUBlic Licenshed by
 *    the FPLACEID eShoityor modify
 * ZIPID eSh  (aThis filMAIN    it unSNeShop Cermsomer of the GNU Gy latEMAILLOGIredistri-mail/Loginption) any latHASPASSWORDID eShHas password?ption) any latLDA(at youRANT usis free sofy latNAM of theName, Surnam Edition.ied waEWill be useful,New P   but ption) any latRIGHTSShop Coightby
 *    y latSTRn.
 *
Street, detail of the GNU GOVERVIEW_BONIID eSh\'Traffic Lnera\' Credit Rating  You should have rREACKORD eShop CAborted Ordd by
 *    uld have GROUP  GNU Ghed  GroupEdition.  If not, sLASTBUYY; withast Purchas Edition.>.
 *
 * @llic Licenshttp:p/www.oxd Producal Public Luld have OXIuseful,2012This filPAYMENT FITNEhop C A PARTICULAyment Methodby
 *    eShop CE* @translatordmin (406), HolgerGremminger (69), marcTYP of the6), Ho Typ Edition.eShop CEVALU of theValu Edition.REMARK*    ID eSh[Edit] RESOURCE IDENTIth OXID eSh[nity // -------------- IDENT-------Remark// --------------s firset' => g.// --usrRegpubliedID eShonvändaren rrmatireras efblisatt lösenordet angetal PubVENDO General Pblic LicensMaublisSetblicS_MAIN_ALLARTICLES' =oftware FoundDBITEibuto by
 N_ALLARTICLETITL of the[2012 Vendor e as pubration// --N_ALLARy latALLlic R = STRAll availableht (C) OXID ej den aktionICONUPLOAuseful,Upload Icothe hINGB_LIST_AUT skaWITHN_ALLAo (934) (C) OX from this WITHATTR' =ion viewAll more dhow allLIST_OUCHERSERIE_EXPORTDON of the oupons export completed the => 'Gästbok',
'ADMINWN=> 'Autor'Down'ADMADMINLINKS_LIST_MENUITEEuseful,' => '[OXID g�ed: ADMINLINKS_LIST_MENUITEINGedistriID g�e itc => '[O..'ADMINLINKS_LIST_MGENERANUSUBITEM' => 'L�genera',
'ADMINLINKS_LIST_TIE_SERVER_NGB_TITLE' => '[Oänvisnion�stbok]',
'ADMINLINKS_LIST_ME_SERVE> '[OXID Gelbilde�rvaltning]',
'ALTERNATIVE_IMAGEe <ht_INla sy bearbeur listanfoished nu.org/lice=> 'Gästbok'TICLES' => 'Alla tiShopgliga artiklar',
'ARTICLE_ATTRIBUTEoftware Found' => ' SerieMängd',
'ARTICLE_ATTRIBIN-----------Min.unity  Sumängd',
'ARTICLE_ATTRIstboALder the t
 *ängd',
'ARTICLE_ktion soOWOTGästbokR = STRV*    with differ (40ELECTLIST' => 'TillordnE_ATTRIBUTSAMEMSSELLIST' => 'Artikelnsamea urvallistor',
'ARTICLE_ATTRIVAILABar',
'ACutförs.'listor',
'ARTICLE_ATTRCALCULATEON3 of the alculate only once ( *   nv. ur
'amp (C) O or category vouchers)listor',
'ARTICLE_ATTRDISCOUanslatorDiscountlistor',
'ARTICLE_ATTR,
'ADM[OXID länkflistor',
'ARTICLE_ATTRE_SERVERaddas dock ej attribut!',
'ARTICLE_AE_SERVERRANDOr the tttribut: Random Nolistor',
'ARTICLE_ATTRMINth OXPRI3 of theTICLE_ATTRIBUTE_ITEMSATTRIBUTE'Y or FITrdna atID eShore�lj new ' => '[ar som står till förTTRIBUder the tendast eumbd by
 om står till för_NOATTRE_ITEth OXID eSh 'Ej anv. attribut',
',n har dessanity GNEDARTICLE' => 'TilloUSUSUBITEMUsen',
'ADMINLINKS_LIy latrdna atder the teSSIGNSLE_ASS_ALLITEMS' => 'Alla artiklar STATISTICR = STRSSIGNARTICLweneraID eShWrdna t,
'WRAPPING_COS   GNU GGift Wrapplic LicTICLE_CROATTRIBUTE_ASSIGNATTRIBUTE' => 'Tillo' => 'Tillordna croftware FoundSSIGNCROSSSELLING' => 'TillordnPICTURj ett aPictur attrlling-artiklar'RESENTPACKU laddas dSIGNCROSSSELLING' => 'Tillordniklar',
'ACTIONS_CROSSSEL// --TICLE_CROy lat',
'ARTICLE_CROSSSELLING_EXTRAS' XTEND_AR' => 'Autor',
'ADMI 'Passande artikel',
'ARTIllordnade tillbehörsartiklar',
'ARTICLE_EXTEy latLCATS' => 'Alla kategorier',
);
