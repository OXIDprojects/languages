...
'tbclattribute_category' => 'C   This ,
'<?php
/**
 *main file Mnityf OXID eShop Communlly Editioll
 *
 *    Thismunity Edition.
 *
 * is free soop Community Edition is free order file Sortingcan redistribute pictures file Pc Licecan redistribute rightnse as Rree Soan redistribute seo terms EOdation, either vetext file T    an redisontent software: you can redisny latersion 3 of the Licensountee software: you can redideliveryseter version.
 *
 *    at it will be op Community Editionat it will bpaymen  (at yParrantyt even the implied rdfaoftwareDFaERCHANTABILITY or FIusernse as Ue thet even the impl_articlense as producundation, l Public e useful,
 *    but WITHOUT AWARRANTY; without even the implSee the
 *    GNU Generalis is d License for more details.
 *
eShop Coe useful,
 *    but WIhttp://wwwRANTY; without even teShop Coee the
 *    GNU Generalanguagmmunity Edition.
 *
 *manufa Licercopyright (C) OXID eSales AG 2003-2012op Community Editiones AG 2003-20rsion 3 of the Licenmodule_config terms et theNU GeneraangNameunity EditOverview�ка';

// -sortlis  (at yInstalled Shop MngNamNU Generanewslett-2012
 * @veHTML-------------------plnity EditTEXTaLang = array(
'chare-----or moreUITEM'------------------selectioty EditS кліє-----------www.gnu.org/licenses/>.ST_MENUop Community EditionST_ME*    (at your option) r the_addresnse as A�пн� ---------ост�icensefor more details.
 *остdownloadnse as DProducts' => 'Promotedunity Edition.
 *
 *остo-----------------------------остremark-------istrt of OXID warrant_ is dis file iDMINGB_ зміни',
'unity Edition.
 *
 *ни',
'TNESS FOR A PARTICULARpricealarm',
'p Communiiy Edition,
'ADMINGB_LISty Edition.
 *
 *roles_beція для клієнтівobjec  (at yO> 'ГIN_NOTSELнтівee te
 *    GNU Generaнтіf�',
'ADMINGB_LIST_MENUSUBITEMf'ADMINGB_TITLE' => '[Го клSOUR',
'ADMINGB_LIST_ENTRY'> 'Інфорop Community Editionshop_cachRTICLESCachthe GNU Gen_MENUS = 'Українська';_MENUlicensRTICLESLдмі�ITLE' => '[�рмація для к� поѲ',
'ADMINLINKS_LIST_MENUperformancRTICLESW> '<b>.�ання п�TNESS FOR A PARTICULAR'ALTErsion 3 of the Licencted, ystem�нтіd to rot be uptatisticосилань OXID]',
'se take cs----te:</b> ion.tentive imageysreqосилань OXID]',
themme  = 'Українська';GNATTR--------------------------toolMENUSUBITEM'SQ$aLang = ee tgrou�осилань OXID]',
ee t�упні товари',
'ACTIOи в�_ALLARTICLESWITHATTR' => 'Prи вextend із Eти ed 'Атрибсвоїти списки вwarranty of
 *    MERCHANTAи в щоб внести зміvendoTTRIBUTE_ITEMSSELLIST' =бору'op Community Editionбор�rsion 3 of the Licenvoucherserie_�риhe
 *    G GTE_NO & re details.
 *RTICLE_ATTRIB�',
'ARTICLE_ATTRIBUTE_рибут!',
op Community Editionwrapping',
'ARTICLE_ATTRIBUTE_Nиски вop Community Edition',
'ARTICLE_ATTRIBUTHEME_ACTIVATE� то�ctivatваити �UTHOR� то�uthorвому �PARENT_�ти TITL�бутParent GNATTLE_ATTRIBUTE_SAVEVERSIONS_LIST_AUmpatible pти',
'ART versionIN_NO�ти LECTONE із V�иб�т',
OOLS_LIST атONENDбут у on complet',
'ARRIBUTES' => FFECTEDROWATTR' =Affected row�т',
IBUTES' =>ERRORMESSAG�бутError messagTICLE_S' => 'Всі �NUMупні п�numbeCLE_ATIBUTES' =>MENUITELE_ASSISy.',
'a 'ПризначеSUBння п�TRIBUкту',
'ARTICSECCESATTR' =Backup data LISTed successfullytive  => 'До цQLQUERYSIGNSELEC queR' => �ризнаЗбере�[OXID DARTI]кту',
'ARTICUPDATEVIEWSFAILEері�DB Views update fя тARTICLE_BUNDLE_Uкту до�ього д�,
'ARTICLE_CROS�овар:',
'ARTICLE_BUNMAIN_CHECKPICATTR' =Search and de�к� unused publishICLE' => '�IGNACSQLDUMBCE IDENmport ' =>File<br>(large files should be upducted via ftp)ари',
'ARTICLTART' => '�tart U_CROSари',
'ARTIC приналежність пр�IGNACктуLECT
 *  _CROSSLECTLISпродажі',
 доCONFIRLE_ASSIAre you su товwa�',
oLE_CROSS----s now?NG_EXTRAS' => 'Аксес�INFO
'ARTICLter�р�ticular DB taбеstru LiceLE_CROSs, in r the changesICLEtake eLE_BU�овneedICLEregenerROSSDBD_ALLCSELLING_ASSIGNACкту доNOWTICLE_CROSSSE,
'ARTICLnoорПр�TIPS_ADDSUMITMTYP�бут bsolute, percentagSELLI or�бер�ELLIMarkup/DeShop C� в цих кат�оріях',
'ARTI orELLIE_EXTEND_BLFIXSurch' =>/RedetaMANYATTRIBU�х кRTICLEDELIVGNARTICLETime F<b>Nt: LE_EXTEND_BPRICE' =>R�ес із �pen�бер� Інфор�XTEND_BPRICE' =>STOCKTICLE_Quantity�бері�р�stockLE_EXTEND_BPRICE' =>TEMPL�ибутTemplROSSOSSSnamSELLIif not defaul� акцій<brCE' =>UNITDESCRIPВиTICLE_Cn�р�the basic ,
'AD isXTENDURL' =CLE_LE_Estand,D_ENedLFIXEDn a specific unit of meaар�appli 'ПрcludingLFIXETENDsa�р�taxзн�oth�р�RL' =�л�onentE_EXTEND_AD_DIMENSIONS_RLIMG file iпл�(ф�tс (д�sко�и оди�D_DIMENSIONSVAICLE_CROед�y only if individual � п якості �S' =>NEWRO�ере�CreROSSnew RolCROSSSELL станда�н�GENERAT�ні',
(Re) Gкт)',
e Foun &EXTENs fielAIN_NOTURL' => 'Зов�SEARCHFIELDOXDYNAMICTICLE_s�ри> 'Файл',
'ARTICLE_EXTEND_FILESHORIT' = => 'Заг� STRrt DescripRTICLE_EXTEND_BPRICERTICLE_EXTEND_FILEЗбере�ING' =>TitEND_EXTURL' => EDITVAні',
Edit Variaз акцій<bFORM пов�іна : YYYY-MM-DD� від стннDEPTIO�ні �читEHOR' => �лаштовSTORN�атеCNotelE_EXTEND_ISSEARCH' => 'UNASSIG,
'ARTICLassign fromизp� від стNEW 'ВиATTR' =>'ARTICLE_E�ь твжина:',
'ARDDR�го д�_MASS' => 'Ѓпні�жина:',
'ARCE' =>�и)',
'ARTICNew�бер�EDIAURLS' => 'ПCATEGONARTICLE�я на мis pogTEND_ISSEARCH' �т',
TREлан�Re-IndexTERIAThis TreND_EXTURL' => �т'ONTENICLE_CRTEND_NONMATEny latEND_QUESTIONEMAIL'UNTTICLE_EXTEND_NONMATEUTHOR' => QUESTIONEMAI 'Покупн_MASS' => 'Shi�ки Cost RuEND_EXTURL' => � врах�SE'Альтер� всі не�Metho�дрібна � вIS�т',�вувати вр без акцій<bNEW=> 'Ђи)',
'ARTICLE_EX
/**
 EDIAURLS' => 'ПLANGU�тупн�я на мLg
 * @',
'ARTICLE_EXTENIN�ної_MASS' => 'LinTICLE_EXTEND_DNEWMALLC повня на мnityTERIAL' => 'Віртуа�MANUFACTUREні',
_MASS' => 'Ms AG 2003-2_EXTEND_UNITQUANTWS,
'ARTICLE_EXTEND_ою від стNEWNE',
'ARTI� (один�одукти',едіа д�LETTК-стѰ мN--------- Sa�ь�EDIAURLS' => 'ПPAYM> 'Альтер�LE_E *    Mони, Доставк�PROMOм',
'ARTI� м�ь т/PromoRICECBann'ARTICLE_EXTEND_UPREMAR�ноїAdd Noн',
'ARTICLE_EXTESELEC�ав�вувати вс клі� LOURC�алізува�HOP => 'ОдиницSTRI'ARTICLE_EXTEND_UTATISTD' => 'вати всse take MEDIAURLS' => 'ПUSК-сть (один   G�бо завантаGROUATEPRICETIME' => 'UTES' => '�бо заванта' => 'А:',
'ARTICLE_EXTEND_UPDATEPRICEB' => 'Б:',
'AVAR1TEND_UPDA�оже місти�2TICLE_bel�я в цих Ёти�3TICLE_c'ARTICSCONFIGURABLE' => 'Ёт�END�ні',
CLE_EXTEND_TEM
/**
ICLE_ATе міст�OUCHК-сть (одинCoupon STTRI'ARTICLE_EXTEND_WRAPPINРекоя на мW�ски'ARTICLE_EXTEOPENHELATEPRICOSSSELHel�нтажен�XTENта�іну нст�UTES'�',
'ARTICLE_EXTERECALCNROF� оснINME' => '�Recal,
'AнаLE' =(ф�горії',is partiуари',EXTEND_WEIGHT' => 'ВагMA,
'ARTIICLE_EXTEND_WEIGHT_UNIT' => 'кг.иць)',
'AMEDIAURLS' => D_WEIGHT' => 'ВагV�ері�ICLE_EXTEND_WEIGHT_UNIT' => 'кг._EXTEND_UPLм\'я зака�SETHT' => 'Вага',
'ARTICset_WEIGHT_UNIT' => 'кг.',
'ARTICLE_EXTEND_WIDTH'�тажуванн',
'ARTICLEів для цього пѵдіть ім\'я закаѽтажуваннлу',
'ARTів для цього пєозволити зав�TIME�родук�а ціна',
'ARTICLE_EXTVAL_FREESHIPP_EXTE1__@@_EXTE2 =>  uswARTICLETAL_PLUS_PROPORВиAL_� пов�plus�в� (pro_ASSionally LE_EXTENDd�ро�S_RATINGS_BUTTON_ALну нWrite a �нф�!�вляти',
'URL> 'Това�Trus,
'ASTRIs Customer Raнськ�ктуAPP_DIRNOTаниD_WARNoff due tPleaseачитdirec�т�:LE_CROSApp�авADMINGB_TIES_OR_FI=> '�и по�значення п�AdminisRTIC   GNU GeІм\'я файлуUNDLE_ASSIGNEUTES' => '�RCHASEDONLY' =IGNACALLMEMBER,
'ARTICllBLE_PURCHASEDONLY' =IGNAC_UPLOAINповин�UTES' => ' MeE' =',
'ARTICка�и�_ 'Покарити)',�і не�вари',
'AS' => CE' =>_QUANTITARTICLE кат�EM' => '�EXTEND_BONI due to sND_IENAME'VE' => 'АктиCR
'ARPOINTативнND_Ipoin�а к=> 'АктиDISABLEAUTOповин�Deaу но automaticи зава AENGTH   MERCH=> 'АктиEMAIL групи'E-LIST Adr.=> 'Invali,
'AR=> 'АктиMOBILF',
'ARTICelluar Phonles h=> 'Акти'Базова цRecieves�а',
'ARTI�ти редагPR�р�UST' => 'Even�е�олити р�S' =>CUSTOMEUNDLE_ASSIES_O Notive MAIN_ARTNUMENу',
'ARTICLE_FILES_TABLE_PURCHASEDOMAIN_DISTEAьки куплека',
'ARTICLEPLACланнCTIVE' => '�S' =>ZIATEPRIC' =>RTICLE_MIGNACC' => '�SNи (.))'S_OR_FIL,
'ARTICLE_MIGNAC 'А�LOGI� товти�/Logn.
 *AIN_GOTO' HASPASSWORері�Has password => 'AIN_GOTO' LDAATEPRICCLE_ ADMINії:',
'ARTINAMлан�Name, SurльSFOUND' => 'AttEA' ORY' => 'В � мЂегоSFOUND' => 'AtRIGHARTICLE_e FoundatiAIN_GOTO' STR існ�Street, �р вRTICLE_MAIN_GOVER дивно',
'\'TrafіаLree \' ARTICLE_MAIN_ACTIVEFRORTICLE_MAIREACKORDК-ст�Abor,
'AO theка',
'ARRTICLE_MAпо�ати�лений',
'ARTICurchased.'LASTBUARTICLELast PолЃва�Ціна',
'ARTICLння п�ICEA'p=> 'А:d�берітьЦіна',
'AR�е� із �E_MA => 'В:' => '�ICEA' => 'А:',
'URERIDD_UPDATEPRIC => 'Ціерег�' => 'А:',
'SEARCHKEYS' => 'Ключові словоріях�ни, Typremoved',
�рег�VALUлан�Valuremoved',
TEPRIC�увина�а',�тьLE_MAIN_TITLtion: Paren[t canа',
'ARTICLE_MAITEPRICES' =>[Rщо�а',
'ARTICLE_MAIтажте[Reg.�тьusrRegES_TAe товTheIDTAG will�ч�rN_VENDORI a�орenter�е�hiатегоtive �пк�значення п�MaS_TAB�їнськ�ші опції'UNDLE_ASSIGNE�озволит�ші опц� приналежV�ор E_FILES_raOAD'�тьші оES_TABLEрнати�S' =avail_EXTEre details.�ка',
'ARTICONUPLOAMAIN_SAUти  Icзміні змін> '�WITH�пки (.))горі� => 'tOPTI_EXTEND_UPLOADI----Aop CommuShow ity Edi> 'ThisSERIE_EX� фDONланнloadis ex_ASSI�льки'Ін�Рейтинг по WN'ARTICLE_OTIONS_MA => 'Рейтинг пЀупи'ажам',
'ARed',
'ARSOLDCNT' => 'Всьoff due tE,
'AR�е�c�жам..VIEW_SOLDCNT' => '�нє �ALORDERCNT' => '�кт)',�го замовле�ажен продажам�кт)' тількиTURES' => 'Зображеoff due tня',
RES_CUSTOM_PICTURES' => 'Зобр
'ART_айли',
'AAHANGE' =>foABLE_Pний',
'ASOLDCNT' => '�начення прTRINEW_ARTMADEON'_PIC1UPLOAD' => 'ЗаUNDLE_ASSIGNEploading filCTURES_PIC1UPLOAD' => '�IN> 'ТегиMin.ct can Sution.инку 1',
'ARTIтиALNDLE_ASSInvalавантажи�ES_TABLEOWOT�йти�=> 'Н�Vи', with diffe�и',�артинка 2',
'ARS_PIC3' =>SAME�ртинка 3',
'ARTIsameRES_PIC3UPLOAD' => 'ЗаванVAILLE_Mартинка 3UPLOAD' => 'Зава�WEIGU => ONLE_MAIN_EE_EXTEND_бу�once (�и',� ка',
'pнов�or     This OSELLIST�роOAD' => 'Заваа ...)',
'ARTI� без а�OAD' => 'Зава�г п�RTICLE_PICTU' => 'Завантаж�ажентажитиICLE_PICTURES_PIC4UPLOA�аже�RANDOLE_ASSIня',
'ARandom No' => 'ЗавантажMINtion:PRILE_MAIN_UPLOAD' => 'Завантажи�'ARTICLE> 'This is a demoshop. UploadiC3UPLOAD' => 'Зава�ES_PICNDLE_ASSIаванLE' =C3UPLOAD' => 'Зава�жит� 'К�tion: Paren�инку 3',
'ARTICLE,ICLE_PICTURt can' => 'ЗавантажUS�упи'Us',
'AR 'Картинкаинкѐртик�loadin 7',
'ICLE_PICTURES_THUMB' => 'Мі',
'ARTICATTR' => LOAD' => weree LES_OR'ніа,
'ched off_COSARTICLE_Gift reasons.',
'TICLE_PIC => 'Завантажити картЦе демонс�UNDLE_ASSIGNEDISDISABLED' => 'Це демо�PI=> '�se as published bня зобра'ARTNTPACKU�нтажISDISABLED' => 'Це демо� приналежreasons.�тьTICLE_PICIGNAC�ження було закритRES_ZOOM,
'ARTICLE_OVERVIEW> 'Завантажити цілях безпеки.',
'ARTICLE_PICTUREG' => 'Товари у�а 1',
'ART);
