...
'ORDER_OVERVIEW_PDF_ZZGLVAT' => 'plus tax ',
...
'tbclcategory_pictures?php
Part of    This file is right OXID eR *
 *   This file is seo?php
/EOhop Community Editext?php
T red   This ontent_main?php
M
 *it and/or modiftion is free softwareountryfy
 *    it under the deliveryseify
 *    it under the *    the Free ll*    it llndation, either verspaymenedistriP your odation, either versrdfa*    OXDFaater version.
 *
 user OXID eUs disdation, either _articlf OXID eSroduceShop Commpe that ie Software Foundation, either sion 3 of the License, or
 *   is distributed in the hopislic Lit will be useful,
 *    but WIA PARTICe Software Foundation, NU Generaln 3 of the License, oA PARTICis distributed in the holanguageral Public License for manufart ofrral Public License
 *    along with On 3 of the License,    along withtion is free softwarmodule_config?php
/et
 *in the ho     hty
 *    iOverview.com
 * @packasortlisedistriInstalled Shop M    hin the honewslettith OXID eShoHTMLID eShop CE
 * @trpl
 *    iTEXTin (28), pianoservisre@copy usefulраїD eShop CE
 * @trselectio *    iS---------D eShop CEral Public License for  IDENTIn 3 of the License,  IDENn redistribute it and/order_addres OXID eA'utf-8OXID eShopet' =>  will e useful,
 *    but Wet' =>download OXID eDєнті� про кл�y
 *    it under the et' =>o * @copylang
 * @copyright (et' =>remarkators: istoryIST_MENUt your _lic Lic_MAIN_CCTIONS_�овари',
'y
 *    it under the ри',
'*    OXID eShop Communpricealarm> 'P 3 of theiLicense, 'Вибері� *    it under the roles_beску вище, щоб внеobjecedistriOST_AULIST_MENU� внеis dstributed in the ho� внf�сти зміни',
'ADMINGBfNGB_LIST_ENTRY' => 'По------les > 'Promoted Products',
мація дn 3 of the License, shop_cachфор�Cach
 *    This 'Гоp://www.oxid-esales.com
 * 'Г�licensфор�Lкни�стьовадля клієнтівKS_LISLIST_MENUSUBITEM' => 'Г�performancформ�ті�.'ADMINLINKS_L*    OXID eShop Communфо�tion is free softwar�я',
ystem?php
/> '[АLIST_TITtatisticLIST_MENUITEM' => 'Ін�ання s* @c,
'ADMINt untenIST_MENUSUysreqLIST_MENUITEM' => 'Інthemhttp://www.oxid-esales.com
 *e servge   lang
 * @copyright (toolENTIFIER = SSQmin (28),is dgrou_LIST_MENUITEM' => 'Інis d> 'utf-8',
'ACTIONS_LIST_MENUITly.',
'Інформація проly.',extend_MAIN_EПр�edTTRIBUTE' => synchronization manually.',t your option) any later verly.',� доступні товаvendo�ти',
'ARTICLE_ATTRIBUаног�n 3 of the License, ано�tion is free softwarvoucherserie_aboutistributed  GUTE_I & ul,
 *    but WARTICLE_ATTRI�о',
'ARTICLE_ATTRIBUT� слідуюn 3 of the License, wrapping�ючі парамет�TE_NOATTRIBn 3 of the License, �ючі парам�THEME_ACTIVATE',
'ACTctivat
'ADMIBUTES'UTHOR',
'ACTuthor атри�PARENT_IBUTESTITL�ибеParent e serATTRIBUTE_NOSELLIVERSIONS_MAIN_ALmapatible pпні сп versionLIST_IBUTESано�_MAIN_VWWINDO' => OOLS_LISTS' =>ONENDиберіon complet� ат�т у но�FFECTEDROW�о',
'Affected rowW' => т у ноERRORMESSAG�ибеError messag�ис�RIBUTE_SELECTONNUM=> 'Вибеnumbe_ATTRIт у ноMENUITETICLE_ASTIVE_IMANYATTRIBUTES' => SUB'Вибе�Tte l тільки �SECCES�о',
'Backup data ітed successfullyIST_M'ARTICLE_BUNQLQUERYon. Pleas queTICLESATTRIBUTES' 'Дост�[OXID �ут] тільки �UPDATEVIEWSFAILE вікDB Views update fдоѿродукти'',
'ARTICLENDLE_ALLITEMSGNEDARTICLE' =>ступні продукMAIN_CHECKPIC�о',
'Search and deICLE unused Shop Co�!',
'ARTIC'ВіSQLDUMBAG 2003mport DLE_File<br>(large files should be up�т�ed via ftp)дукту до TART?php
/tart UE' =>дукту до�ризначення проду�'Ві',
'AReasetributE' => ease taи аксесуаTICLECONFIRTICLE_AAre you suзна�wa�і oCLE' => @cops now?SSSELLING_ASSIGNCROSSSELLIINFO�егт�terRIBUticular DB taATTRstrurt ofCLE' =>s, in et' = changes�с-take eи',
на�need�с-regener => DBдажRTICLE' => 'Ві',
'ARTICLENOW�',
'ARTICLE_GNEDARTICno;

ATTRTIPS_ADDSUMITMTYP�ибе�bsolute, percentagSSELL orродуSELLMarkup/DA PARTIтупні кате�рії',
'ARTICLE orSELLXTEND_ARTEXTRASurchG_AL/Re
 *рибут і к�RTICLEDELIVTICLE_BUNTime Fівt: находитьсяRSSELL_MAIN_Apenроду �ка";

ходитьсяSTOCK�',
'AQuantityроду�,
'AstockнаходитьсяTEMPL'ВибеTempl => ROSSnamSSELLif not defaul� товар (�ьсяUNITDESCRIPом�',
'ARnICLEthe basic 'Ви isви� як�с-�ноstand,тиedXTRA' n a specific unit of mea�итappliі',
'cludingXTRA'�и�saEMS'taxна�oth'Т�як�'ARTonent�овар�TICLE_EXTEND_RLIMGьов�CROSSXTENt_BPRICEsАк�E_ATTRIBUTTICLE_EXTENDVARTICLE_C,
'ARy only if individual ан�ез акці� ноNEWRO�ост�Cre => new RolG_ASSIGNAдео, mp3 �о YGENERAT�!',
'AR(Re) Gари �XID eS &CLE_Es fiel_LIST_D_ERRORSAVINGTPRISEARCHFIELDOXDYNAMIC�',
'As�ри�рібна ціна повинн�SHORFAULT�и біль* @vrt Descrip� знаходитьна повинн� 'Дост�EXTEND_Tit_EXTEND_ERRORSAEDITVA!',
'AREdit Variaй товар (FORM�ння гор : YYYY-MM-DDDF, віде�'В�DE,
'Aвар:ежнEARTICLESXTEND_FREESHISTORNLLING' C�',
l�оштовна дос�UNASSIGУста�assign from' =>pDF, віде�NEWвом�о',
'A)',
'ARTICні',SCONFIGURABLE' =>DDR_ALLITEMSкт мож�'utf-8'CONFIGURABLE' =>ься�ний',
'ARNewродуD_ISSEARCH' => 'CATEGOICLE_BUN�ий дл�Cateog�товна д�TICLE_TREтуп�Re-Indexов�e is TreEXTEND_ERRORSATICLONTENRTICLE_TH' => 'Доr modiабарити)',
UNTEND_LENGTH' => 'ДоLLARTICLESарити)' в цих к�кт можShiNOATT Cost Ru_EXTEND_ERRORSALE_EXTEND_NSEICLE_EXTEND_ME> 'ВіртуMethoажіть п�LE_EISня ONMATERIAL' => '�ений товар (NEW�ст�ний',
'ARTICLEttribuNG_ASSIGNAIPDISCOULANGUR' => 'В�ий дл�LNU Gene�ти всі неINниж�кт можLinвий мол�NEWMALLC�ння �ий дл�he Lовжина:',
'ARTICLE_MANUFACTURE!',
'ARкт можM  along witльтернат�WS�онтакт',
'A� PDF, віде�NEWNE�регѻон',
'ART�іть атррібна �LETT шабдл�NCE
 * @t SaRTICD_ISSEARCH' => 'PAYMRTICLE_EXTEND_MERTIC) any lАльтернатив�PROMO> 'Устдл�ні',/Promoме�BannND_TPRICE' => 'Р�REMARниж�Add No�ати всі н�SELEC�сиONMATERIAL' => 'В-------- Les A�зова цінHOPRTICLE_EXTEND_TEM @ve�:',
'ARTICLE_EXTTATIST�ти бRIAL' => 'ВанняND_ISSEARCH' => 'US шаблон',
'ARted _EXTEND_UPDATEPRICESGROUD_UPDATEPRICEB' =>LLIST' => _EXTEND_UPDATEPRICES-сть (одиниць)',
'ARTICLE_EXTEND_UPDATEMEDIAVAR1�овитRTICLE_EXTEND_UPLOA2�',
'Abelступні к_UPLOA3�',
'Ac)',
'ALEUPLOAD' => 'Заг_UPLEND�!',
'ARакт',
'ARTIвувE_ATTRIE_EXTEND_UPLOUCH шаблон',
'ARCoupon SATTR�:',
'ARTICLE_EXWRAPPINRTICLE_Eий дл�WE_NOATT�:',
'ARTICLEOPENHELD_UPDATCROSSSHelTICLE_EXTEND_U�д�ICES'ARTICLE_EICE' LLIST> 'А:',
'ARTICLERECALCNROFій<br>IN
'ARTICLERecal�рй дE_TOOXTEN�іни/ці�мірiодуктBLED' => 'This is a demosMAУст�ading files has been switched off TICLE_EXTENDND_ISSEARCH' = => 'This is a demosV� вікading files has been switched off через ня',
'ARTICLE_SEThis is a demoshop. Uploadset has been switched off due to security reasons.'IDTH' => 'Шир�URLDESC' =>RTICLE_FILES_ENTER_FILENAMосилання',
'ARTICLE_IDTH' => 'Шир�'Вага',RTICLE_FILES_ENTER_FILENAM 'кг.',
'ARTICLE_EXTENDTIMEрузити�тегоріях',
'ARTICVAL
'ARTICLE_ош�1__@@ош�2�й� usw�родTAL_PLUS_PROPORомAL_ання plus�а  (proARTIionally ing filesdі т�S_RATINGS_BUTTON_ALTICLE_EWrite a ка";!ження моURLRIES' => 'ПTrusBUND @ves Customer Rasales.com',
'ARAPP_DIRNOTPPING'D_WARN�инсьPleaseлежнdirec�і :CLE' =>Appля GB_LIST_EN => 'ЗЂаж�у наBUTES' => 'Вибе�AdminisXTENted in thES_OR' => 'або ин атри�LLIST' => 'йл',
'ARTICL'ВіALLMEMBERрегтll� файл',
'ARTICL'Ві іс�IN на пе�LLIST' =>  Me_TOOвведѺаѾв�_ в цитованиВіртуTIONS_LIST_ME�лу'ься_QUANTITCLE_BUN�ння льки EXTEND_BONIанта�D_FIванLES_TABLE_UPLOADCR'ARTPOINT => 'Не D_FIpoin�вт�TABLE_UPLOADDISABLEAUTO на пе�Dea�іть automaticту',
'ART ARTICLny laterTABLE_UPLOADEMAIL_BUNDLE_ASSIE-іт Adr.осInvali атTABLE_UPLOADMOBILF'Уст�Celluar Phon�и �TABLE_UPLOADОдиниця',RecievesRTICLE_EXTEVETO' => 'До',PR> 'д',
'ARTIEvenту_ACTIVETO' =>  ноCUSTOME'ARTICLE_A =>  NoIST_M> 'Аль�MEN завантажити файл',
'RTICLE_MAINR_FILENAME' => 'олити ре�PLACтупн_FILES_TABLE ноZID_UPDATтои',
'AR'Ві�ерн�SN�ант�=> 'Заіни',
'AR'ВіVE' =LOGIARTICLE_но'/Logunder TICLE_MAINHASPASSWOR вікHas password
'ARTTICLE_MAINLDAD_UPDATCLE_ GB_LI�ру',
'ARTINAMтуп�Name, Sur'П�GARTICLE' => '�К-�_MAIN_EAN' =�ляN то�GARTICLE' => 'RIGH,
'ARTICXID eShop TICLE_MAINSTR=> 'АрStreet, �ат�л',
'ARTICLEOVERTICLDEDFILES' =\'TrafRTICL *
\' > 'Завантаже�LE_MAIN_MAREACKORD шаб�AborBUNDOt' =�лити LE_MAIN_M на => 'Н> 'або введ�',
'ARTICLLASTBUCLE_BUNLast P => ',
'ADM
'ARTICLE_MAIN_PRI'ВибеѦінp�',
'ARdродукт 
'ARTICLE_MAIN�е�_MAIN_A_PRI�:',
'AR-сть 'К-сть (одIN_GOT
'ARTICLE_EX�--',
'ARTTICLE_MA-сть (од�егти',
'ARTICLE_MAIN_SEARCHKEYS' =�рії',
�ль� Typ вже іTICLE_MAVALUтуп�Valu вже і_UPDAT,
'ARзна�TICLпр�AGS' => 'Т�т. ном�[ро�E_MAIN_TITLE' => _UPDATEPRICE[R доE_MAIN_TITLE' => ICES' => '[Reg.пр�usrRegит�eисв�TheSAVIN will�с�r�ц. ПД a> 'Тenterтуhi'EAN то�IST_MзавBUTES' => 'Вибе�Ma�тиd-esales.comLE_OTHER_OPTIONS�н атри� 'кг.',
'ARTICLE_OTHER_OPT�ризначенV�но �ажи�ra' =>пр�LE_OTHEім\'яNTS' => 'Ногavail�роul,
 *    b�дален�ICONUPLOARICEC' U до Ic�ут�LASTCHANGE' =стWITHзавант�іни/�_EXTEtютчерез FTP)@copAn 3 of tShow e Licen'я ф�SERIE_EX',
'DONтупн�ісs exARTIC'ARTICLE_ARTICLVERVIEW_SALEPOSITIONWNстаннACTIONS_CLE_OVERVIEW_SALEPOSITIDLE_ASSIейтинг �edіях�ам',
'ARTICLE_OV�инсьE�г �туc�йти..дажам',
'ARTI=> 'У�о',
'ARTICLE_OV�ари TOTALORDERCNT' => '�STOM_PICTN' => 'Рейти�ари�',
'ARTICLE_RTICLE_PICTURES_CUSTOM_PI�инськомвлень',
'ARTICLE_PICTURES_CUS_MAIN__TABLE_FILENAA',
'ARTICfoи фабо ввжам',
'ARTIUTES' => 'Вибер@verпції',
'Aка 1',
'ARTICLE_PIC�н атри�міститтинка 1',
'ARTICLE_INс',
'ARTICMin.�ро� SuстѲантажити W_SAALARTICLE_A: ТICTURES_PIC2UPLOAім\'яOWOTVIEW_SALи',
'AVAIN_ with diffe�ніTICLE_PICTURES_PIC2' =>�ку 2',
SAMECLE_PICTURES_PIC3' => 'same�нка 3',
'ARTICLE_PICTURES_VAILтоICLE_PICTURES_P 3',
'ARTICLE_PICTURES> 'TUICLEONY' => 'Кng files �діonce (MAIN_ => '�C1' p> 'Тоor  file is �и виі т
'ARTICLE_PICTURES�ий контений т�
'ARTICLE_PICTURESPOSITIо замо�RTICLE_PICTURES_PIC5UPSTOM_PIC_ICONUPLOAD' 'Картинка 4',
'STOM_PICRANDOTICLE_Aкоменandom NoRTICLE_PICTURES_PIC5UPMINт. �PRIY' => '�2',
'ARTICLE_PICTURES_PIC2UPLOAснує'я файлу може міс� 3',
'ARTICLE_PICTURESнкаARTICLE_AICTURES_E_TOO� 3',
'ARTICLE_PICTURESUPLOAD''ARTIт. ном�вантажити к�,'Картиро�RTICLE_PICTURES_PIC5UPUSDLE_ASSIUs� ат'ARTICLE_PICTURES_�ант�тивнѼісѰжи�> 'Зберегти',
'ARTICLEND_UPDAT�о',
'AR,
'ARTICLwe *
 тіл�ав�,
'лати_COS,
'ARTICGift�ви, циф мініTICLE_PICTURES_PIC1UPLOAD' => 'За�RES_UPLOADISDISABL�н атри�',
'ARTICLE_PICTURES_UPLOADISDIPIий OXID eShop Commun�ення / взв�NTPACKUES_ICONUP,
'ARTICLE_PICTURES_UPLOADISDI�ризначенви, цпр� міні'Віидалення зображен�ьша Останні змLE_PICTURES_ZOOM1UPLOAD' =�уло закрито в цілях безпESSORIES' => 'ПризTURES_ZOOM1');
