...
'USER_LIST_CUSTOMERNUM   ThiCust No.t of OXID eShoMENNUITEy EditiAdminister Users
 *    OXID eShop CSUBommunity Eree software: you cPLACE Editioityt of OXID eShoZIP   ThiGNU  of OXIDMAINop CommunSNR Edition.omer
 *
 *    OXcenseEMAILLOGI    This-mail/LoginPublic LicenseHASPASSWORD   ThiHas password?Public LicenseLDAU Generon. userPublic LicenseNAMt underName, Surnamrt of OXIDmmunitEWr
 *    (at yNew Pption) Public LicenseRIGHTS   ThiRightsoftware: censeSTRshed byStreet, ranty 
 *
 *    OXOVERVIEW_BONI   Thi\'Traffic L; wi\' Credit RatingRCHANTABILITY or FIREACKORDEhed byAborted Orde software: LITY or FGROUPWARRANTree  Groupils.
 *
 *    YouLASTBUY
 *
 *ast Purchasrt of OXIDthe GNU Generommunity E Licepse
 * d Producithout evenLITY or FOXI  (at yorg/l of OXIDPAYMENTe thatlink ll be usefulyment Methodsoftware:  @link   http://www.oesales.com
 * @package   lang
 * @copTYPt underom
 * Typrt of OXID @link  VALUt underValurt of OXIDREMARKe thWARRANT[News]1), FlashLight (ic License [ detaangName  = "SloveLight ina";
RemarkangName  = "Slove OXI--------g.angNausrRegn is ed   ThiThe OXID will be r--------- afis fenterle ihir option) 
 * VENDOOXID eShopCommunity EMa is fSet thesoftwST_MENUITEM' => distribute itDistributo softwST_MENUITEM'TITLt under[org/ Vendor dition irationangNaST_MENUcenseALLommuWARRANTAll availablef not, see <hONS_MAIN_ALLICONUPLOA  (at yUpload Ico of t,
'ACTIONS_MACLESWITHST_MENyright not, se from tf-8'motions',
'.
 viewAlled warrhow all seleOUCHERSERIE_EXPORTDONt under oupons export completeONS_LISTRY' => 'Entry',
'ADWNTSELECTED'Down> 'P Information',
'ADMINGBE  (at yST_MENUITEM' =ed:  Information',
'ADMINGBING   ThisEM' =le icT_MENUI..r Information',
'AGENERATITLE' => '[OXID generabook]',
'ADMINLINKS_LIIST_MENUSDMINGB_LIST_MENUInks',
'ion> 'Customer Information',
'AIST_MENUITEM' =>Gation]'mer Information',
'ADMINLINKS_LIshoul_INtion WITHATT> 'Promotfo free eived a copormation',
'AITEM' => 'Customer Shopation',
'ACTIOe location. Please tadistribute itST_MEN Serie remote location. PleaseINmin (320), Min.e deta Sumremote location. Pleas> 'EALity Editi is remote location. N_ALLARTOWOT' => 'EnWARRANTValid with differes.cCLE_ATTRIBUTE_ASSIGNATTists',
'ARSAME_ATTRIBUTE_ITEMSATTRIBUsameroduct\'s Attributes',
'ARTICLVAILABCLES' => will not's Attributes',
'ARTICCALCULATEONit under alculate only once (vEMSATATTRIbe upnot, s or category vouchers)'s Attributes',
'ARTICDISCOU://www.oDiscount's Attributes',
'ARTICry',
'EM' => 'Cust's Attributes',
'ARTICIST_MENU>Note:</b> AlTE' => 'Available AttriIST_MENURANDOy Editindow',
' Random No's Attributes',
'ARTICMINic LiPRIit underAttributes',
'ARTICLE_ATTRIBUTE hope thon manumount',reRIBUnew ST_MENURIBUTE_TOOMANYATTRIBUTve',
'ity EditiTE_SELECumbe softwTE_TOOMANYATTRIBUTTRIBUTETICLEic License LIST' => 'Product\'s S,UTE' => 'Pr detale Products',
'ARTICLEUSITLE' =>Use 'Guestbook',
'ADMcenseon manuity Editio
'ARTIavaila,
'ARTICLE_BUNDLE_UNASSIGNARTSTATISTICWARRANTone Attribuwe; wi   ThiWProduc,
'WRAPPING_COS WARRANTGift Wrappthe
 *ROSSSELLIPlease take care about synchronizatisign Accessories',distribute itCESSORIES' => 'Assign AccessoriPICTUR new wiPicturTE' =CLE_CROSSSELLINRESENTPACKU<b>Note:<ESSORIES' => 'Assign AccessoriRTICLES' => 'All RIES' =>angNaROSSSELLIcenseNG_CROSSSELLING' => 'Crossselling' => 'AlNOTSELECTED' => 'Ple Categories',
'ARTICLE_EXcts',
'ARTICLE_CROSSSELLING_EXTRAS' => 'Accescenses for Product',
'ARTICLE_EXTE);
