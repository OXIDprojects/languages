...
'HELP_SHOP_THEME_iNewBasketItemMessage' => 'Lorsqu\'un client met un produit dans le panier, OXID eShop peut se comporter de différentes manières. Définissez le comportement à adopter.',
...
'HELP_SHOP_THEME_sCatThumbnailsize' => 'Dans la vue par catégorie, l\'image de la catégorie sélectionnée est affichée dans la taille définie.',
...
'HELP_SHOP_THEME_sThumbnailsize' => 'Les vignettes sont de petites images des produits. Elles sont utilisées:<br><ul><li>Dans les listes de produits.</li><li>Dans les promotions affichées au centre de la page d\'accueil, ex: <span class="filename_filepath_or_italic">Serniers arrivages!</span>.</li></ul>Afin d\'éviter les problèmes de mise en forme liés à des images trop grandes, les vignettes sont redimensionnées. E Entrez la taille maximale des vignettes ici.',
'SHOP_THEME_aDetailImageSizes' => 'Taille des images produits (largeur x hauteur)',
...
'SHOP_THEME_blTopNaviLayout' => 'Afficher la navigation par catégories en haut',
'SHOP_THEME_bl_perfShowLeftBasket' => 'Afficher les panier à gauche',
'SHOP_THEME_bl_perfShowRightBasket' => 'Afficher les panier à droite',
'SHOP_THEME_bl_perfShowTopBasket' => 'Afficher les panier en haut',
...
'SHOP_THEME_bl_showListmania' => 'Utiliser les listmanias',
'SHOP_THEME_bl_showOpenId' => 'Utiliser Open ID',
'SHOP_THEME_bl_showVouchers' => 'Utiliser les coupons',
'SHOP_THEME_bl_showWishlist' => 'Utiliser les listes de souhaits',
'SHOP_THEME_GROUP_display' => 'Affichage',
'SHOP_THEME_GROUP_features' => 'Fonctionnalités',
'SHOP_THEME_GROUP_images' => 'Images',
'SHOP_THEME_iNewBasketItemMessage' => 'Choisir une action lors de la mise au panier d\'un produit',
...
'SHOP_THEME_iTopNaviCatCount' => 'Nombre de catégories à afficher en haut',
...
'SHOP_THEME_sCatThumbnailsize' => 'Taille des images de catégories (largeur x hauteur)',
...
'SHOP_THEME_sIconsize' => 'Taille des icônes (largeur x hauteur)',
'SHOP_THEME_sManufacturerIconsize' => 'Fabricant : Taille du logo',
...
'SHOP_THEME_sThumbnailsize' => 'Taille des vignettes (largeur x hauteur)',
'SHOP_THEME_sZoomImageSize' => 'Taille des images Zoom (largeur x hauteur)',
);
