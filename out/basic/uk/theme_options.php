...
'HELP_SHOP_THEME_sIconsize' => 'Іконки це найменші зображення продуктів. Вони використовуються:
<ul>
<li>в кошику</li>
<li>в списках праворуч, наприклад "<span class="filename_filepath_or_italic">популярні товари</span>" або "<span class="filename_filepath_or_italic">спеціальні пропозиції</span>"</li>
</ul>
Щоб уникнути проблем з відображенням, іконки будуть зменшенні. Введіть тут максимальний розмір для іконок.',
