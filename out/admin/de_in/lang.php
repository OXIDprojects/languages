...
'tbclnewsletter_pl<?php
/*Text*    This file is pareviewhp
/*Vorschau*    This file is pselectiophp
/*Versenden*    This fi_m<?php
/*Stamm can redistribullhp
/*Mit ucan redistriteSho OXID eShop Commuorder_addressGeneraApubliou can redense asrticleshed byrtike terms ofense adownloadished bDf the Licer version 3 iPaymen GeneraIon) any er version 3 bute it and/or modify
ense aover
 *
 *   Übersichn.
 *
...
/**istorie.
 *
 pn) any_countryGeneraLänderut WITHOUT ANY Wbute it and/or modify
UT ANY WrdfaGeneraRDFa  MERCHANricealarmarra under E-MOSE.R A PARTICULAR PURPOSe it and/or modify
roles_beublic License for more details.objec GeneraObjektbut WITHOdetails.userGeneraBenutzven the imdetailf.
 *
 *    You should have rfblic License
 *    along won is liswarranty of
 *    MERCHAg/licenses/>.t under the terms ofshop_cachoundatiCaching
 * @package onfig.  See instell.
 * @packagelicensoundatiLizenz
 * @package>.
 *
 * @link      htrs: dsd-esales.com
 * @packageperformancoundatiPch inf
 * @version Y or FITNESS FOR A PARuppeseo it andEO-
// RESOURCEystem it and -----
// REStatistic dsb, ravage, simone.schu------
$sdistmell";
Wartuyright (C) ysreq dsb, ravage, simone.schthemeD eSales AG 2003-2012
 * @verONS_LIndeninformation',
'ACTIOoolribute it andQ *    Thilic grou: dsb, ravage, simone.schlic as published by
 *    the FreRTICLEare Foundation, either versRTICLextend.  See rweitern.
 *
 RTICLel',
'ACTIONS_MAIN_ALLARTICLUT ANY GeneraZahlT_MENUITEM'RTICL be useful,
 *    but WITHOvendon eine Aktion zur Bearbei=> 'Eintrt under the terms of=> 'EinE IDENTITFIER = STRIvouchare:rie_ Artiished be
 *   gruppen & on, either versM' => 'Gästetrag',
'ADMINGB_LIST_MEN
'ADMINLINKS_Lt under the terms ofwrappingS_LIST_MENUITEM' => 'KunENUSUBITEM't under the terms ofS_LIST_MENUITEM' => THEME_ACTIVATEshed byktivierou canNATIVE_UTHORshed byutoen thNATIVEPARENT_NATIVETITLSERVER_Eltern-TNS_Lt konfiguriert, AVERSIONSGeneraKompatible einem extern wareion(en)t konfigurn. Datee softwarefree konOOLS_LISTE_IMAONENDERVER_NOTEon be: yon.
 nuelle SynchFFECTEDROWien werAffected row   (anuelle SyncERRORMESSAGer von error messagnen Se> 'Attribute zuNUM,
'ARTICLE_Anumbven thSIGNSELECTLMENUITE 'AuswaS8',
'ACdnen',
'ARTICLE_ATSUBTRIBUTE_ITTRTICIBUTE' => 'ArtiSECCESien werBackup data ch ilgreich g.
 lt
 * RTICLE_ATTRIQLQUERY=> 'Alle  queryIBUTE' => 'Artibilder von [OXID rib.']IBUTE' => 'ArtiUPDATEVIEWSIBUTE_ITEMSSEDatenbank-Views wurdenArtikel hat daktualisierusw.listen',MAIN_CHECKPICien werUnb
 * te Bilder s => n und lös_OPET' => 'Nicht beSQLDUMBRIBUTE_NOA�hlei import => '<b>HiNeues AttriTARTisten',pdate startW' => 'Neues Attrben. Attribute',
'ARTICLE_ATTRIBUht beATTRIBle vIBUTE_NOAausfüh
'ARTICLE_ATTRIBUTATTRIBUTES'CONFIR 'AuswaBist Du e hoer, dassribudie UTES' jetzt uSpeicn willst' => 'MengATTRIBUTES' => 'INFO:',
'ANachdemribuÄ eveungen am Tabellenlayout vorgenommen hast, musttribu'ARTICLE_Bneu genästrenST' => 'Nicht beATTRIBUTES'NOWe softwCLE_BUNDLE_ALLITEMIBUTE' =TIPS_ADDSUMITMTYPSERVER_NbsolutswäprozenTE_Ner<br> oRIBUon, eitügbAuf/Abschlarighthen',
'ARTICLE_SSSELLING_ALLITEMS'aren ügb> 'Alle verfügbRTICLE_CROSSSELLING_ASSIGNRTICLEDELIVATTRIBUTEZeit Finfot:SIGNCROSSSELLING' =>RBUTESundation, eit  OXID eS öffn löschen',
'ARTNG' =>STOCKIBUTE_AnzahlArtikel' auf Laguordnen',
g-Artikel',
TEMPLE_SERVER_ster name des Templatesügbfalls n hop Standardugeordnete Zubehör-UNITDESCRIPonisisten',
hörDLE_Grundpreis AttrRIBUPARTINzu verstehen,S' =>e hoRAS' eineügbabestimmte MeCLE'einh zuobezieht,NINNEzwarCLE__CROießlichügbaRIBUMehrwertsteuerNINNEsonstig => 'Zug_BLFandteilesw.listenEND_ARTEXTRA'RLIMGCLE_CROSpassung,
'ARLCATS' => notwendiSSIGNCROSSSELLING' =>VAVE' => Nur le Katspaktille MwSt. hierCLE_ATTikelLE_EXTEND_DEFAUL SyncNEWROder von Neue Ro_DIManleg',
'ARTICLE_EXTEND_ENTEL' =GENERAT> Der ShRechteNINNEende n 'Artike' => 'Artikel dazu:',
'AE_EXTEND_ENTESEARCHFIELDOXDYNAMIC:',
'ATE_OP' => 'Warnung: UVP muss größer aSHOR> 'Araler Preis  KurzGNU G => 'Warnung: UVP muss größer abilder von 
'ARTITitither  'WarnungEDITVA Der ShVariante edin',
'ARTICLE_A,
'ARFORMeibung',rdnen' : YYYY-MM-DDND_FILE' => 'TRIBDEr-Ars AG 2003tragEWWINDOW' => 'Neu'H:',
'ARSTORNARTICLE_ISCONFI*   nPING' => 'VersandkTRIBUNASSIGtelle bittknüpfetzezu ShopEWWIN',
'ARTICLE_EXTNEWhronisien werstierher.',
edien URL angeben <bL:',DDRE_ITEMSSETEND_M
 *  e',
'ARTICLE_EXTENG' =>IAURLS' =>nLING_EXTRA 'Maße',
'ARTICLE_EXTCATEGOTTRIBUTEstierKateg   b'Immaterieller Artikel',
'ATREEND_NONESTIONEMAbaum' => indizPING' => 'Versandkl',
ONTENibung',
tierCMS-Saus 'Immaterieller Artikel',
OUNTCLE_EXTEND_Qs Land'Immaterieller Artikel', 'Crossselling.',
'wareandkostenreg> 'Immaterieller Artikel', 'CrosssSEorieren.',
'NAME' =artnheit',
'ARTICLE_EXTEND_UIS TempND_NONMATERIRabatCLE_EXTEND_UPDATEMEDIA' =ist ite',
'ARTICLAttribuCLE_EXTEND_UPDATEMEDIA' =LANGUen',
'ART.',
'Spr  laTEND_UPDATEPRICEA' => 'A:INICLE_CRMATERILink'Immaterieller Artikel',MALLCeibung',
tierthe UESTIONEMAIL' => 'Alt. Anspr.partnMANUFACTURE Der ShMATERIHete KllUNITstgesetzten Zeit aktualWSrnehmen',
'ARENSIONSatzRICETIME' => 'Startzeit:NETRIBUTE_CES' _BUNrgorieLE' => 'ODER Datei hochladeLETT
'ARTICLE_EX N file is  'ZulBUTE_ASSIGNNachläsPAYMgnorieren.',
'B_LIST_sTICLE_EXTEND_UPDATEMEDIA' =PROMOel dazu',
TEND_MASS' /Promo> 'TeBann'Zugeordnete ZuRURLEMARXTEND_UPotiFILEfüaße',
'ARTICLE_EXTSELECD_ENTND_URLDESC' uswahlnsesEPRICEB' => 'B:',
'ARTICLSHOPARTICLE_EXTEICLE_ND_WIDTH' => 'B:',
'ARTITATISTrmaler PXTEND_------EC' => 'C:',
'ARTICLE_EXTUS
'ARTICLE_EXr e
 *    aloISDOWNLOADABLE' GROUE_FILES_ENTd von DatE' => TICLE_FILES_ISDOWNLOADABLE' , Zahlen, Unterstrich (_) und',
'ARTICLE_EXTEVAR1 Datei angICLE_FILES_NEW_PURC2azu',
'ARTIICLE_FILES_NEW_PURC3CLE_EXTEND_FREEICETIME' => 'Startzeit:VEND> Der ShPDATEPRIeferanollten per FTP hochgeladeVOUCH)<br>(DateinaGutNDOWinGästEW_TITLE' => 'Neue DateiWRAPPINs HauptE_FILEeNDOW'kverpLISTngEW_TITLE' => 'Neue DaOPENHELE_FILESHilfchern',
'ARTICLE_nen DateiLE' UNIT' => 'e
 *   E_EXTEete Crossselling-ArtRECALCNROFikel',
'INUPDATEPRIon, eitaSSSELLRIBUESTIONEMAn' => berechES_TABLE_PURCHASEDONLY' => 'Nur gekaMAdazu',
TICLE_FILES_TABLE_ND_UPDATEPRES' => 'Hochgeladene Dateien',
'ARTICLE_LIST_AVtion sichICLE_FILES_TABLE_CLE_FILESFILES' => 'Hochgeladene DateienSET' => 'Nur gekauft',
'ARTICLE_FILES_TAin ,
'AUPLOADEDFILzurücksetz 'von',
'ARTICLE_MAIN_ACTIVETO' =>LLPRODUCTS' => 'alle ArCTIVFROND_UPDATEP 'Oder aktiv',
'ARTICLE_MAIN_ALDPRICE' => 'Alt.N_ACTIVE' => 'Aktiv',
'CTIVFROCLE_MAIN_ACTOder aktiv',
'ARTICLE_MAINTIMEostenfrei',
s zuordnen',
'ARTICLE_CROVALerne URL',_ISCONF1__@@_ISCONF2ICLE uswsw.lisS_RATINGS_BUTTON_AL'DateinamE_EX',
'sel dR_FIL!ARTICLE' => 'WaURLUTE_SELECTONTrusNATTICLEs Ku youbmer bICLE'ND_FATTRIBAPP_DIRNOTTICLE_D_WARNFILES_OR_BitteEWWINDOW�hle_ALLITEApp-Verzhat ni',
'Alic LicensCLE_MRY' =Artikel ARTICLE_ATTRIBUTE_ITe
 *   dnetwalg lösc-Artikelnummer (MPNhat diese AttNGB_TITLE' => '-- keine --',
ht beALLMEMBERRIBUTE_AD_ERe
 *    alo_MAIN_PRICEA' =A:',
'INikel zulassMitglieRIBURIBU'ARTICLE_FILES => 'B:'RTIC_MED_ 'CrosssEND_MEDIAURLSCLE_FIL
 *    theern',
NG' =>_QUANTITTRIBUTEOSSSEL',
'ARTICEXTEND_BONIICE' =>onitäTICLEr.',
'ARTICLCR,
'APOINTITEMSSELonuspunthe GNUr.',
'ARTICLDISABLEAUTOikel zulassKLE_E autom----' =>NGB_TITLE' => '-ZuordnT_MENUIr.',
'ARTICLEMAILFAILEion sic the
 'Me. ungültDESCRIr.',
'ARTICLMOBILF dazu',
Telefon mob
 *  r.',
'ARTICLn werden)<br>(Datefile is RVIEW_ARTMADEON'PRAGE_ptionen',
'ARTICLprivaStichworte SyncCUSTOME => 'AuswaCLE_MAnumm'ARTICLE_OVRTICLE_APN)',
'ARTICLE_MAIN_NONE' => '-- keinederung am',MAIN_PRICE' => 'PreisCNT' => 'AnzahPLACEND_NONORTICLE => 'AnzahZIE_FILESPLZITION' =>ht ben_OVERVISN Der ShANGE' =r
 * on',
'ARTIORID'LOGIdazu',
 the
/LogiRCNT' => 'ht beHASPASSWORion sicHatCLE_ Passwort?Verkäufe gesaLDAE_FILES_PICN_PRICEB' => 'B:'' => 'NAMEND_NONVor-/_BUNEXTEl/Icon manuell en, tanzahl bestARTICLARTICLE_Verkäufe gesaRIGHTITLE' =ube!)'Verkäufe gesaSTRIEW_SOLDStr./Haus> 'VerkäufeOVERLE' LE_MAIN_TAGS' => 'S als Ampither ICLE_PICTURES_PREACKORD
'ARTICLAbgebro_OPEN_VAUPDATATEGORY' =CLE_PICTURES_ikel ITEMSSEL 'Preis',
'ARTICLE_MAI_PICTURES_LASTBUTRIBUTELNDLELE_UPufLE_PICTURES_PIC3' => 'TRIBUTE_ITZulNDLE_gekaufteXID GästebuIC2UPLOAD' => te',:',
'AoxiTICLEIC2UP, Zahleaben, Zahlen, Unterstrich methoteller-Art_PIC4UPLO, Zahlen, Untich (_) undICLE_PICTURURES_PIC5' => 'SSSELLING_M,
'ARTntypPICTURES_PIC4UPLOVALUEND_NONW der LiIC2UPND_WEI' => Attribult aCLE_A'ARTICLE_PICS_PIC2' => [TICL.D' => 'Bild 6 hocND_WEIGHT' =[BemLE_PICTURES_PIC7' LE' => 'Do[RegLE_PICusrReg_EXTrete wähDMAIN_SAVE'  wird nachE_MAIEingabe sLE_EICTURES_ICes rladenikelCONUP hochlARTICLE_ATTRIBUTE_ITE/or ung löscchern',
'ARTICLEhat diese AttCLE_MAIN_AC'Thumbnail',
'ARben. Attribute',
CLE_MAIN_ACONE' =>ungCLE_Achern',EA' => 'Basispreis:_MAINverht',ba voron, either ' => 'Dies iICONUPLOA,
'ARTIIcon hoCROSyou can Bildern wurdst iWITH hochladen',ING_EXTRvonNEDAsemE_PICTURES_UND_F
 *At under _MAINanzeiEGORY' ken',
'SERIE_EXPExteONEND_NONES_OR' =>exfnen abgME' lo*   
 * n:',
'ARTICLE_PICTUREWN Sicherhei or
 * S_ZOOM2UPLOAD' => 'Zoom'Liefera => 'Zoom   2',
'=> ',
'ARn:',
'ARTICLE_PICTUFILES_OR_ECTURES_ZILES_OR' =>e ..ES_ZOOM2UPLOAD' =>, mp3 o'LieferaOSSSELLPICTURES_ZO'ArtikelOOM3UPLOAD' => 'ZooRTICLE_PIES_ZOOM2' => 'Zoom'Artikelamen TICLE_PICTURES_ZOOM2UPLOAD' =>, mp3 oFILES_OR_GArtikel _PICTURES_ZOOM4' => 'Zoom 4',
'ARBild _RICEC' => 'C:V Hochlade füAIN_SAVE' => 'Sphladen:',
'ARTICLERTICLE_ATTRIBUTE_ITEhop => LE_PICTURES_Pxt:',
'ARTICLE_RIGHTS_hat diese AttES_OR' => 'odeergruppen',
'ARTICLE_RIGINPIC6' => 'BAborsc'ARTsE_EXrgruppen',
'ARTICLE_RIRTICAL=> 'AuswaNE_PICTUn:',
'ARTICLEEA' => 'OWOT
'ARTICLES_PIC6GTHER_O miolltderer Sästpen zuordnen (AusschließliSAMEchtbar)',
'ARTICLE_RIGHTglhat GROUPS_BUYABLE' => 'AusschließVAILNTE''Speichern',
'ARpen zuordnen (AusschliONLYUkel'ONIEW_SALE
'AReinmalig => 'Hochg (OTHER_O nur bei zugew
'AR> 'MPICTURES_Zort hozuordnen (Ausschli> 'ÜbernehmenTICLE_'abs',
'ARTICLE_STOCK__PICTUaden:',
'ART'abs',
'ARTICLE_STOCK_RTICLE_PIEW_POSTEDFROM'ergruppen',
'ARTIC=> 'bis',
'ARRANDONBUYABLEArtieichRandom Nh sichtbar für die BenMINS_PICPRIIEW_SALERTICLE_Rafbar)',
'ARTICLE_RIGHTS_ASSIGNVCON' => ken',
'ARTICLE_FILES_OR' =>er Datei hochse',
'ARTICLE_STOC',
'AR=> 'AuswaZule Ka=> 'Le'ARTzeuLIVERY' => 'Wieder liefer kaufbach siS_PIC2' => e Benutzergruppe',
'ARTICLCLE_S_STOPRICSETGnRTICLE_PICTERY' => 'Wieder lieferUS'Lieferaladen:NTPRICE_AMOUNTTO' => 'bken',
'=> 'AuswaES_OR' =>=> 'LetzteOSTOCKTEXT' => 'Info fallgeladenenr)',
'ARTICLE_STOND_Fweigh'ADMINGGew hope thICLE_FILLE_RIGHTS_ALLGROUPS' => 'Alle BenutzergruCK_PRICE' => 'Prei_ASSIGNBUYABLEME' => 'oder NameTIV' => 'E-Mail scPIen',
N_MANUFAlCLE_Prt sinkt',
'ARTE_MANTPACKUEVIEW_POSTnd<br>unter folg. Wert sinkt',
'ARben. Attribute',
 => 'LagerbADISDISABLEDCK_PRICE'ht beTICLE_STOCK_SAVE' => 'SpeicherTEXT' =>us SicherheiAVE'ünden abgeschel auf Lager',
RTICLE_STOCK_STOCK' => 'Lagerbestand',
'ARTICLE_STTRIBUTE_SELECTONEATTR'ferstatus',
'ARTICLE_S);
