...
'ARTICLE_ATTRIBUTE_OPENINNEWWINDOW' => 'Attribut in neuem Fenster erstellen',
...
'tbclmanufa<?php
/*ll
 *   MeShofile is part of OXIDseo
 *    EOty Editioodule_config
 *   Einstell. Community Edit/**
 *    This file is y Editsortlist
 *   Installierte Shop-My Edity Editinewslettp
/**
 *   HTML Public License as pl**
 *   Text *    the Free Softwreview
 *   Vorschau Public License as selectio
 *   Versenden Public Licetribute it and/or modify OXID eShop Community Editi OXIDtion,oundation, eitherorder_address will At WIT
 *
 *    *    brticleHOUT ANrtikeity Editi *    downloadTHOUT ADMERCHANTAnty of
 *   iPaymener the tCULAR PUnty of
 *   /**
 *    This file is *    overthe LicensÜbersichthe
 *    GNU remarkished bistoril Public pULAR P_country will Länderthe GNU General /**
 *    This file isGeneral rdfa will RDFaty EditioricealarmID ehop ComE-Mses///www.gnu.org/license
 *    This file isroles_beww.oxid-esales.com
 * @packageobject will Objektl Public @packageuser will Benutz    along @packafe   lang
 * @copyright (C) OXfOXID eShop CE
 * @translatn) anyundeID eShop Community Editi-------------Shop Community Editishop_cache impliCaching -------------on is free software: you can-----license impliLizenzutf-8',
'ACTI----------
// RESOURCE ninfor= STRING
// ------------performance impliPlten','utf-8',
'ACTInot, see <http://www.gT_MEN  OXID eShop Communiikel',ystem
 *    SWITHAIN_ALLARtatisticformation',
'ACTIONS_LIST Artikel's detACTIONS_Wartu---
$aLangysreqformation',
'ACTIONS_LISthemition is free software: you caneitungn eine Aktion zur BearbeoolID eShop CommQ
 *    thXID grounformation',
'ACTIONS_LISXID  but WITHOUT ANY WARRANTY; wition',
en the implied warranty ofion',extend/>.
 *rweiterthe
 *  ion',TEM' => 'Kundeninformation',General will Zahl aus der Liion', received a copy of the GNU vendoST_MENUITEM' => 'KundeninLIST_TITLShop Community EditiLIST_TI  OXID eShop Communivouchsionrie__MENUTHOUT ACE
 * @gruppen & ed warranty ofs:</b> Der ShTLE' => '[OXID Linksverwxternen ServerShop Community Editiwrappingver zu laden. Dateien wert hochgelaShop Community Editiver zu laden. DateieTHEME_ACTIVATEHOUT ANktivier
 *
 > 'MengUTHORHOUT ANuto   al> 'MenPARENT_> 'MenTITLRTICLE_Eltern-Titunute zuordnen',
'AVERSIONS will Kompatible ASSIGNSELECT rsioion(en)ute zuordnlisten ter versio latte zOOLS_LISTnge',ONENDTICLE_ATTRon ben.
the
,
'ARTICLE_AFFECTEDROWzuordneAffected rowNESS ,
'ARTICLE_ERRORMESSAGRIBUTE_Arror messagTLIST'OATTRIBUTE' => NUMben. Attribunumb    alLE_ATTRIBUTMENUITERIBUTESSitte w�ählen Sie ein AttSUBribut!',
'TY' =_ATTRIBUTE_NOSESECCESzuordneBackup data ltenlgreich ge   lt: you.listen',
'AQLQUERYntrag',
' query_ATTRIBUTE_NOSE_ATTRIBUTE_[OXID ben. ]_ATTRIBUTE_NOSEUPDATEVIEWSARTICLE_ATTRIDatenbank-Views wurdenNEWWINDOW' =>aktualisf thbut in neueMAIN_CHECKPICzuordneUnbE
 *te Bilder s</b>n und löswäh_TOOMANYATTRIBUSQLDUMBtellen',
'e w�i importBUTE_ASSIGNDLE_ALLITETARTBitte npdate startICLE_BUNDLE_ALLITVE' => 'Speichern',
'ARTICLE_ATTRTRIBU_SELEC,
'Aellen',
'ausfühkel',
'ARTICLE_BUN_SELECTONEACONFIRut!',
'Aind Sie     er das',
'Adie TONEA jetzt uTICLEn wollUNDLE_UNASSIGNARTICLE' => 'ZINFOdazu:'Nachdem',
'AÄ *  ungen am Taberfülayout vorgenommen haben, müARRASSSELLING_ALLITneu gener SrenE_TOOMANYATTRIBU_SELECTONEANOWter verALLITEMS' => 'Alle_ATTRIBUTIPS_ADDSUMITMTYPRTICLE_Absoluter, prozenE_ATer<br> out aed warrELLIAuf/Abschla--
$'Zugeordnete Crselling-Artikel',
'NG_EXELLITICLE_CROSSSELLIgeordnete Zubehör-ArtikelRTICLEDELIVerstellenZeit Fn',
t:TEND_ARTEXTRA' => 'ARCTONE implied warr e, or
  öffnG' => 'Zugeordne => 'ASTOCKn',
'ARnzahlTRAS' => auf Lage wählen XEDPRICE' =>TEMPL'ARTICLE_fügbname des TemplatesELLIfalls n   Y Standardisalarm)',
'ARTICLE_UNITDESCRIPTRIBBitte nuLCATSSIGGrundpreis ist ut aP> 'Bezu verstehOSSSut auARTICuf eineELLINbestimmte MeS' =einhARTIbezieht,len!'zwarUNITete ießlichELLINut aMehrwertsteuerlen!'sonstigibung',
m',
andteilebut in neauptkat. setzRLIMGderaktiopassungeben reis',
'A notwendiXTEND_ARTEXTRA' => 'AVAASSIGNANur LE_EXTspURL'lle MwSt. hierARTICLErfügbaren AXEDPRICEICLE_NEWROTRIBUTE_Neue Rerf� anleg_EXTEND_FILE' => 'Datei'ARTGENERATE' => 'ARechtelen!'_FILEnZubehörLING' => 'Crosssellings LE' => 'DateiSEARCHFIELDOXDYNAMICdazu:'uswäCLE_EXTEND_HEIGHT' => 'H:',
'ARTICSHOR.',
'ND_ISCONFIG Kurzt it LE_EXTEND_HEIGHT' => 'H:',
'ARTIC_ATTRIBUTE_ICLE_ETitrrantyEXTEND_HEEDITVA' => 'AVariante edirtikel',
'ARTIeordnFORMTICLE_EXCLE_EX : YYYY-MM-DDSEARCH' => 'KribuDEE_EX free softrag',
'ARTICLE_BUNDLICLE_EXTESTORNSSSELLIAL' => 'py onße',
'ARTICLE_EXTribuUNASSIGhat diese knüpfUVP zu GNU ',
'AG' => 'ZugeordnNEWATTRIBzuordneXTENDSELLISTPLOAD' => 'Datei hocchl�DDRCLE_ATTRIren.',Y WARREND_TEMPLATE' =>  => 'ATemplate',nnicht erlaLE_EXTEND_TEMPLATE' =>CATEGOrstellenXTENDKateg of _UNITNAME' => 'MengeneinheiTREVP',
'AEND_UNITQbaumLING'indizße',
'ARTICLE_EXTeinhONTENICLE_EXTTENDCMS-S',
'_UNITNAME' => 'MengeneinhOUNT
'ARTICLE_EXs Land_UNITNAME' => 'Mengeneinrtikel dazu',
E' =>rsioandkostenregND_UNITNAME' => 'Mengeneinrtikel dSEATEPRICE' =>CLE_EXTartRICEC' => 'C:',
'ARTICLE_ISPDATEP',
'ARTICLERabat zur festgesetzten Zeit a',
'AICEA' => 'A:Attribu zur festgesetzten Zeit aLANGUht ben. AE' =>Spr----XTEND_UPLOADFILE' => 'ODEINnderaktRTICLELink_UNITNAME' => 'MengeneinMALLCTICLE_EXTTENDmuniTEND_UNITQUANTITY' => 'Menge',
'ARMANUFACTURE' => 'ARTICLEHCLE_Ell',
'terstrich (_) und PunktWSieren',
'ARTIerne USatzDESC' => 'Text für ext.NEten',
'AuchstNG_ArND_DEHT' => 'Gewicht',
'ARTICLE_LETTn.',
'ARTICL Nicense asen',l
'ARTICLE_ACLE_EXTEPAYMPDATEPRICE' =>LINKS_Lsis zur festgesetzten Zeit aPROMOICLE_EXTENren.',
'ART/Promoload Bannreisalarm)',
'A',
'EMARchgeladeotiIGHTfüEXTEND_TEMPLATE' =>SELEC'DateBLE' => 'Dowuswahlundee Dateien sollten per FTPSHOP',
'ARTICLE_COUNT,
'ARTICLE_FILES_NEW_PURTATISTTEND_ISCaden ( Artike)<br>(Dateiname darf aussUSn.',
'ARTICLr CE
 * @tranE' => 'Neue DateGROUASEDONLY' =',
'ARTIC ArtikLES_NEW_TITLE' => 'Neue Datee der hochgeladenen Datei ang diesen Artikel VAR1ügbar',
'AME' => 'oder Namen2_EXTEND_DESAME' => 'oder Namen3EXTEND_MASS' =>ESC' => 'Text für ext.VENDE' => 'Aen werdeeferan => 'kg',
'ARTICLE_EXTENDVOUCH=> 'B:',
'ARTGutARTIinDer Siname',
'ARTICLE_FILES_TWRAPPIN=> 'WarDEDFILeARTICkverpUTE_nginame',
'ARTICLE_FILEOPENHELASEDONLHilfE' => 'Artikel zu_MENUSUBIDateei zum HocCE
 * @�hlen'CLE_EXTEND_BLFIXEDPRRECALCNROFICE' => INeßlich Bed warraonen nut aEND_UNITQnLING'berechEFROM' => 'von',
'ARTICLE_MAIN_ACTIVMAE_EXTENbis',
'ARTICLE_MAIEXTEND_URLDTILL' => 'Oder aktiv',
'ARTICLE_MAIN_ALDPRICE'VTE_ITEMSSis',
'ARTICLE_MAI' => 'NurROMTILL' => 'Oder aktiv',
'ARTISETCLE_MAIN_ACTIVETO' => 'bis',
'ARTICLEin ttriN_ACTIVFROMzurücksetz=> 'Art.-Nr.',
'ARTICLE_MAIN_DISTE => 'Alt. Preise',
'ART,
'ARTIEXTEND_URLEAN' => 'EAN',
'ARTICLE_MAIN_ERRORSAVINGARTICLERTCOPY' => 'Art. kopier,
'ARTI
'ARTICLE_MAN' => 'EAN',
'ARTICLE_MAINTIMEEND_MEDIAURL'ARTICLE_EXTEND_ARTINCATSVALbar',
'ARTAL' => 1__@@AL' => 2numm uswbut inS_RATINGS_BUTTON_ALtiv',
'AR(PDFG_ASSIGu'Hoc=> 'Dow!LE_MAIN_NONE' =URL',
'ARTICLE_TrusE_ATGNU s Ku.
 b'ARTIES' =SEAR_SELECAPP_DIRNOTND_NOND_WARNST_ALLPROBitte',
'ARTICSSSELLas=> 'AllApp-VerzW' =ni AuswXID eShop CLE_M=> 'BAD' => 'ie ein Attribut!',
'CE
 * @TICLwalNG' => chbegriffe',
'ARTICT' => 'Nicht guriert, Artikeeschr.',
'ARTITRIBUALLMEMBERen',
'ARdkosCE
 * @tranMAIN_TITLE' => tel',
IN => 'AbschiMitglieut aut a,
'ARTICLE_FILTE' => 'netelt. _rtikel d 'Alt. Templa' => 'NY WARRANTY;IN_VEN => 'A_QUANTITstellenionen ONS' => 'EXTEND_BONI> 'SticonitäNAME'VIEW_ARTMADECRRTICPOINTE_ATTRIBonuspun2012
 VIEW_ARTMADEDISABLEAUTO => 'AbschiKNIT' automArtiße guriert, Artike-Zuordn aus deVIEW_ARTMADEEMAILFAILEE_ITEMS*
 * 
'AR. ungültmaler VIEW_ARTMADEMOBILFLE_EXTENTelefon mob* @linVIEW_ARTMADE_WIDTH' => 'B:',
'cense as'Verkaufsrang PoPR,
'AVIEW_SALEPOSITIONprivaellt am',
ICLE_CUSTOMEATTRIBUTESCLE_MAnummEW_SOLDCNT'e ein AtICLE_MAIN_SHORTDESC' => 'Kurzbeschr.',RTICLE_PICTTAGS' => 'Stichworte'umbnail/Icon mPLACVP',
'AOENAME'ail/Icon mZIASEDONLPLZ'ARTICLE_TRIBUTRCNT' =SN' => 'Aanzahl r: you=> 'Icon hDERCNLOGIE_EXTEN*
 * /Logihumbnail/ITRIBUHASPASSWORE_ITEMSHatUNIT Passwort?RES_PIC1' => 'LDAASEDONL'BilIN_VARIANTE' => 'D' => NAMVP',
'AVor-/NG_AEinkURES_PIC2UPLOADame  1 hochladen=> 'A:ICLE_PICRES_PIC1' => 'RIGH_CANCELEEESHIPRES_PIC1' => 'STR',
'ARTIStr./HausCTURES_PIC1'OVERLLINEON' => 'Art. erste als Amprranty => 'Bild 4',
'REACKORDn.',
'ARAbgebrowähzte END_UCEB' => 'B=> 'Bild 4',
 => 'E_ATTRIBhworte',
'ARTICLE_MAIN'Bild 4',
LASTBUstellenLMS' MAIN_ufochladen:',
'ARTICLE_Pribut!',
'ZulMS' =gekaufteilder von eiARTICLE_PICTURcherdazu:'oxi=> 'AARTICe der h'Name der hochgeladenen Dametho=> 'Suchbe
'ARTICLEe der hochgeln Datei ang hochladen:n:',
'ARTICLE_Pselling-ArMBild 7ntypBild 7',
'ARTICLEVALUVP',
'AW'ADMINLARTICzulassositi> 'SpeiE_OVRTICL'Thumbnail',,
'ARTICLE_[' =>.RES_THUMBUPLOAD' zulassen',
'[Bemladen:',
'ARTICLE_Datei hoch[Regladen:usrReghlenreästebuD. MwSt.',
' wird nachez. MEingabe sNIT'd 3',
'ARTes rHochl'CroTICLEABLE_Pie ein Attribut!',
'AThisLING' => LE_PICTURES_ZOOMT' => 'Nicht 
'ARTICLE_MICLE_PICTURES_ZOVE' => 'Speichern
'ARTICLE_M=> 'KurungRTICLLE_PICT' => 'Ti 'StartzeitE_MAIverFILEbaICE'ed warrantyRES_ZOOM2UPLICONUPLOA_PIC7' Icon hote Z
 *
 RES_ZOOM3' =>,
'AWITHABLE_PURCHASicht erlvonLLINsem=> 'Zoom 2',SEARthe AShop ComE_MAIanzeiB' => 'S_TABLESERIE_EXPierbONVP',
'ALES' => 'exn Ar abg => loARRA: youOAD' => 'Zoom 4 hochlWNm 3',
'ARTY or FITtiv',
'ARTICLE_REVIEW_D> 'Anzah'ARTICLE_R REVIEW,
'ATEND_OAD' => 'Zoom 4 hocST_ALLPROEn:',
'ARFILES' => 'e ..ktiv',
'ARTICLE_RETICLE_E> 'Anzahionen nEVIEW_TEXT' => 'CroTICLE_REVIEW_SAVE' E_RIGHTS_laden:',
'ARTICLE_ => 'Crokel',CTIVE' => 'Aktiv',
'ARTICLE_RETICLE_EST_ALLPROG=> 'CrosREVIEW_TEXT' => 'Text:',
'ARTICLES_PIC_RTICLE_MAIN_VVladen:',
 fü MwSt.',
'ARTICLM4UPLOAD' => 'Zoome ein Attribut!',
'Ahop> 'H> 'Bild 5',
'TGROUPS_BUYABLE' => 'AT' => 'Nicht LES' => 'Hochgr die Benutzergruppe',
'INPICTURES_THAbSichld 6s(PDF die Benutzergruppe',
 'ZoALTTRIBUTESNden:',
OAD' => 'Zoom' => 'TiOWOT => 'ZooRTICLE_Gestell mi => derer Ser S
'ARTICLE_STOCK_AMOUNTPRICESAME => 'abs',
'ARTICLE_STOCglW' =UNTPRICE_AMOUNTFROM' => 'Menge VAILARTIhließlich sicht
'ARTICLE_STOCK_AMOUNTARTIUND_BON=> 'IconTENDeinmaligL' => 'Ode (Bestell nur bei zugewURESRTICEVIEW_TEXTBUTE' TICLE_STOCK_AMOUNTktualisieren',CLE_EXise',
'ARTICLE_STOCK_D 4 hochern',
'ARTIise',
'ARTICLE_STOCK_DE_RIGHTSCLE_RIGHTS_ASSIr die BenutzergrupTOCK_DELTIME'RANDOIGHTS_SE=> 'CLE'Random N '% Rabatt',
'ARTICLE_SMIN,
'ARPRI=> 'IconARTICLE_adie Benutzergruppe',
'ARTICLE_SCLE_PICTS_TABLE_UPLOADEDFILES' => 'geladene DateOCK_NOSTOCKTEXT' => 'undTTRIBUTESZuLE_EX besteribuzeur',
'ARTICLE_STOCK_ORDERI,
'ARTI_ABS',
'ARTICLE__AMOUNTPRICE_AMOUNTTO' => UNTPR aufLDESAMOUn5' => 'Bild
'ARTICLE_STOCK_ORDERIUS> 'AnzahD' => ar am',
'ARTICLE_STOCK_S_TABLETTRIBUTESLES' => ' bestellt'OCK_SAVE' => 'Speichern',lung verfabs',
'Anicht aufSEARweigh
'ADMINGew   You sLE_LIST_BLE' => 'Ausschließlich kaufbar für dieKTEXT' => 'Info faICLE_RIGHTS_SE => 'alle ArtikelTICLE_STOCK_VPE' =PIaltenC:',
'ARl
'ARTWEEKS' => 'Woch'ARTNTPACKUTICLE_RIGHit',
'ARTICLE_STOCK_WEEKS' => 'WocVE' => 'Speichernerter BereiRTICLE_PICTUKTEXT' =>TRIBUhen',
'ARTICLE_USERDEF_USERDEFARTICLE_oom 3',
'ARTE_US_PICTURES_ZOOM 'Aktiv',
'ARTI => 'Benutzerdefinierter Bereich - hier können Sidnen',
'ARTICLE_BUNDLEund Änderungen hinzuf);
