...
'HELP_ARTICLE_EXTEND_EXTURL' => 'Do pole <span class="navipath_or_inputname">Externí odkaz</span> můžete zadat odkaz týkající se výrobku (např. web výrobce). Do pole <span class="navipath_or_inputname">text externího odkazu</span> zadejte text, který bude sloužit jako popis odkazu, např. <span class="navipath_or_inputname">Více informací</span>.',
...
'HELP_ARTICLE_EXTEND_QUESTIONEMAIL' => 'Do pole <span class="navipath_or_inputname">Alternativní kontakt</span> zadejte Váš email. Pokud bude mít zákazník otázku k výrobku, bude odeslána na tento email. Pokud nezadáte žádnou adresu, dotaz bude zaslán na Váš informační email.',
...
'HELP_ARTICLE_EXTEND_TPRICE' => 'Do pole <span class="navipath_or_inputname">Doporučená maloobchodní cena</span> zadejte doporučenou maloobchodní cenu. Bude zobrazena zákazníkům. Nad cenou výrobku se zobrazí<i>Zlevněno z doporučené ceny</i>.',
'HELP_ARTICLE_EXTEND_UNITQUANTITY' => '<span class="navipath_or_inputname">Počet kusů</span> a <span class="navipath_or_inputname">Balení</span> Vám umožňuje zobrazit cenu za jednotku (např. 20 Kč za litr). <span class="navipath_or_inputname">Počet kusů</span> je množství výrobků (např. <span class="navipath_or_inputname">5</span>), <span class="navipath_or_inputname">Balení</span> je množství (např. <span class="navipath_or_inputname">litr</span>). Cena za jednotku se zobrazuje u výrobku',
...
'HELP_ARTICLE_MAIN_TAGS' => 'Zde můžete zadat tagy produktu. Z těchto tagů je na úvodní stránce vygenerován mrak značek. Tagy jsou odděleny čárkou.',
...
'HELP_ARTICLE_PICTURES_ZOOM1' => 'Zoom obrázky jsou obrázky ve velkém rozlišení, které se zobrazí po kliknutí na obrázek v detailním pohledu na produkt. </br>You can upload zoom pictures in <span class="navipath_or_inputname">Zoom X upload</span>. After uploading, the filename is shown in <span class="navipath_or_inputname">Zoom X</span>. If no zoom picture is uploaded yet, <span class="userinput_or_code">nopic.jpg</span> is displayed.<br>Další informace jsou k dispozici v <a href="http://www.oxid-esales.com/en/resources/help-faq/eshop-manual/product-images-basics" target="_blank">části manuálu obrázky produktů</a>.',
'HELP_ARTICLE_SEO_ACTCAT' => 'Můžete zadat různá SEO URL pro jeden výrobek (např. pro různé kategorie). Pomocí <span class="navipath_or_inputname">aktivovat kategorii/výrobce</span> vyberete SEO URL, které chcete změnit.',
'HELP_ARTICLE_SEO_DESCRIPTION' => 'Tento popis bude přímo v  HTML zdrojovém kódu stránky výrobku (META description). Popis je důležitý pro vyhledávače. Zde můžete popis zadat. Pokud jej nezadáte, budou automaticky vygenerována.',
'HELP_ARTICLE_SEO_FIXED' => 'Můžete nechat eShop vygenerovat nové SEO URL. Stránky výrobku budou mít nové SEO URL pokud se například změní titulek výrobku. Nastavení <span class="navipath_or_inputname">fixních URL</span> se nezmění.',
'HELP_ARTICLE_SEO_KEYWORDS' => 'Tyto klíčová slova budou přímo v HTML zdrojovém kódu stránky výrobku (META keywords). Klíčová slova jsou důležitá pro vyhledávače. Zde můžete klíčová slova zadat. Pokud je nezadáte, budou automaticky vygenerována.',
...
'HELP_ARTICLE_STOCK_AMOUNTPRICE_PRICE' => 'Zde můžete nastavit cenu pro množství zadaném výše. Cenu můžete zadat absolutně nebo jako procetuální slevu.<br> Další informace o množstevních slevách jsou k dispozici v <a href="http://www.oxid-esales.com/en/resources/help-faq/eshop-manual/setting-graduated-prices" target="_blank">části manuálu o množstevních slevách</a>.',
'HELP_ARTICLE_STOCK_DELIVERY' => 'Zde můžete zadat datum, od kterého bude vyprodaný výrobek znovu dostupný. Datum zadejte ve formátu rok-měsíc-den, např. 2009-02-16.',
'HELP_ARTICLE_STOCK_NOSTOCKTEXT' => 'Zde můžete napsat zprávu, která je zobrazena v případě, že výrobek není na skladě. Další informace o skladových zprávách jsou k dispozici v <a href="http://www.oxid-esales.com/en/resources/help-faq/eshop-manual/setting-messages-stock-levels" target="_blank">části manuálu o skladových zprávách</a>.',
...
'HELP_ARTICLE_STOCK_REMINDAMAOUNT' => 'S <span class="navipath_or_inputname">odeslat e-mail, pokud skladové zásoby klesnou pod určitou hodnotu</span> můžete specifikovat, že bude zaslán e-mail jakmile stav skladu klesne na zadanou hodnotu. Zaškrtněte volbu a zadejte úroveň záspob, na kterou chcete být upozorněni.',
'HELP_ARTICLE_STOCK_STOCKFLAG' => 'Existují 4 <span class="navipath_or_inputname">způsoby zobrazení výrobků</span> :<ul><li><span class="navipath_or_inputname">Standardní</span>: výrobek může být objednán, když je vyprodán.</li><li><span class="navipath_or_inputname">Externí sklad</span>: výrobek je vždy zobrazen jako <i>na skladu</i>.</li><li><span class="navipath_or_inputname">Vyprodán</span>: výrobek není vůbec zobrazen.</li><li><span class="navipath_or_inputname">Vyprodán, neobjednatelný</span>: výrobek je zobrazen ale nelze ho objednat.</li></ul>',
'HELP_ARTICLE_STOCK_STOCKTEXT' => 'Zde můžete napsat zprávu, která je zobrazena v případě, že výrobek je na skladě. Další informace o skladových zprávách jsou k dispozici v <a href="http://www.oxid-esales.com/en/resources/help-faq/eshop-manual/setting-messages-stock-levels" target="_blank">části manuálu o skladových zprávách</a>.',
...
'HELP_CATEGORY_MAIN_DEFSORT' => 'V poli <span class="navipath_or_inputname">Rychlé třízení</span> zadejte, podle čeho mají být kategorie a výrobky třízeny. Více v <a href="http://www.oxid-esales.com/en/resources/help-faq/eshop-manual/sorting-products">návodu</a> na webu OXID eSales.',
...
'HELP_CATEGORY_MAIN_PRICEFROMTILL' => 'V poli<span class="navipath_or_inputname">Cena od / do</span> můžete nastavit zobrazení <strong>všech</strong> výrobků s cenou v zadaném intervalu v jedné kategorii.',
...
'HELP_CATEGORY_SEO_DESCRIPTION' => 'Tento popis bude přímo v  HTML zdrojovém kódu stránky výrobku (META description). Popis je důležitý pro vyhledávače. Zde můžete popis zadat. Pokud jej nezadáte, budou automaticky vygenerována.',
'HELP_CATEGORY_SEO_FIXED' => 'Můžete nechat eShop vygenerovat nové SEO URL. Stránky výrobku budou mít nové SEO URL pokud se například změní titulek výrobku. Nastavení <span class="navipath_or_inputname">fixních URL</span> se nezmění.',
'HELP_CATEGORY_SEO_KEYWORDS' => 'Tyto klíčová slova budou přímo v HTML zdrojovém kódu stránky výrobku (META keywords). Klíčová slova jsou důležitá pro vyhledávače. Zde můžete klíčová slova zadat. Pokud je nezadáte, budou automaticky vygenerována.',
...
'HELP_CONTENT_SEO_DESCRIPTION' => 'Tento popis bude přímo v  HTML zdrojovém kódu CMS stránky výrobku (META description). Popis je důležitý pro vyhledávače. Zde můžete popis zadat. Pokud jej nezadáte, budou automaticky vygenerována.',
'HELP_CONTENT_SEO_FIXED' => 'Můžete nechat eShop vygenerovat nové SEO URL. Stránky výrobku budou mít nové SEO URL pokud se například změní titulek výrobku. Nastavení <var>fixních URL</var> se nezmění.',
'HELP_CONTENT_SEO_KEYWORDS' => 'Tyto klíčová slova budou přímo v HTML zdrojovém kódu CMS stránky výrobku (META keywords). Klíčová slova jsou důležitá pro vyhledávače. Zde můžete klíčová slova zadat. Pokud je nezadáte, budou automaticky vygenerována.',
'HELP_DELIVERYSET_MAIN_POS' => '<var>Třízení</var> definuje pořadí, v jakém jsou metody výpočtu poštovného zobrazeny uživateli. Metoda s nejnižším číslem je nahoře.',
'HELP_DELIVERY_MAIN_CONDITION' => 'V <var>podmínkách</var> můžete nastavit, jak bude účtováno poštovné:<ul><li><kbd>Počet</kbd>: podle počtu výrobků v košíku.</li><li><kbd>Velikost</kbd>: podle velikosti všech výrobků. V tomto případě musí být zadána velikost jednotlivých výrobků.</li><li><kbd>Hmotnost</kbd>: podle váhy všech výrobků. V tomto případě musí být zadána hmotnost jednotlivých výrobků.</li><li><kbd>Cena</kbd>: podle ceny výrobků.</li></ul>Můžete zadat symboly <var>>=</var> (větší nebo rovno) a <var><=</var> (menší nebo rovno) pro zadání limitů.',
'HELP_DELIVERY_MAIN_COUNTRULES' => 'V <var>pravidlech výpočtů</var> lze nastavit, jak často má být vypočítávána cena:<ul><li><kbd>Jednou</kbd>: cena se vypočítá na konci objednávky.</li><li><kbd>Jednou pro každé zboží</kbd>: cena se počítá pro každé zboží v košíku nehledě na množství.</li><li><kbd>Pro každý výrobek</kbd>: cena se počítá pro každý kus.</li></ul>',
'HELP_DELIVERY_MAIN_FINALIZE' => 'Pokud je aktivní volba <var>Nepočítat dále, pokud metoda funguje</var> pro ukončení výpočtů po prvním úspěšném.',
'HELP_DELIVERY_MAIN_ORDER' => 'Můžete použít <var>Pořadí výpočtů poštovného</var> pro učení pořadí, ve kterém budou použity metody výpočtu poštovného. Metoda s nejnižším číslem bude použita první. Pořadí je důležité, pokud je aktivní volba <var>Nepočítat dále, pokud metoda funguje</var>.',
'HELP_DELIVERY_MAIN_PRICE' => 'Můžete použít <var>Slevy / poplatky</var> pro volbu výpočtu poštovného. Existují dva způsoby:<ul><li>Pomocí <kbd>abs</kbd>, cena je pevně dána (např.: <kbd>6.50</kbd>, cena je 6,50 Kč).</li><li>Pomocí <kbd>%</kbd>, cena tvoří procento z ceny výrobku (např.: <kbd>10</kbd>, poštovné stojí 10% ceny výrobku).</li></ul>',
...
'HELP_LANGUAGE_DEFAULT' => 'Výchozí jazyk, který je použit v případě, kdy eshop nemůže detekovat jayzkovou mutaci jiným způsobem: jazyk nebyl rozpoznán v URL, nemohl být detekován prohlížečem, nený definován v session. Výchozí jazyk <u>nemůže být smazán</u>, může být pouze deaktivován',
...
'HELP_MANUFACTURER_SEO_DESCRIPTION' => 'Tento popis bude přímo v  HTML zdrojovém kódu stránky výrobce (META description). Popis je důležitý pro vyhledávače. Zde můžete popis zadat. Pokud jej nezadáte, budou automaticky vygenerována.',
'HELP_MANUFACTURER_SEO_FIXED' => 'Můžete nechat eShop vygenerovat nové SEO URL. Stránky výrobce budou mít nové SEO URL pokud se například změní titulek výrobku. Nastavení <span class="navipath_or_inputname">fixních URL</span> se nezmění.',
...
'HELP_SHOP_CACHE_ENABLED' => 'Pokud je aktivováno ukládání dynamického obsahu do mezipaměti (cache), pro zvýšení výkonu je obsah je cachován. Deaktivujte toto nastavení, pokud upravujete eshop(píšete moduly, upravujete šablony vzhledu atd).',
'HELP_SHOP_CACHE_LIFETIME' => 'Zde nastavíte, jak dlouho bude obsah v mezipaměti (cache) uložen. Výchozí hodnota je 36000 sekund.',
'HELP_SHOP_CONFIG_ALTVATIDCHECKINTERFACEWSDL' => 'Zde můžete zadat alternativní URL adresu pro online kontrolu DPH ID.',
'HELP_SHOP_CONFIG_ATTENTION' => 'Pozor: I když je použito šifrování, smlouvy s platebními společnostmi toto zakazují!',
...
'HELP_SHOP_CONFIG_BASKETRESERVATION' => 'Pokud je tato volba neaktivní, eShop snižuje množství na skladě až v okamžiku, kdy je objednávka potvrzena zákazníkem a dokončena platba.<br><br> Po aktivaci volby se funkcionalita mění: Skladová dispozice produktu se snižuje a produkt je <b>rezervován</b> v okamziku, kdy je vložen do košíku. Rezervace je zrušena v případě, kdy je obsah košíku objednán nebo platnost košíku vyprší.',
...
'HELP_SHOP_CONFIG_BIDIRECTCROSS' => 'Pomocí křížového prodeje můžete nabídnout doplňkové zboží k výrobku (např. k autu jsou jako křížový prodej přiřazeny pneumatiky, pak se pneumatiky zobrazí při koupi auta). <br> Pokud je aktivován obousměrný křížový prodej vůz se zobrazí s pneumatikami a opačně.',
'HELP_SHOP_CONFIG_DELETERATINGLOGS' => 'Uživatel nemůže jeden výrobek hodnotit vícekrát. Zde můžete nastavit, po jak dlouhé době uživatel může výrobek znovu hodnotit. Pokud nezadáte žádnou hodnotu, výrobek může být hodnocen jen jednou.',
'HELP_SHOP_CONFIG_DISABLEONLINEVATIDCHECK' => 'Pokud zadá při objednání zákazník z cizí země v EU DPH, je DPH započítáno k objednávce. Pokud není DPH ID validní, DPH sazba není k objednáve připočtena.<br>Pokud je volba zakázána, je vždy započítána obecná DPH sazba.',
...
'HELP_SHOP_CONFIG_FBFACEPILE' => 'Facepile zobrazuje profilové obrázky přátel návštěvníků eShopu, kteří se přidali ve Facebooku na váš web.',
'HELP_SHOP_CONFIG_FBINVITE' => 'Zobrazuje seznam přátel návštěvníka eShopu a umožňuje je pozvat do eShopu.',
'HELP_SHOP_CONFIG_FBLIKE' => 'Dovoluje uživatelům vytvořit spojení na váš web a sdílet obsah jejím přátelům na Facebooku pomocí jednoho kliknutí.',
'HELP_SHOP_CONFIG_FBSHARE' => 'Zobrazuje tlačítko sdílet na Facebooku pro sdílení obsahu vašeho webu.',
...
'HELP_SHOP_CONFIG_NEWARTBYINSERT' => 'Na titulní straně Vašeho eShopu se v kategorii <i>Nově v nabídce!</i> zobrazují nejnovější výrobky. Výrobky můžete řadit podle data přidání nebo data poslední změny.',
'HELP_SHOP_CONFIG_ORDEROPTINEMAIL' => 'Pokud je volba aktivní, uživatel, který si zaregistruje Novinky dostanete e-mail s ověřovacím odkazem. Pouze pokud uživatel na odkaz klikne stává se odběratelem Novinek',
'HELP_SHOP_CONFIG_OVERRIDEZEROABCPRICES' => 'Pro různé uživatele můžete nastavit různé ceny: Pro každý výrobek můžete zadat cenu A, B a C. Pokud je uživatel ve skupině <i>Cena A</i>, je mu místo normální ceny zobrazena cena A.<br>Pokud je tato volba aktivní, normální cena je použita v případě, že není definována cena A, B nebo C.<br>Tuto volbu můžete aktivovat když používáte A, B a C cenu. V případě, že cena pro skupinu není definována, uživateli se zobrazí cena 0,00.',
...
'HELP_SHOP_CONFIG_POINTSFORREGISTRATION' => 'Výše uživatelských kreditů získá kdo pozval někoho do eShopu. Pozvaný uživatel se musí registrovat, aby tyto body získal. Získané body jsou uloženy v uživatelově záznamu a provozovatel eshopu je může využít k jakémukoliv účelu.',
...
'HELP_SHOP_CONFIG_SEARCHFIELDS' => 'Zde můžete zadat parametry, podle kterých bude možno vyhledávat. Do každého řádku zadejte pouze jeden parametr.<br>Nejčastější parametry:<ul><li>oxtitle = Titul</li><li>oxshortdesc = Krátký popis</li><li>oxsearchkeys = Klíčová slova</li><li>oxartnum = Číslo výrobku</li><li>oxtags	= Značky</li></ul>',
'HELP_SHOP_CONFIG_SHOP_CONFIG_FACEBOOKAPPID' => 'Pro připojení vaší webové stránky k facebooku zadejte Application ID. Jak připojit váš web k Facebooku si můžete přečíst tady:<a href="http://wiki.oxidforge.org/Tutorials/Connecting_website_to_facebook" target="_blank" target="_blank">návod</a>.',
...
'HELP_SHOP_CONFIG_SHOP_CONFIG_FBSECRETKEY' => 'Pro zajištění bezpečného spojení mezi va39m webem a Facebookem, musíte zadat Secure Key, který získáte při registraci vašeho webu do FacebookuPřečtěte si <a href="http://wiki.oxidforge.org/Tutorials/Connecting_website_to_facebook" target="_blank" target="_blank">návod</a> jak propojit váš web s Facebookem.',
'HELP_SHOP_CONFIG_SHOWTAGS' => 'Pokud není zaškrtnuto, nezobrazují se v eshopu žádné štítky. Stránky, které obsahují štítky v URL nejsou dostupné.',
'HELP_SHOP_CONFIG_SORTFIELDS' => 'Zde můžete zadat parametry, podle kterých budou výrobky třízeny do seznamů. Do každého řádku zadejte pouze jeden parametr.<br>Nejčastější parametry:<ul><li>oxtitle = Titul</li><li>oxprice = Cena</li><li>oxvarminprice = Nejnižší cena, pokud jsou povoleny různé ceny variant.</li><li>oxartnum = Číslo výrobku</li><li>oxrating = Hodnocení</li><li>oxstock = Skladové zásoby</li></ul>',
'HELP_SHOP_CONFIG_STOCKOFFDEFAULTMESSAGE' => 'Můžete nastavit upozornění pro každý výrobek, jehož skladové zásoby jsou vyprodány.<br>Pokud je tato volba aktivní, pro všechny výrobky se zobrazí základní upozornění <i>Zásoby došly a zboží musí být doobjednáno</i>.',
'HELP_SHOP_CONFIG_STOCKONDEFAULTMESSAGE' => 'Můžete nastavit upozornění pro každý výrobek, který se objeví na skladě.<br>Pokud je tato volba aktivní, pro všechny výrobky se zobrazí základní upozornění <i>Připraven k odeslání</i>',
'HELP_SHOP_CONFIG_USENEGATIVESTOCK' => 'Pomocí <span class="navipath_or_inputname">Povolit zápornou hodnotu skladových zásob</span> můžete zvolit způsob počítáni záporných skladových hodnot:<br><ul><li>Je-li volba aktivní, zásoby se počítají do záporných hodnot, pokud si uživatel objedná zboží, které právě není na skladu.</li><li>Pokud je volba vypnutá, hodnota zásob nikdy neklesne pod 0, i když si uživatel zboží objedná.</li></ul>',
'HELP_SHOP_MAIN_ACTIVE' => '<span class="navipath_or_inputname">Aktivováním</span> můžete zapnout / vypnout celý eShop. Pokud je eShop vypnutý, uživatelům se zobrazí zpráva o jeho dočasné nedostupnosti.',
'HELP_SHOP_MAIN_INFOEMAIL' => 'Všechny emaily odeslané přes Kontaktujte nás! budou zaslány na tuto adresu.',
'HELP_SHOP_MAIN_ORDEREMAIL' => 'Zákazníkovy bude zaslán email s informacemi o jeho objednávce. Odpovědi na tyto emaily budou zaslány na <span class="navipath_or_inputname">objednávkový email</span>.',
'HELP_SHOP_MAIN_OWNEREMAIL' => 'Pokud si zákazník něco objedná, bude Vám zaslán email s informacemi o objednávce. Tento email bude zaslán na <span class="navipath_or_inputname">Vaši adresu</span>.',
'HELP_SHOP_MAIN_PRODUCTIVE' => 'Pokud tato volba <span class="warning_or_important_hint">není</span> aktivní, informace o délce zpracování a debugovací informace jsou zobrazeny na konci každé stránky. Tyto informace jsou užitečné při nastavování e-shopu.<br><span class="warning_or_important_hint">Aktuvujte tuto volbu v případě, že je eshop v ostrém provozu. Tímto se vašim zákazníkům nebudou žádné dodatečné informace zobrazovat.</span><br>Další důležité informace naleznete <a href="http://wiki.oxidforge.org/Tutorials/Check_before_going_live" target="_blank">zde</a>',
'HELP_SHOP_MAIN_SMTPSERVER' => 'SMTP údaje potřebné pro odesílání e-mailů (např. zasílání zákazníkům potvrzení objednávky e-mailem). Další informace lze nalézt v <a href="http://www.oxid-esales.com/de/resources/help-faq/eshop-manual/entering-smtp-data" target="_blank">příslušné části návodu</a>.',
...
'HELP_SHOP_MALL_PRICEADDITION' => 'Můžete zadat marži pro všechny ceny produktů v eshopu: Zadejte marži a zvlolte jestli je procentní (<span class="userinput_or_code">%</span>) nebo absolutní (<span class="userinput_or_code">abs</span>).',
'HELP_SHOP_PERF_CHECKIFTPLCOMPILE' => 'Pokud je tato volba aktivována, eshop kontroluje, jestli byly změněny šablony. Pokud ano, šablona je znovu zkopilována. Pokud upravujete šablony, aktivujte tuto volbu. Deaktivujte ji, pokud je eshop v produkčním režimu abyste zvýšili jeho výkon. <br>Bližší informace naleznete <a href="http://www.oxid-esales.com/en/resources/help-faq/eshop-manual/advices-adepting-templates" target="_blank" target="_blank">v manuálu o cachování</a>.',
'HELP_SHOP_PERF_CLEARCACHEONLOGOUT' => 'Obvykle je kompletní chache vyprázdněna jakmile dojde k uložení změny v administraci. To může způsobovat výkonnostní problémy. Pokud je tato volba aktivní, cache se smaže až po odhlášení z administrace eshopu.',
'HELP_SHOP_PERF_DISBASKETSAVING' => 'Košík registrovaných se ukládá. Pokud znovu navštíví eShop, košík se jim zobrazí. Pokud aktivujete tuto volbu, obsah košíku se již nebude ukládat.',
...
'HELP_SHOP_PERF_LOADATTRIBUTES' => 'Běžně se detaily výrobku zobrazují jen v podrobném popisu výrobku. Pokud je tato volba aktivní, detaily se zobrazují vždy.<br>',
...
'HELP_SHOP_PERF_LOADPRICE' => 'Pokud tato volba není aktivní, nezobrazují se ceny výrobků.',
'HELP_SHOP_PERF_LOADREVIEWS' => 'Uživatelé mohou hodnotit a komentovat výrobky. Pokud je tato volba aktivní, recenze a komentáře se u výrobku zobrazí.',
'HELP_SHOP_PERF_LOADSELECTLISTSINALIST' => 'Běžně se výběry zobrazují jen v podrobném popisu výrobku. Pokud je tato volba aktivní, výběry se zobrazují vždy.',
'HELP_SHOP_PERF_NEWESTARTICLES' => 'Seznam nejnovějších výrobků je zobrazen v <i>Nově v nabídce!</i>. Zde můžete vybrat způsob tvorby seznamu:<ul><li><span class="navipath_or_inputname">inactive</span>: Seznam se nezobrazuje.</li><li><span class="navipath_or_inputname">manual</span>: Můžete zvolit výrobky v <em>Zákaznické informace -> Akce -></em> seznam <i>Nově v nabídce!</i>.</li><li><span class="navipath_or_inputname">automatic</span>: Seznam je generován automaticky.</li></ul>',
'HELP_SHOP_PERF_PARSELONGDESCINSMARTY' => 'Pokud je tato volba aktivní, popisy kategorií a výrobku jsou zpracovávány pomocí Smarty - můžete používat Smarty tagy.<br>',
'HELP_SHOP_PERF_SEO_CACHE' => '',
'HELP_SHOP_PERF_TOPSELLER' => 'Seznam dlouhodobě oblíbených výrobků se zobrazuje v <i>Dlouhodobě oblíbené zboží</i>. Zde můžete nastavit, jak má být seznam generován:<ul><li><span class="navipath_or_inputname">inactive</span>: Seznam se nezobrazuje.</li><li><span class="navipath_or_inputname">manual</span>: Můžete zvolit výrobky v <em>Zákaznické informace -> Akce -></em> seznam <i>Dlouhodobě oblíbené zboží</i>.</li><li><span class="navipath_or_inputname">automatic</span>: Seznam je generován automaticky.</li></ul>',
...
'HELP_SHOP_RDFA_VAT' => '',
'HELP_SHOP_SEO_IDSSEPARATOR' => 'Oddělovač se používá u víceslovných názvů místo mezer např. www.vášobchod.cz/kategorie-s-víceslovným-názvem<br>Jako základní oddělovač je použit znak -.',
'HELP_SHOP_SEO_REPLACECHARS' => 'Některé speciální znaky (typicky přehlásky) by neměly být v URL, můžou způsobit problémy. Zde můžete definovat, jak mají být nahrazeny. Definice musí být ve tvaru <code>speciální znak => náhradní znak</code>, např. <code>Ü => Ue</code>.<br>Pro němčinu jsou náhradní znaky již nadefinovány.',
'HELP_SHOP_SEO_RESERVEDWORDS' => 'Některá URL jsou potřebná pro provoz eShopu, např. www.youreshop.com/admin pro přístup do administrace. Pokud pojmenujete kategorii <i>admin</i> SEO URL bude také www.youreshop.com/admin, do kategorie se tedy nebudete schopni dostat. Proto bude použita SEO URL přípona. Zde můžete nadefinovat, ke kterým URL má být přípona přidána automaticky.',
'HELP_SHOP_SEO_SAFESEOPREF' => 'Pokud se je v kateogirii více výrobků se stejným jménem, mají stejné SEO URL. Proto mají také SEO příponu. Pokud žádnou příponu nedefinujete, bude použito slovo <i>oxid</i>.',
'HELP_SHOP_SEO_SKIPTAGS' => 'Pokud pro kategorii nevytvoříte META tagy, budou vytvořeny automaticky. Proto by některá, příliš často se vyskytující slova, měla být vynechána. Slova v tomto seznamu budou vynechána META tagy.',
'HELP_SHOP_SEO_STATICURLS' => 'Pro některé stránky (např. Podmínky užití) můžete definovat URL. Můžete také zadat URL pro každý jazyk zvlášť.',
...
'HELP_SHOP_SYSTEM_DENIEDDYNGROUPS' => 'Povolí filtrování uživatelských skupin, které jsou zpracovány přes "dgr" parametr v URL.',
...
'HELP_SHOP_SYSTEM_OTHERCOUNTRYORDER' => 'Zde můžete nastavit, zda lze provést objednávky ze zemí, pro které nejsou stanoveny ceny:<ul><li>Pokud je volba aktivována, uživatel si může objednat a bude mu stanovena speciální cena.</li><li>Pokud je volba vypnutá, uživatel si nemůže objednat žádné zboží.</li></ul>',
'HELP_SHOP_SYSTEM_SHOP_LOCATION' => '',
'HELP_SHOP_SYSTEM_SHOWVARIANTREVIEWS' => 'Tato volba ovlivňuje, jak jsou zpracovávány recenze pro varianty - pokud je volba aktivní, poznámky variant jsou zobrazeny i u hlavního výrobku.',
'HELP_SHOP_SYSTEM_UTILMODULE' => '',
'HELP_SHOP_SYSTEM_VARIANTINHERITAMOUNTPRICE' => 'Zde můžete nastavit, zda ceny variant mají být stejné jako ceny hlavních výrobků. Pokud je volba aktivní, cena hlavního výrobku jsou použita i pro varianty.',
'HELP_SHOP_SYSTEM_VARIANTPARENTBUYABLE' => 'Mohou být objednány hlavní výrobky?<ul><li>Pokud ano, aktivujte tuto volbu.</li><li>Pokud mohou být objednány pouze varianty, volba musí být vypnutá.</li></ul>',
'HELP_SHOP_SYSTEM_VARIANTSSELECTION' => 'V eShopu existuje mnoho seznamů pro zařazování výrobků, např. zařazování zlevněných výrobků. Pokud je tato volba aktivní, varianty jsou také uvedeny v těchto seznamech.',
'HELP_USER_EXTEND_BONI' => 'Zde můžete upravit kredit zákazníka. Od výše kreditu se odvíjejí povolené platební metody.',
'HELP_USER_EXTEND_DISABLEAUTOGROUP' => 'Uživatelé jsou automaticky zařazováni do uživatelských skupin. Pokud aktivujete tuto volbu, uživatele nebudou zařazováni.',
'HELP_USER_EXTEND_EMAILFAILED' => 'Pokud nemůžete odeslat email zákazníkovi, aktivujte tuto volbu. Zákazníkovi již nebudou odesílány další emaily',
...
'HELP_VOUCHERSERIE_MAIN_DISCOUNT' => 'V záložce <span class="navipath_or_inputname">Slevy</span> můžete nastavit velikost slev. Můžete rozhodnout, zda sleva bude percentuální nebo ve formě konkrétní částky:<ul><li><span class="userinput_or_code">abs</span>, např. sleva v hodnotě 50 Kč.</li><li><span class="userinput_or_code">%</span>, např. sleva ve výši 10% z ceny objednávky.</li></ul>',
...
'HELP_VOUCHERSERIE_MAIN_VOUCHERNUM' => 'Zde můžete zadat číslo kupónu. Tuto možnost využijete při tvorbě nových kupónu pokud je neaktivní <span class="navipath_or_inputname">Generování čísel</span>. Všechny kupóny série budou mít stejné číslo.',
