...
'HELP_ARTICLE_MAIN_TAGS' => 'Tu môžete zadať tagy produktu. Z týchto tagov je na úvodnej stránke vygenerovaný mrak značiek. Tagy sú oddelené medzerou.',
...
'HELP_SHOP_CONFIG_FBINVITE' => 'Zobrazí zoznam priateľov návštevníka eShopu a umožňuje ich pozvať do eShopu.',
...
'HELP_SHOP_PERF_LOADATTRIBUTES' => 'Detaily výrobku sa bežne zobrazují len v podrobnom popise výrobku. Pokým je táto voľba aktívna, detaily sa zobrazujú vždy.<br />',
...
'HELP_SHOP_PERF_LOADREVIEWS' => 'Užívatelia môžu hodnotiť a komentovať výrobky. Pokým je táto volba aktívna, značí to zobrazovanie recenzií a komentárov.',
...
'HELP_USER_EXTEND_DISABLEAUTOGROUP' => 'Užívatelia sú automaticky zaraďovaní do užívateľských skupín. Pokiaľ túto voľbu aktivujete, užívatelia zaraďovaní nebudú.',
